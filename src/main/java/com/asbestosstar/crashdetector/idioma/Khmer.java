...
//}
	...
	public String migradorLegacyBotonSidebar() {
		return "ឧបករណ៍ផ្លាស់ប្តូរ";
	}

	@Override
	public String migradorLegacyTitulo() {
		return "ឧបករណ៍ផ្លាស់ប្តូរកម្មវិធីវិភាគ Legacy";
	}

	@Override
	public String migradorLegacyDescripcion() {
		return "ជំនួយការនេះជួយផ្លាស់ប្តូរការកំណត់ពីកម្មវិធីវិភាគការដួល (crash) ចាស់ និងមានកម្មសិទ្ធិ ទៅប្រព័ន្ធទំនើប បើកចំហ និងងាយស្រួលថែរក្សា។ ការផ្លាស់ប្តូរវិធានទាំងនេះកាត់បន្ថយការពឹងផ្អែកលើឧបករណ៍បិទជិត និងសម្រួលដល់ការត្រួតពិនិត្យ កិច្ចសហប្រតិបត្តិការ និងការគាំទ្រពីសហគមន៍។ និមិត្តសញ្ញាដែលបង្ហាញនៅទីនេះមិនមែនជានិមិត្តសញ្ញាពិតប្រាកដទេ; វាគឺជាការចម្លងលេងសើចដែលយើងគិតថាគួរឱ្យអស់សំណើច។";
	}

	@Override
	public String migradorLegacyCrashAssistant() {
		return "ជំនួយការ Crash Assistant";
	}

	@Override
	public String migradorCrashAssistantDescripcion() {
		return "នាំចូល problematic_mods.json ពី Crash Assistant និងបញ្ចូលវាជាមួយទម្រង់របស់ CrashDetector តាមរយៈជំនួយការ។";
	}

	@Override
	public String migradorEjecutar() {
		return "ដំណើរការជំនួយការ";
	}

	@Override
	public String migradorCompletado() {
		return "ជំនួយការបានបញ្ចប់។";
	}

	@Override
	public String migradorNadaParaMigrar() {
		return "មិនមានអ្វីត្រូវផ្លាស់ប្តូរទេ។";
	}

	// Khmer (ភាសាខ្មែរ)
	@Override
	public String migradorCAUsarPrimitiva() {
		return "ប្រើ GUI ចម្បងដើម";
	}

	@Override
	public String migradorCADeshabilitarChecks() {
		return "បិទការជ្រើសរើស";
	}

	@Override
	public String migradorCAAvisoUrlSoporteWysiwyg() {
		return "តំណភ្ជាប់គាំទ្រមិនត្រូវបានផ្លាស់ប្តូរទេ ព្រោះអ្នកមិនកំពុងប្រើ GUI ដើម។ ដើម្បីផ្លាស់ប្តូរ URL គាំទ្រ សូមប្រើកម្មវិធីកែសម្រួល WYSIWYG នៅក្នុងការកំណត់របស់ CrashDetector។";
	}

	// Khmer (ភាសាខ្មែរ)
	@Override
	public String migradorCAAvisoNoMigrado() {
		return "ការព្រមាន: ដោយសារតែភាពខុសគ្នារវាងប្រភេទការកំណត់រចនាសម្ព័ន្ធ បញ្ជីបដិសេធនៃការផ្ទៀងផ្ទាត់មិនអាចធ្វើចលនាដោយស្វ័យប្រវត្តិបានទេ។ ពីទីនោះ អ្នកក៏អាចបិទការព្រមាន Intel និង Dif នៅក្នុងបញ្ជី Mods បានដែរ; ដូចនៅក្នុង CrashDetector ការទាំងនេះត្រូវបានចាត់ទុកថាជាការត្រួតពិនិត្យធម្មតា។ ប្រសិនបើអ្នកមិនបើករបៀបដើម (primitive mode) ទេ អ្នកនឹងត្រូវប្រើកម្មវិធីកែសម្រួល HTML WYSIWYG នៅក្នុងការកំណត់របស់ CrashDetector ដើម្បីបញ្ចូលតំណភ្ជាប់។ ប្រសិនបើអ្នកប្រើរបៀបដើម តំណភ្ជាប់ជំនួយនឹងត្រូវបានចម្លងដោយស្វ័យប្រវត្តិពី Crash Assistant។ ដើម្បីផ្លាស់ប្តូរពណ៌ និងការកំណត់នៅក្នុងចំណុចប្រទាក់អ្នកប្រើប្រាស់ក្រាហ្វិក (GUI) អ្នកត្រូវទៅកាន់ការកំណត់របស់ CrashDetectors ចូលទៅកាន់តំបន់ CDSkinCape/GUI Editor និងជ្រើសរើសប្រភេទ GUI ព្រមទាំងការអនុវត្តជាក់លាក់របស់វា។ រូបភាពអាចត្រូវបានកែសម្រួលពីទីតាំងដូចខាងក្រោម៖ "
				+ Statics.carpeta.resolve("imagenes").toString()
				+ "។ ស្គ្រីប JEXL ក៏នឹងមិនត្រូវបានធ្វើចលនាដែរ។ ប្រសិនបើអ្នកត្រូវការធ្វើការវិភាគមូលដ្ឋានតាមរយៈការផ្គូផ្គងខ្សែអក្សរ ឬកន្សោមធម្មតា អ្នកអាចប្រើមុខងារ បន្ថែមមូលហេតុ នៅក្នុងការកំណត់សាជីវកម្ម; ប្រសិនបើអ្នកត្រូវការមុខងារកម្រិតខ្ពស់ជាងនេះ អ្នកគួរតែបង្កើតកម្មវិធីបន្ថែមនៅក្នុង Java: https://github.com/FeatureCreepEAP/crashdetector-tutorial-extention-english";
	}
	...
	/*
	 * អត្ថបទលំនាំសម្រាប់ឧបករណ៍ស្កេនពីចម្ងាយ។
	 */

	public String guardAbrirEscanerNube() {
		return "VirusTotal និង MetaDefender";
	}

	public String escanerNubeBotonLateral() {
		return "ឧបករណ៍ស្កេនពពក";
	}

	public String escanerNubeTitulo() {
		return "ឧបករណ៍ស្កេន Mod ដោយប្រើ VirusTotal និង MetaDefender";
	}

	public String escanerNubeMensajeRecuerdoParallelArtistProject() {
		return "យើងនឹករលឹកអ្នកខ្លាំងណាស់។ ភាពច្នៃប្រឌិត ថាមពល និងអ្វីៗគ្រប់យ៉ាងដែលអ្នកបានចែករំលែកជាមួយសហគមន៍ នៅតែមានវត្តមាននៅក្នុងគម្រោងនេះ។ ឧបករណ៍នេះរក្សាទុកនូវអនុស្សាវរីយ៍របស់ Parallel Artist Project ដោយក្តីស្រលាញ់។";
	}

	public String escanerNubeAvisoPrivacidad() {
		return "ជូនដំណឹង៖ នៅពេលដែល Hash មិនមានរបាយការណ៍ ឯកសារ JAR នឹងត្រូវបានផ្ញើទៅកាន់អ្នកផ្តល់សេវាដែលបានជ្រើសរើស។ គំរូដែលបានផ្ទុះឡើងទៅកាន់សេវាសាធារណៈអាចត្រូវបានចែករំលែកជាមួយដៃគូសន្តិសុខ។ ការធ្វើសមកាលកម្មមិនបង្កើនកោតារបស់គណនីទេ ហើយ Thread ច្រើនពេកអាចបណ្តាលឱ្យមានកំហុស HTTP 429។ សូមកុំផ្ញើ Mod ឯកជន ឬសម្ងាត់ដោយមិនបានពិនិត្យមើលលក្ខខណ្ឌគណនីរបស់អ្នក។";
	}

	public String escanerNubeClaveVirusTotal() {
		return "កូនសោ API VirusTotal:";
	}

	public String escanerNubeClaveMetaDefender() {
		return "កូនសោ API MetaDefender:";
	}

	public String escanerNubeNumeroHilos() {
		return "Thread ព្រមគ្នា:";
	}

	public String escanerNubeGuardarClaves() {
		return "រក្សាទុកកូនសោសកល";
	}

	public String escanerNubeEscanearVirusTotal() {
		return "ស្កេនដោយប្រើ VirusTotal";
	}

	public String escanerNubeEscanearMetaDefender() {
		return "ស្កេនដោយប្រើ MetaDefender";
	}

	public String escanerNubeEscanearAmbos() {
		return "ស្កេនដោយប្រើទាំងពីរ";
	}
	...
	public String escanerNubeSeccionClaves() {
		return "កូនសោ API និងការអនុវត្ត";
	}

	public String escanerNubeSeccionResultados() {
		return "លទ្ធផលការវិភាគ";
	}

	public String escanerNubeClavesGuardadas() {
		return "កូនសោ API សកលត្រូវបានរក្សាទុកដោយជោគជ័យ។";
	}

	public String escanerNubeConfirmarSubidaTitulo() {
		return "បញ្ជាក់ការវិភាគពីចម្ងាយ";
	}

	public String escanerNubeConfirmarSubidaMensaje() {
		return "Hash SHA-256 នឹងត្រូវបានសួរនាំជាមុនសិន។ ឯកសារដែលគ្មានរបាយការណ៍នឹងត្រូវបានផ្ទុះឡើងទៅកាន់អ្នកផ្តល់សេវាដែលបានជ្រើសរើស។ តើអ្នកចង់បន្តទេ?";
	}

	public String escanerNubeFaltaClaveVirusTotal() {
		return "ខ្វះកូនសោ API VirusTotal។";
	}

	public String escanerNubeFaltaClaveMetaDefender() {
		return "ខ្វះកូនសោ API MetaDefender។";
	}

	public String escanerNubeSinArchivosJar() {
		return "មិនមានឯកសារ JAR ដែលអាចអានបាននៅក្នុងថត Mod ដែលបានកំណត់រចនាសម្ព័ន្ធ។";
	}

	public String escanerNubeArchivoNoLegible() {
		return "ឯកសារមិនមាន ឬមិនអាចអានបាន។";
	}

	public String escanerNubeImagenNoDisponible() {
		return "រូបភាព Parallel Artist Project មិនមាន";
	}
	...
	public String escanerNubeEstadoEscaneando(int completados, int total) {
		return "កំពុងវិភាគ៖ " + completados + " នៃ " + total;
	}

	public String escanerNubeEstadoCompletado(int completados) {
		return "ការវិភាគបានបញ្ចប់។ កិច្ចការដែលបានបញ្ចប់៖ " + completados;
	}
	...
	public String escanerNubeDetalleInformeExistente() {
		return "លទ្ធផលទទួលបានតាមរយៈការសួរនាំ Hash; ឯកសារមិនត្រូវបានផ្ទុះឡើងវិញទេ។";
	}

	public String escanerNubeDetalleArchivoSubido() {
		return "Hash មិនមានរបាយការណ៍ ហើយឯកសារត្រូវបានផ្ទុះឡើងសម្រាប់ការវិភាគ។";
	}

	public String escanerNubeDetalleSinEstadisticas() {
		return "អ្នកផ្តល់សេវាបានបញ្ចប់សំណើ ប៉ុន្តែមិនបានផ្តល់នូវស្ថិតិដែលអាចប្រើប្រាស់បាន។";
	}

	public String escanerNubeErrorClaveRechazada(String proveedor) {
		return proveedor + "បានបដិសេធកូនសោ API ឬគណនីមិនមានសិទ្ធិសម្រាប់ប្រតិបត្តិការនេះ។";
	}

	public String escanerNubeErrorLimite(String proveedor) {
		return proveedor + "បានបដិសេធសំណើដោយសារតែឈានដល់កម្រិត ឬការគ្រប់គ្រងអត្រារបស់គណនី។";
	}

	public String escanerNubeErrorHttp(String proveedor, int codigo, String detalle) {
		String sufijo = detalle == null || detalle.trim().isEmpty() ? "" : " លម្អិត៖ " + detalle;
		return proveedor + "បានផ្តល់កូដ HTTP " + codigo + "." + sufijo;
	}

	public String escanerNubeErrorRespuestaJson(String proveedor) {
		return proveedor + "បានផ្តល់នូវការឆ្លើយតប JSON មិនត្រឹមត្រូវ។";
	}

	public String escanerNubeErrorTiempoEspera(String proveedor) {
		return "ពេលវេលារង់ចាំសម្រាប់ការវិភាគរបស់ " + proveedor + "បានអស់។";
	}

	public String escanerNubeErrorIdAnalisis() {
		return "អ្នកផ្តល់សេវាមិនបានផ្តល់នូវលេខសម្គាល់ការវិភាគ។";
	}

	public String escanerNubeErrorUrlSubidaVirusTotal() {
		return "VirusTotal មិនបានផ្តល់នូវ URL សម្រាប់ផ្ទុះឡើងឯកសារធំ។";
	}

	public String escanerNubeErrorUrlSubidaNoSegura() {
		return "អ្នកផ្តល់សេវាបានផ្តល់នូវ URLផ្ទុះឡើងដែលមិនប្រើ HTTPS។";
	}

	public String escanerNubeErrorDesconocido() {
		return "មានកំហុសមិនស្គាល់កើតឡើងកំឡុងពេលវិភាគ។";
	}
	...
	public String escanerNubeColorFondo() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌ផ្ទៃខាងក្រោយ";
	}

	public String escanerNubeColorPanel() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌ផ្ទាំង";
	}

	public String escanerNubeColorPanelClaro() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌ផ្ទាំងភ្លឺ";
	}

	public String escanerNubeColorTexto() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌អត្ថបទ";
	}

	public String escanerNubeColorTextoSecundario() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌អត្ថបទបន្ទាប់បន្សំ";
	}

	public String escanerNubeColorCampo() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌វាល";
	}

	public String escanerNubeColorCampoTexto() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌អត្ថបទវាល";
	}

	public String escanerNubeColorVirusTotal() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌សង្កត់ VirusTotal";
	}

	public String escanerNubeColorMetaDefender() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌សង្កត់ MetaDefender";
	}

	public String escanerNubeColorAmbos() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌សង្កត់រួមបញ្ចូល";
	}

	public String escanerNubeColorAdvertencia() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌ការព្រមាន";
	}

	public String escanerNubeColorTabla() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌តារាង";
	}

	public String escanerNubeColorTablaTexto() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌អត្ថបទតារាង";
	}

	public String escanerNubeColorSeleccion() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌ការជ្រើសរើស";
	}

	public String escanerNubeColorSeleccionTexto() {
		return "ឧបករណ៍ស្កេនពពក៖ ពណ៌អត្ថបទដែលបានជ្រើសរើស";
	}
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("km", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("km", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("km", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("km", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("km", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("km", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("km", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("km", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("km", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("km", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("km", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("km", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("km", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("km", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("km", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("km", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("km", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("km", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("km", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("km", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("km", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("km", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("km", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("km", clave, argumentos);
	}
	...
	public String mensajeWatchdogCierreClientePostMain() {
		return "<b style='color:#" + config.obtenerColorAdvertencia() + "'>"
				+ "Minecraft ចំណាយពេលយូរពេកក្នុងការបិទ។</b>" + "<p>ហ្គេមបានបង្កើត៖</p>"
				+ "<code>java.lang.Error: Watchdog (Client shutdown from post-main)</code>"
				+ "<p>របាយការណ៍នេះលេចឡើងនៅពេលដែលដំណើរការ Minecraft នៅតែសកម្មរយៈពេល "
				+ "ប្រហែល 15 វិនាទីបន្ទាប់ពីចាប់ផ្តើមបិទ។</p>"
				+ "<p><b>ជាធម្មតា នេះមិនតំណាងឱ្យមានបញ្ហាធ្ងន់ធ្ងរដោយខ្លួនឯងទេ។</b> "
				+ "វាអាចមានន័យថា Mod, Thread ឬកិច្ចការសម្អាតបានចំណាយពេលយូរពេក " + "ដើម្បីបញ្ចប់នៅពេលបិទ។</p>"
				+ "<p>វាក៏អាចជារបាយការណ៍បន្ទាប់បន្សំដែលបានបង្កើតឡើងខណៈពេលដែលហ្គេមកំពុង "
				+ "បិទរួចហើយបន្ទាប់ពីការដួលរលំផ្សេងទៀត។</p>" + "<p><b>អ្វីដែលត្រូវធ្វើ៖</b></p>" + "<ul>"
				+ "<li>ប្រសិនបើហ្គេមបានបិទដោយត្រឹមត្រូវ ហើយវាកើតឡើងតែម្តងគត់ អ្នកអាចមិនអើពើវា។</li>"
				+ "<li>ប្រសិនបើវាកើតឡើងម្តងហើយម្តងទៀត សូមពិនិត្យមើលកំហុសមុននៅក្នុង " + "<code>latest.log</code>។</li>"
				+ "<li>ស្វែងរក Mods ដែលរក្សាកិច្ចការ ការតភ្ជាប់ ឬដំណើរការឱ្យនៅសកម្មក្នុងអំឡុងពេលបិទ។</li>"
				+ "<li>កុំសន្មត់ថា Thread ចុងក្រោយដែលបានបង្ហាញនៅក្នុង Dump គឺជាអ្នកទទួលខុសត្រូវ។</li>" + "</ul>";
	}

	@Override
	public String nombreWatchdogCierreClientePostMain() {
		return "ការបិទកម្មវិធីយឺត (Watchdog post-main)";
	}
