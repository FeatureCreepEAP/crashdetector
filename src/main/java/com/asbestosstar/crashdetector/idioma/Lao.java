...
//Métodos para Idioma relacionados con la verificación LexForgeMLTransformerEnNeoForge
	...
	public String mensajeOculusIrisUnknownShaderVariable() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				...
				+ "<p><b>ລຳດັບການແກ້ໄຂທີ່ແນະນຳ:</b></p>" + "<ul>"
				...
				+ "<li>ຖ້າທ່ານໃຊ້ mods ການ render ຫຼື ກຣາຟິກອື່ນໆ, ກວດສອບຄວາມບໍ່ເຂົ້າກັນລະຫວ່າງພວກມັນ.</li>" + "</ul>"
	...
	public String mensajeItemNoExiste(String itemFaltante, String namespace) {
		...
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ພະຍາຍາມໃຊ້ໄອເທມທີ່ບໍ່ມີຢູ່.</b>" + "<p>ບັນທຶກຂໍ້ມູນມີແຖວ <b>Item: " + itemHtml
				+ " does not exist</b>.</p>"
				+ "<p>ສິ່ງນີ້ໝາຍຄວາມວ່າ <b>datapack</b>, <b>mod</b> ຫຼື <b>ການຕັ້ງຄ່າ</b> ບາງຢ່າງ "
				+ "ກຳລັງອ້າງອີງເຖິງໄອເທມທີ່ບໍ່ມີໃນເກມ.</p>" + "<p><b>ສິ່ງທີ່ຄວນກວດສອບ:</b></p>" + "<ul>"
				...
				+ "ຫຼື mod ມີບັນຫາ ແລະ ຄວນລຶບມັນອອກ.</li>" + "<li>ຖ້າບໍ່ມີ mod ນັ້ນ, ລອງ <b>ຕິດຕັ້ງມັນ</b>.</li>"
				+ "</ul>" + "<p><b>ເພື່ອຊອກຫາວ່າ mod ຫຼື datapack ໃດກຳລັງຮຽກຮ້ອງໄອເທມນັ້ນ:</b></p>" + "<ul>"
				+ "<li>ໃຊ້ເຄື່ອງມື <b>grepr</b> ຢູ່ແຖບດ້ານຂ້າງ.</li>" + "<li><b>ຢ່າ</b> ເລືອກໂຟลเดอร์.</li>"
				+ "<li>ເປີດໃຊ້ຕົວເລືອກ <b>search in archives</b>.</li>"
				+ "<li>ໃນຊ່ອງຄົ້ນຫາ, ໃສ່ <b>namespace</b>, ນັ້ນຄືສ່ວນກ່ອນເຄື່ອງໝາຍ colon: " + "<b>" + namespaceHtml
				+ "</b>.</li>" + "</ul>"
	...
	public String mensajeCobblemonPinkanIslandsRhyhornModelo() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				...
				+ "<li>ຖ້າບັນຫາເກີດຂຶ້ນຫຼັງຈາກອັບເດດ mod ໜຶ່ງໃນນັ້ນ, ລອງໃຊ້ຄູ່ເວີຊັນອື່ນ.</li>" + "</ul>"
	...
	public String mensajeColdSweatInitDynamicTags() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ກວດພົບຂໍ້ຜິດພາດໃນ Cold Sweat.</b>" + "<p>ບັນທຶກຂໍ້ມູນມີສັນຍານເຊັ່ນ <b>$cold_sweat$onBuildStart</b>, "
				...
				+ "ຫຼື ການປະສົມທີ່ຂັດແຍ່ງກັບ mod ຫຼື datapack ອື່ນ.</p>" + "<p><b>ສິ່ງທີ່ຄວນລອງ:</b></p>" + "<ul>"
				...
				+ "<li>ຖ້າຂໍ້ຜິດພາດເກີດຂຶ້ນຫຼັງຈາກອັບເດດ mods, ລອງໃຊ້ຄູ່ເວີຊັນອື່ນ.</li>" + "</ul>"
	...
	public String mensajeClassCastExceptionGeneral(String lineaClassCast) {
		String detalle = lineaClassCast == null || lineaClassCast.isEmpty() ? ""
				: "<p><b>ແຖວທີ່ພົບ:</b></p><p><code>" + lineaClassCast + "</code></p>";

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ກວດພົບ ClassCastException.</b>"
				+ "<p>ນີ້ໝາຍຄວາມວ່າຄລາສຖືກຈັດການຄືກັບວ່າເປັນຄລາສ ຫຼື ອິນເຕີເຟສອື່ນທີ່ບໍ່ເຂົ້າກັນ.</p>" + detalle
				+ "<p>ຄວາມຜິດພາດປະເພດນີ້ມັກເກີດຈາກສະຖານະການດັ່ງຕໍ່ໄປນີ້:</p>" + "<ul>"
				+ "<li><b>ສອງ mod ທີ່ບໍ່ເຂົ້າກັນ</b> ກັນແລະກັນ.</li>"
				+ "<li><b>Mixins</b>, <b>transformers</b> ຫຼື ແພັດຊ໌ທີ່ປ່ຽນແປງຄລາສ ແລະ ເຮັດໃຫ້ສ່ວນອື່ນຂອງເກມຄາດຫວັງປະເພດທີ່ແຕກຕ່າງ.</li>"
				+ "<li>mod ອື່ນໆທີ່ມີຢູ່ໃນ <b>stacktrace</b> ທີ່ກຳລັງເຮັດໃຫ້ເກີດການແປປະເພດຜິດ.</li>" + "</ul>"
				+ "<p><b>ສິ່ງທີ່ຄວນກວດສອບ:</b></p>" + "<ul>"
				+ "<li>ເບິ່ງແຖວຂອງ <b>stacktrace</b> ທີ່ກ່ຽວຂ້ອງກັບຂໍ້ຜິດພາດນີ້.</li>"
				+ "<li>ໃຫ້ຄວາມສຳຄັນພິເສດກັບຊື່ mod ຫຼື ຄລາສທີ່ມີຮູບແບບ <b>$modid$algo</b>, ເພາະມັກຈະຊີ້ໄປທີ່ mod ທີ່ກ່ຽວຂ້ອງ.</li>"
				+ "<li>ລອງອັບເດດ, ຖອດອອກ, ຫຼື ແຍກ mod ທີ່ເບິ່ງຄືວ່າກ່ຽວຂ້ອງກັບການແປປະເພດທີ່ບໍ່ຖືກຕ້ອງ.</li>" + "</ul>"
				+ "<p>ເຖິງແມ່ນວ່າ <b>ClassCastException</b> ຈະບໍ່ເປັນອັນຕະລາຍສະເໝີໄປ, ແຕ່ມັນກໍ່ມັກຈະເປັນແບບນັ້ນ.</p>";
	}

	@Override
	public String nombreClassCastExceptionGeneral() {
		return "ກວດພົບ ClassCastException";
	}

	@Override
	public String mensajeValkyrienSkiesTournamentLithiumPoiInjection() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ກວດພົບຄວາມບໍ່ເຂົ້າກັນທີ່ເປັນໄປໄດ້ລະຫວ່າງ Valkyrien Skies Tournament ແລະ Lithium/Radium.</b>"
				+ "<p>ບັນທຶກຂໍ້ມູນມີ <b>InvalidInjectionException</b> ທີ່ສະແດງ mixin ຂອງ "
				+ "<b>Lithium</b> ກ່ຽວກັບ <b>POI</b> ພ້ອມກັບ <b>valkyrienskies-common.mixins.json:feature.poi.MixinPOIManager</b>.</p>"
				+ "<p>ບັນຫານີ້ມັກເກີດຂຶ້ນເມື່ອໃຊ້ <b>Lithium ເວີຊັນເກົ່າ</b> ຫຼື <b>fork ທີ່ອີງໃສ່ Lithium ເກົ່າ</b> ເຊັ່ນ "
				+ "<b>Radium Reforged</b> ຮ່ວມກັບ <b>VS Tournament</b>.</p>" + "<p><b>ສິ່ງທີ່ຄວນລອງ:</b></p>" + "<ul>"
				+ "<li>ອັບເດດ <b>Lithium</b> ໃຫ້ເປັນເວີຊັນທີ່ໃໝ່ກວ່າ ແລະ ເຂົ້າກັນໄດ້.</li>"
				+ "<li>ຖ້າທ່ານຢູ່ໃນ <b>Forge/NeoForge</b> ແລະ ກຳລັງໃຊ້ <b>Radium Reforged</b> ຫຼື fork ເກົ່າອື່ນ, ໃຫ້ຖອດອອກ.</li>"
				+ "<li>ແທນທີ່ດ້ວຍການທົດລອງໃຊ້ <b>Harium</b>, ເຊິ່ງເປັນ fork ທັນສະໄໝຂອງ Radium ທີ່ຖືກຊິງໂຄຣນ໌ກັບການປັບປຸງລ່າສຸດຂອງ Lithium.</li>"
				+ "<li>ຖ້າບັນຫາເກີດຂຶ້ນຫຼັງຈາກອັບເດດ mods, ກວດສອບຄູ່ເວີຊັນທີ່ແນ່ນອນລະຫວ່າງ <b>VS Tournament</b> ແລະ mod ປັບປຸງ AI/POI ຂອງທ່ານ.</li>"
				+ "</ul>"
				+ "<p>ໂດຍປົກກະຕິແລ້ວ, ຂໍ້ຜິດພາດນີ້ມັກເກີດຈາກການນຳໃຊ້ <b>Lithium/Radium</b> ເວີຊັນເກົ່າທີ່ບໍ່ເຂົ້າກັນດີກັບ <b>VS Tournament</b>.</p>";
	}

	@Override
	public String nombreValkyrienSkiesTournamentLithiumPoiInjection() {
		return "ຄວາມບໍ່ເຂົ້າກັນລະຫວ່າງ VS Tournament ກັບ Lithium/Radium";
	}

	@Override
	public String mensajeVSTournamentVSConfigClassNoExiste() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "VS Tournament ເບິ່ງຄືວ່າເກົ່າເກີນໄປສຳລັບເວີຊັນ Valkyrien Skies ຂອງທ່ານ.</b>"
				+ "<p>ບັນທຶກຂໍ້ມູນມີ <b>NoClassDefFoundError</b> ສຳລັບ "
				+ "<b>org/valkyrienskies/core/impl/config/VSConfigClass</b> ແລະ ຍັງມີແຖວຈາກ "
				+ "<b>org.valkyrienskies.tournament.TournamentMod.init(...)</b>.</p>"
				+ "<p>ສິ່ງນີ້ມັກໝາຍຄວາມວ່າທ່ານມີ <b>VS Tournament ເວີຊັນເກົ່າ</b> ທີ່ພະຍາຍາມ "
				+ "ໃຊ້ຄລາສພາຍໃນເກົ່າຂອງ <b>Valkyrien Skies</b> ທີ່ບໍ່ມີແລ້ວ.</p>" + "<p><b>ສິ່ງທີ່ຄວນເຮັດ:</b></p>"
				+ "<ul>" + "<li>ຖອດ <b>VS Tournament</b> ເວີຊັນເກົ່າອອກ.</li>"
				+ "<li>ໃຫ້ໃຊ້ <b>VS Tournament Reforged</b> ແທນ.</li>"
				+ "<li>ກວດສອບເພີ່ມວ່າເວີຊັນຂອງ <b>Valkyrien Skies</b> ກົງກັບເວີຊັນທີ່ addon ຮອງຮັບ.</li>" + "</ul>"
				+ "<p>ຄຳແນະນຳໃຫ້ປ່ຽນເປັນ <b>VS Tournament Reforged</b> ສອດຄ່ອງກັບສະຖານະປັດຈຸບັນຂອງໂຄງການ: "
				+ "ເວີຊັນເດີມຂອງ Tournament ຍັງຖືກຈັດວ່າເປັນ mod ເກົ່າສຳລັບ 1.18.2, ໃນຂະນະທີ່ "
				+ "<b>VS Tournament Reforged</b> ເຜີຍແຜ່ແຍກຕ່າງຫາກ ແລະ ປັດຈຸບັນຮອງຮັບ Valkyrien "
				+ "2.4.9+ ໃນ Forge 1.20.1.</p>";
	}
	...
	public String mensajeControlifyRemoveReloadingScreen() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ກວດພົບຄວາມບໍ່ເຂົ້າກັນລະຫວ່າງ Controlify ແລະ Remove Reloading Screen.</b>"
				+ "<p>Log ມີແຖວ <b>Attempted to fetch default config before DefaultConfigManager was ready!</b> "
				+ "ແລະ <b>$rrls$init</b>, ເຊິ່ງມັກຈະບົ່ງບອກເຖິງຄວາມຂັດແຍ່ງລະຫວ່າງ <b>Controlify</b> ແລະ "
	...
	public String mensajeBiomesOPlentyFogDataLiquidosPersonalizados() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ບັນຫາທີ່ເປັນໄປໄດ້ກັບ Biomes O' Plenty ແລະ ທາດແຫຼວທີ່ກຳນົດເອງ.</b>"
				+ "<p>Log ມີຂໍ້ຜິດພາດ <b>class org.joml.Vector4f cannot be cast to class "
	...
	public String mensajeKotlinReflectionInternalErrorVersion() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ກວດພົບຂໍ້ຜິດພາດພາຍໃນການສະທ້ອນຂອງ Kotlin.</b>"
				+ "<p>Log ມີ <b>kotlin.reflect.jvm.internal.KotlinReflectionInternalError</b> ພ້ອມຂໍ້ຄວາມທີ່ຄ້າຍຄື "
	...
	public String mensajeMotionBlurBufferCerrado() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ບັນຫາທີ່ອາດເກີດຂຶ້ນກັບ Motion Blur.</b>"
				+ "<p>Log ມີການອ້າງອີງເຖິງ <b>net.natural.motionblur.shader.FrameBlendingManager.writeBlendParamsUBO</b> "
				+ "ແລະ ຜິດພາດ <b>java.lang.IllegalStateException: Buffer already closed</b>.</p>"
				+ "<p>ແຖວເຫຼົ່ານີ້ອາດຈະປາກົດແຍກກັນໃນ log, ແຕ່ຖ້າຢູ່ນຳກັນມັກຈະຊີ້ບອກວ່າບັນຫາກ່ຽວຂ້ອງ "
				+ "ກັບ mod <b>Motion Blur</b> ຫຼື ການຈັດການ shaders/buffers ກຣາຟິກຂອງມັນ.</p>"
				+ "<p><b>ທາງເລືອກທີ່ແນະນຳ:</b></p>" + "<ul>" + "<li>ລອງເລີ່ມເກມໂດຍບໍ່ມີ <b>Motion Blur</b>.</li>"
				+ "<li>ຖ້າເກມເລີ່ມໄດ້ປົກກະຕິໂດຍບໍ່ມີ mod ນັ້ນ, ໃຫ້ຖອດການຕິດຕັ້ງອອກ ຫຼື ຊອກຫາເວີຊັນທີ່ໃໝ່ກວ່າ.</li>"
				+ "<li>ທ່ານຍັງສາມາດລອງປິດ shaders ຫຼື mods ການ render ອື່ນໆ ຖ້າບັນຫາຍັງຄົງຢູ່.</li>" + "</ul>";
	}

	@Override
	public String nombreMotionBlurBufferCerrado() {
		return "ບັນຫາທີ່ອາດເກີດຂຶ້ນ: Motion Blur";
	}

	@Override
	public String mensajeGeneratorAcceleratorOwoVersion() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ການຂັດແຍ່ງທີ່ອາດເກີດຂຶ້ນກັບ Generator Accelerator.</b>"
				+ "<p>Log ມີຄວາມແຕກຕ່າງລະຫວ່າງລາຍເຊັນ <b>Found</b> ແລະ <b>Available</b>, ພ້ອມກັບຄລາສຈາກ "
				+ "<b>Generator Accelerator</b>, ຕົວຢ່າງ <b>dev/sixik/generator_accelerator/common/features/FastTarget</b>.</p>"
				+ "<p>ຂໍ້ຜິດພາດນີ້ອາດເກີດຈາກ <b>Generator Accelerator</b>. ມັນອາດກ່ຽວຂ້ອງ "
				+ "ກັບຄວາມບໍ່ເຂົ້າກັນລະຫວ່າງ mod ນັ້ນ ແລະ ບາງເວີຊັນຂອງ <b>owo-lib</b>.</p>"
				+ "<p><b>ທາງເລືອກທີ່ແນະນຳ:</b></p>" + "<ul>"
				+ "<li>ລອງເລີ່ມເກມໂດຍບໍ່ມີ <b>Generator Accelerator</b>.</li>"
				+ "<li>ຖ້າເກມເລີ່ມໄດ້ປົກກະຕິ, ໃຫ້ຖອດການຕິດຕັ້ງ mod ນັ້ນອອກ ຫຼື ຊອກຫາເວີຊັນອື່ນ.</li>"
				+ "<li>ລອງອັບເດດ ຫຼື ປ່ຽນເວີຊັນຂອງ <b>owo-lib</b>, ໂດຍສະເພາະຖ້າ mods ອື່ນໆກໍຂຶ້ນກັບ owo ເຊັ່ນກັນ.</li>"
				+ "<li>ກວດສອບວ່າ <b>Generator Accelerator</b>, <b>owo-lib</b>, loader ແລະ ເວີຊັນ Minecraft ເຂົ້າກັນໄດ້.</li>"
				+ "</ul>" + "<p>ສາເຫດທີ່ເປັນໄປໄດ້ຫຼາຍທີ່ສຸດແມ່ນ Generator Accelerator ພະຍາຍາມໃຊ້ການດັດແປງທີ່ມີລາຍເຊັນ "
				+ "ບໍ່ກົງກັບເວີຊັນປັດຈຸບັນຂອງຄລາສ ຫຼື ການຂຶ້ນກັບກັນ.</p>";
	}

	@Override
	public String nombreGeneratorAcceleratorOwoVersion() {
		return "ການຂັດແຍ່ງທີ່ອາດເກີດຂຶ້ນ: Generator Accelerator ແລະ owo-lib";
	}

	@Override
	public String mensajeFabricRenderingApiFaltaIndium() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ຂາດໂປຣແກຣມ render ທີ່ເຂົ້າກັນໄດ້ກັບ Fabric Rendering API.</b>"
				+ "<p>Log ມີຂໍ້ຜິດພາດທີ່ <b>RendererAccess.getRenderer()</b> ສົ່ງຄ່າ <b>null</b>, "
				+ "ເຮັດໃຫ້ເກີດການລົ້ມເຫຼວເມື່ອພະຍາຍາມໃຊ້ <b>Renderer.materialFinder()</b>.</p>"
				+ "<p>ບັນຫານີ້ມັກເກີດຂຶ້ນເມື່ອ <b>Fabric Rendering API</b> ບໍ່ມີຢູ່ຢ່າງຖືກຕ້ອງ. "
				+ "ສາເຫດທົ່ວໄປແມ່ນການໃຊ້ <b>Sodium</b>, ໂດຍສະເພາະເວີຊັນເກົ່າທີ່ທົດແທນ ຫຼື ປິດໃຊ້ງານບາງສ່ວນ "
				+ "ຂອງລະບົບ render ທີ່ mods ອື່ນໆຄາດຫວັງ.</p>" + "<p><b>ວິທີແກ້ໄຂທີ່ແນະນຳ:</b></p>" + "<ul>"
				+ "<li>ຕິດຕັ້ງ mod <b>Indium</b>.</li>"
				+ "<li>ຮັບປະກັນວ່າ <b>Indium</b> ເຂົ້າກັນໄດ້ກັບເວີຊັນ <b>Sodium</b>, Fabric Loader ແລະ Minecraft ຂອງທ່ານ.</li>"
				+ "<li>ຖ້າທ່ານມີ Indium ຕິດຕັ້ງຢູ່ແລ້ວ, ໃຫ້ອັບເດດ <b>Sodium</b>, <b>Indium</b> ແລະ <b>Fabric API</b>.</li>"
				+ "<li>ຖ້າບັນຫາຍັງຄົງຢູ່, ລອງໃຊ້ງານໂດຍບໍ່ມີ Sodium ຊົ່ວຄາວເພື່ອຢືນຢັນວ່າຂໍ້ຜິດພາດກ່ຽວຂ້ອງກັບ renderer.</li>"
				+ "</ul>"
				+ "<p>Indium ປົກກະຕິຈະຟື້ນຟູຄວາມເຂົ້າກັນໄດ້ກັບ Fabric Rendering API ສຳລັບ mods ທີ່ຂຶ້ນກັບລະບົບນັ້ນ "
				+ "ໃນຂະນະທີ່ Sodium ຖືກຕິດຕັ້ງ.</p>";
	}
	...
	public String mensajeEntradaDuplicadaIdModerno() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				...
				+ "ຂໍ້ມູນທີ່ແຕກຕ່າງກັນໂດຍໃຊ້ ID ພາຍໃນດຽວກັນ.</p>" + "<p><b>ທາງເລືອກທີ່ແນະນຳ:</b></p>" + "<ul>"
	...
	public String migradorCAAvisoNoMigrado() {
		return "ຄຳເຕືອນ: ເນື່ອງຈາກຄວາມແຕກຕ່າງຂອງປະເພດການຕັ້ງຄ່າ, ລາຍການຫ້າມ (denylist) ຂອງການກວດສອບບໍ່ສາມາດຍ້າຍໄດ້ໂດຍອັດຕະໂນມັດ. ຈາກທີ່ນັ້ນ, ທ່ານຍັງສາມາດປິດການເຕືອນຂອງ Intel ແລະ Mod List Diff; ຄືກັນກັບໃນ CrashDetector, ສິ່ງເຫຼົ່ານີ້ຖືວ່າເປັນການກວດສອບປົກກະຕິ. ຖ້າທ່ານບໍ່ເປີດໃຊ້ໂໝດດັ້ງເດີມ, ທ່ານຈະຕ້ອງໃຊ້ຕົວແກ້ໄຂ HTML WYSIWYG ໃນການຕັ້ງຄ່າຂອງ CrashDetector ເພື່ອໃສ່ລິ້ງ. ຖ້າທ່ານໃຊ້ໂໝດດັ້ງເດີມ, ລິ້ງຊ່ວຍເຫຼືອຈະຖືກຄັດລອກໂດຍອັດຕະໂນມັດຈາກ Crash Assistant. ເພື່ອປ່ຽນສີ ແລະ ການຕັ້ງຄ່າໃນກາຟິກອິນເຕີເຟດ (GUI), ທ່ານຕ້ອງໄປທີ່ການຕັ້ງຄ່າຂອງ CrashDetector, ເຂົ້າເຖິງພື້ນທີ່ຂອງ CDSkinCape/GUI Editor ແລະ ເລືອກປະເພດຂອງ GUI, ພ້ອມທັງການນຳໃຊ້ສະເພາະຂອງມັນ. ຮູບພາບສາມາດແກ້ໄຂໄດ້ຈາກຕຳແໜ່ງຕໍ່ໄປນີ້: "
				+ Statics.carpeta.resolve("imagenes").toString()
				+ ". ສຄຣິບ JEXL ກໍຈະບໍ່ຖືກຍ້າຍເຊັ່ນກັນ. ຖ້າທ່ານຕ້ອງການພຽງແຕ່ການວິເຄາະພື້ນຖານໂດຍການຈັບຄູ່ຂໍ້ຄວາມ ຫຼື ນິຍາມປົກກະຕິ (regex), ທ່ານສາມາດໃຊ້ຟັງຊັນ 'Agregar Razones' ໃນການຕັ້ງຄ່າຂອງບໍລິສັດ; ຖ້າທ່ານຕ້ອງການຄຸນສົມບັດທີ່ກ້າວໜ້າຫຼາຍຂຶ້ນ, ທ່ານຄວນສ້າງເອັກສະເຕນຊັນໃນ Java: https://github.com/FeatureCreepEAP/crashdetector-tutorial-extention-english";
	}
	...
	public String ideScriptProyectoDeshabilitadoAviso() {
		return "ປະເພດໂຄງການນີ້ມີຢູ່ໃນ GUI ແລ້ວ, ແຕ່ຖືກປິດໃຊ້ງານຈົນກວ່າຈະເພີ່ມ language server ຫຼື ຕົວວິເຄາະຂອງມັນ.";
	}
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("lo", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("lo", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("lo", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("lo", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("lo", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("lo", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("lo", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("lo", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("lo", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("lo", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("lo", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("lo", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("lo", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("lo", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("lo", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("lo", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("lo", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("lo", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("lo", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("lo", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("lo", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("lo", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("lo", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("lo", clave, argumentos);
	}
