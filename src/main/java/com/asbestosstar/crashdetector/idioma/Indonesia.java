...
// Di kelas bahasa Anda:
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("id", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("id", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("id", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("id", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("id", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("id", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("id", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("id", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("id", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("id", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("id", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("id", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("id", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("id", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("id", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("id", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("id", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("id", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("id", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("id", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("id", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("id", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("id", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("id", clave, argumentos);
	}
	...
	public String busquedaBinariaModsBotonLateral() {
		return "Pencarian biner mod";
	}

	@Override
	public String busquedaBinariaModsTitulo() {
		return "Pencarian biner mod — Anya Nyabyss";
	}

	@Override
	public String busquedaBinariaModsDescripcion() {
		return "Menonaktifkan sementara sekitar separuh mod, meluncurkan ulang gim dengan CDLauncher, lalu mempersempit daftar tersangka berdasarkan hasil setiap pengujian.";
	}

	@Override
	public String busquedaBinariaModsAdvertenciaVariosMods() {
		return "Penting: pencarian ini mengasumsikan satu mod menyebabkan masalah. Hasilnya tidak dapat diandalkan bila dua mod atau lebih menyebabkannya secara terpisah, atau bila kegagalan bergantung pada interaksi beberapa mod.";
	}

	@Override
	public String busquedaBinariaModsProteccionDependencias() {
		return "Perlindungan dependensi: bila sebuah dependensi dinonaktifkan, mod yang bergantung padanya juga dinonaktifkan. Mod yang tetap aktif tidak akan kehilangan dependensi yang terdeteksi.";
	}

	@Override
	public String busquedaBinariaModsIniciar() {
		return "Mulai pencarian";
	}

	@Override
	public String busquedaBinariaModsProblemaPersiste() {
		return "Masalah tetap terjadi";
	}

	@Override
	public String busquedaBinariaModsProblemaDesaparecio() {
		return "Masalah menghilang";
	}
	...
	public String busquedaBinariaModsDesactivados() {
		return "Mod yang dinonaktifkan untuk pengujian ini";
	}
	...
	public String busquedaBinariaModsEstado(String clave, int ronda, int candidatos, int desactivados, String detalle) {
		...
		switch (clave) {
		case "sin_sesion":
			return "Tidak ada pencarian aktif.";
		case "recuperacion":
			return "Ada sesi yang terputus. Pulihkan mod sebelum melanjutkan.";
		case "escaneando":
			return "Menganalisis mod dan dependensi…";
		case "juego_activo":
			return "Gim hasil peluncuran ulang sudah berjalan.";
		case "restaurando":
			return "Memulihkan mod…";
		case "preparando":
			return "Menyiapkan putaran " + ronda + " (" + candidatos + " / " + desactivados + ")";
		case "lanzando":
			return "Meluncurkan ulang gim untuk putaran " + ronda + " (" + candidatos + " / " + desactivados + ")";
		case "juego":
			return "Gim berjalan untuk putaran " + ronda + " (" + candidatos + " / " + desactivados + ")";
		case "esperando":
			return "Gim telah berakhir. Nyatakan apakah masalah tetap terjadi atau menghilang.";
		case "ronda_persiste":
			return "Putaran ditandai: masalah tetap terjadi.";
		case "ronda_desaparece":
			return "Putaran ditandai: masalah menghilang.";
		case "restaurado":
			return "Semua mod telah dipulihkan.";
		case "sin_mods":
			return "Diperlukan sedikitnya dua mod aktif.";
		case "sin_division":
			return "Sisa mod tidak dapat dibagi tanpa merusak dependensi yang terdeteksi.";
		case "inconsistente":
			return "Hasil tidak konsisten. Biasanya ini berarti ada beberapa penyebab atau interaksi antar-mod.";
		default:
			return detalle == null ? "" : detalle;
		}
	}
	...
	public String busquedaBinariaModsConfirmacion() {
		return "Alat akan mengganti nama berkas mod sementara dan meluncurkan ulang gim. Manifes pemulihan akan dibuat. Lanjutkan?";
	}

	@Override
	public String busquedaBinariaModsResultadoUnico(String mod) {
		return "Mod tersangka berhasil diisolasi: " + mod;
	}

	@Override
	public String busquedaBinariaModsResultadoGrupo(String mods) {
		return "Kelompok dependensi ini tidak dapat dipisahkan: " + mods;
	}

	@Override
	public String busquedaBinariaModsError(String detalle) {
		return "Galat pencarian biner: " + detalle;
	}
