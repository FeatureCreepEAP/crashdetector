...
public class Arabe implements Idioma {
	...
	public String javaProblematica() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "تم اكتشاف انهيار أصلي في بيئة تشغيل Java (JVM).</b>"
				+ "<p>يحدث هذا النوع من الأخطاء داخل آلة Java الافتراضية نفسها (على سبيل المثال، في <code>jvm.dll</code> أو <code>libjvm.so</code>، إلخ)، "
				+ "ولا يسببه بالضرورة أحد الـ mods.</p>"
				+ "<p>على الرغم من أنه في حالات نادرة قد ينشأ عن mods تستخدم مكتبات أصلية غير متوافقة، "
				+ "<b>إلا أن الأرجح بكثير أنه يرجع إلى نسخة معيبة أو تالفة أو قديمة من JVM</b>.</p>"
				+ "<p>هذا شائع بشكل خاص إذا كنت تستخدم بناءً قديمًا أو غير رسمي لنسخة Java الخاصة بك (على سبيل المثال، إصدارات مجتمعية بدون دعم).</p>"
				+ "<p><b>نوصي باستخدام JVM موثوق ومُدار:</b></p>" + "<ul>"
				+ "<li><b>Red Hat Build of OpenJDK</b> (مستقر، مختبر جيدًا، مثالي لـ Windows/Linux)</li>"
				+ "<li><b>OpenLogic OpenJDK</b> (دعم متعدد المنصات، بما في ذلك macOS Intel)</li>"
				+ "<li><b>Azul Zulu</b> (معتمد، مع دعم LTS مجاني)</li>"
				+ "<li><b>Oracle JDK</b> (رسمي، مع تحديثات منتظمة)</li>" + "</ul>"
				+ "<p>تجنب الإصدارات غير المعروفة أو المخصصة أو القديمة جدًا، حيث قد تحتوي على أخطاء حرجة في محرك JVM.</p>"
				+ "<p><b>هل تستخدم Prism Launcher أو TLauncher؟</b> من السهل جدًا إعداد JVM مخصص: "
				+ "في Prism Launcher، اذهب إلى <i>Instalaciones</i> → <i>Editar instancia</i> → <i>Configuración de Java</i>; "
				+ "في TLauncher، اذهب إلى <i>Settings</i> → <i>Java Settings</i> وحدد مسار JDK/JRE الذي قمت بتنزيله. "
				+ "من الممكن أيضًا أن يعاني جامع القمامة الخاص بك من مشاكل؛ في هذه الحالة، يجب عليك التبديل إلى ZGC."

				+ "لست بحاجة إلى تغيير JVM الخاص بالنظام!</p>";
	}
	...
	public String mensajeCobblemonPinkanIslandsRhyhornModelo() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "تم اكتشاف خطأ في النموذج الخاص بـ Rhyhorn.</b>"
	...
	public String mensajeClassCastExceptionGeneral(String lineaClassCast) {
		String detalle = lineaClassCast == null || lineaClassCast.isEmpty() ? ""
				: "<p><b>السطر المكتشف:</b></p><p><code>" + lineaClassCast + "</code></p>";

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "تم اكتشاف ClassCastException.</b>"
				+ "<p>هذا يعني أنه تم التعامل مع فئة (class) كما لو كانت فئة أو واجهة (interface) أخرى غير متوافقة.</p>"
				+ detalle + "<p>عادةً ما ينتج هذا النوع من الأخطاء عن أحد المواقف التالية:</p>" + "<ul>"
				+ "<li><b>إضافتان (mods) غير متوافقتين</b> مع بعضهما البعض.</li>"
				+ "<li><b>Mixins</b>، أو <b>transformers</b>، أو تصحيحات (patches) تعدّل فئةً ما وتجعل جزءًا آخر من اللعبة يتوقع نوعًا مختلفًا.</li>"
				+ "<li>إضافات أخرى موجودة في <b>stacktrace</b> تتسبب في التحويل الخاطئ (miscast).</li>" + "</ul>"
				+ "<p><b>ما يجب التحقق منه:</b></p>" + "<ul>"
				+ "<li>راجع الأسطر في <b>stacktrace</b> المرتبطة بهذا الخطأ.</li>"
				+ "<li>أولِ اهتمامًا خاصًا لأسماء الإضافات أو الفئات بالتنسيق <b>$modid$algo</b>، لأنها عادةً ما تشير إلى الإضافات المعنية.</li>"
				+ "<li>حاول تحديث، أو إزالة، أو فصل الإضافات التي يبدو أنها مرتبطة بالتحويل غير الصالح.</li>" + "</ul>"
				+ "<p>على الرغم من أن <b>ClassCastException</b> ليس دائمًا قاتلًا، إلا أنه غالبًا ما يكون كذلك.</p>";
	}

	@Override
	public String nombreClassCastExceptionGeneral() {
		return "تم اكتشاف ClassCastException";
	}

	@Override
	public String mensajeValkyrienSkiesTournamentLithiumPoiInjection() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "تم اكتشاف عدم توافق محتمل بين Valkyrien Skies Tournament و Lithium/Radium.</b>"
				+ "<p>يحتوي السجل على <b>InvalidInjectionException</b> حيث يظهر mixin من "
				+ "<b>Lithium</b> على <b>POI</b> مع <b>valkyrienskies-common.mixins.json:feature.poi.MixinPOIManager</b>.</p>"
				+ "<p>تحدث هذه المشكلة عادةً عند استخدام إصدار <b>قديم من Lithium</b> أو "
				+ "<b>fork يعتمد على Lithium قديم</b>، مثل <b>Radium Reforged</b>، مع " + "<b>VS Tournament</b>.</p>"
				+ "<p><b>ما يجب تجربته:</b></p>" + "<ul>" + "<li>قم بتحديث <b>Lithium</b> إلى إصدار أحدث ومتوافق.</li>"
				+ "<li>إذا كنت تستخدم <b>Forge/NeoForge</b> وتستخدم <b>Radium Reforged</b> أو fork قديم آخر، قم بإزالته.</li>"
				+ "<li>بدلاً من ذلك، جرب <b>Harium</b>، وهو fork حديث لـ Radium متزامن مع التحسينات الأخيرة لـ Lithium.</li>"
				+ "<li>إذا بدأت المشكلة بعد تحديث الإضافات، راجع المجموعة الدقيقة بين <b>VS Tournament</b> وإضافة تحسين الذكاء الاصطناعي/POI الخاصة بك.</li>"
				+ "</ul>"
				+ "<p>عمليًا، ينشأ هذا العطل عادةً من تنفيذ قديم لـ <b>Lithium/Radium</b> لا يتوافق بشكل جيد مع <b>VS Tournament</b>.</p>";
	}

	@Override
	public String nombreValkyrienSkiesTournamentLithiumPoiInjection() {
		return "عدم توافق VS Tournament مع Lithium/Radium";
	}

	@Override
	public String mensajeVSTournamentVSConfigClassNoExiste() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "يبدو أن VS Tournament قديم جدًا لإصدار Valkyrien Skies لديك.</b>"
				+ "<p>يحتوي السجل على خطأ <b>NoClassDefFoundError</b> لـ "
				+ "<b>org/valkyrienskies/core/impl/config/VSConfigClass</b> وكذلك سطر من "
				+ "<b>org.valkyrienskies.tournament.TournamentMod.init(...)</b>.</p>"
				+ "<p>يعني هذا عادةً أن لديك إصدارًا <b>قديمًا من VS Tournament</b> يحاول "
				+ "استخدام فئات داخلية قديمة من <b>Valkyrien Skies</b> لم تعد موجودة.</p>"
				+ "<p><b>ما يجب فعله:</b></p>" + "<ul>" + "<li>أزل <b>VS Tournament</b> القديم.</li>"
				+ "<li>استخدم <b>VS Tournament Reforged</b> بدلاً منه.</li>"
				+ "<li>تأكد أيضًا من أن إصدار <b>Valkyrien Skies</b> يتوافق مع الإصدار المدعوم من قبل الإضافة.</li>"
				+ "</ul>" + "<p>تتوافق توصية التحويل إلى <b>VS Tournament Reforged</b> مع الحالة الحالية للمشروع: "
				+ "لا تزال النسخة الأصلية من Tournament مدرجة كمود قديم لـ 1.18.2، بينما "
				+ "يتم نشر <b>VS Tournament Reforged</b> بشكل منفصل ويُعلن حاليًا عن دعمه لـ Valkyrien "
				+ "2.4.9+ على Forge 1.20.1.</p>";
	}
	...
	public String mensajeEntradaDuplicadaIdModerno() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				...
				+ "إدخالات مختلفة باستخدام نفس المعرف الداخلي.</p>" + "<p><b>الخيارات الموصى بها:</b></p>" + "<ul>"
	...
	public String nombreOpenGLMemoriaInsuficiente() {
		return "OpenGL – ذاكرة فيديو غير كافية";
	}

	@Override
	public String mensajeOpenGLMemoriaInsuficiente() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "أنتج Minecraft خطأ OpenGL بسبب نقص في الذاكرة الرسومية.</b>" + "<p>أطلق اللعبة:</p>"
				+ "<code>GL_OUT_OF_MEMORY</code>"
				+ "<p>هذا يعني عادةً أن بطاقة الرسومات أو النظام لم يتمكنوا من حجز ذاكرة كافية للملمسات، الظلال، النماذج، المخازن المؤقتة أو المؤثرات البصرية.</p>"
				+ "<p><b>الأسباب الشائعة:</b></p>" + "<ul>" + "<li>ظلال (Shaders) ثقيلة جداً.</li>"
				+ "<li>حزم موارد (Resource packs) عالية الدقة.</li>"
				+ "<li>الكثير من mods البصرية أو المتعلقة بالتصيير.</li>" + "<li>مسافة التصيير عالية جداً.</li>"
				+ "<li>قلة ذاكرة VRAM المتاحة.</li>" + "<li>تعريفات فيديو قديمة أو غير مستقرة.</li>" + "</ul>"
				+ "<p><b>الحل الموصى به:</b></p>" + "<ul>" + "<li>تعطيل الظلال مؤقتاً.</li>"
				+ "<li>استخدام حزم موارد ذات دقة أقل.</li>" + "<li>خفض مسافة التصيير والمحاكاة.</li>"
				+ "<li>تقليل جودة الرسومات، الظلال، الجسيمات و Mipmaps.</li>" + "<li>تحديث تعريفات بطاقة الرسومات.</li>"
				+ "<li>إغلاق البرامج الأخرى التي تستخدم GPU أو ذاكرة كبيرة.</li>" + "</ul>"
	...
	public String migradorCAAvisoNoMigrado() {
		return "تنبيه: بسبب الاختلافات بين أنواع الإعدادات، لا يمكن ترحيل قائمة الرفض للتحقق تلقائياً. من هناك، يمكنك أيضاً تعطيل تحذيرات Intel و Dif في قائمة الـ Mods؛ كما هو الحال في CrashDetector، تُعتبر هذه تحققات عادية. إذا لم تقم بتمكين الوضع البدائي (primitive mode)، سيتعين عليك استخدام محرر HTML المرئي (WYSIWYG) في إعدادات CrashDetector لإدراج الروابط. إذا استخدمت الوضع البدائي، سيتم نسخ رابط المساعدة تلقائياً من Crash Assistant. لتغيير الألوان والإعدادات في واجهة المستخدم الرسومية (GUI)، يجب التوجه إلى إعدادات CrashDetectors، والدخول إلى منطقة CDSkinCape/GUI Editor وتحديد نوع واجهة المستخدم، بالإضافة إلى التنفيذ المحدد لها. يمكن تعديل الصور من الموقع التالي: "
				+ Statics.carpeta.resolve("imagenes").toString()
				+ ". لن يتم ترحيل نصوص JEXL أيضاً. إذا كنت تحتاج فقط إلى إجراء تحليلات أساسية عبر مطابقة السلاسل النصية أو التعبيرات النمطية، يمكنك استخدام وظيفة \"إضافة أسباب\" في إعدادات المؤسسة؛ وإذا كنت تتطلب وظائف أكثر تقدماً، ينبغي عليك إنشاء امتداد بلغة Java: https://github.com/FeatureCreepEAP/crashdetector-tutorial-extention-english";
	}
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("ar", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("ar", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("ar", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("ar", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("ar", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("ar", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("ar", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("ar", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("ar", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("ar", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("ar", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("ar", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("ar", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("ar", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("ar", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("ar", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("ar", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("ar", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("ar", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("ar", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("ar", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("ar", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("ar", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("ar", clave, argumentos);
	}
