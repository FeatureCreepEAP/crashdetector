...
//}
	...
	public String migradorCAAvisoNoMigrado() {
		return "คำเตือน: เนื่องจากความแตกต่างระหว่างประเภทการตั้งค่า รายการปฏิเสธ (denylist) ของการตรวจสอบไม่สามารถย้ายได้โดยอัตโนมัติ จากที่นั่น คุณยังสามารถปิดการเตือนของ Intel และ Mod List Diff ได้; เช่นเดียวกับใน CrashDetector สิ่งเหล่านี้ถือเป็นการตรวจสอบปกติ หากคุณไม่เปิดใช้งานโหมดดั้งเดิม คุณจะต้องใช้ตัวแก้ไข HTML WYSIWYG ในการตั้งค่าของ CrashDetector เพื่อแทรกลิงก์ หากคุณใช้โหมดดั้งเดิม ลิงก์ช่วยเหลือจะถูกคัดลอกอัตโนมัติจาก Crash Assistant ในการเปลี่ยนสีและการตั้งค่าในอินเทอร์เฟซกราฟิก (GUI) คุณต้องไปที่การตั้งค่าของ CrashDetector เข้าถึงพื้นที่ของ CDSkinCape/GUI Editor และเลือกประเภทของ GUI รวมถึงการใช้งานเฉพาะของมัน รูปภาพสามารถแก้ไขได้จากตำแหน่งต่อไปนี้: "
				+ Statics.carpeta.resolve("imagenes").toString()
				+ ". สคริปต์ JEXL ก็จะไม่ถูกย้ายเช่นกัน หากคุณต้องการเพียงการวิเคราะห์พื้นฐานผ่านการจับคู่สตริงหรือนิพจน์ปกติ คุณสามารถใช้ฟังก์ชัน 'Agregar Razones' ในการตั้งค่าองค์กร; หากคุณต้องการฟังก์ชันขั้นสูงกว่านี้ คุณควรสร้างส่วนขยายในภาษาจาวา: https://github.com/FeatureCreepEAP/crashdetector-tutorial-extention-english";
	}
	...
	public String migradorCAModoPrincipalAviso() {
		return "เลือกวิธีที่จะย้าย GUI หลัก 'centro_soporte' คล้ายกับ GUI เริ่มต้นของ Crash Assistant มากที่สุด แต่ไม่แนะนำ โดยเฉพาะสำหรับผู้เล่น DIY เพราะมีป๊อปอัปมากมายและการออกแบบที่ไม่ดี มีไว้เพื่อช่วยย้ายจากระบบเก่าของ Crash Assistant เท่านั้น 'primitiva' เป็น GUI ที่เรียบง่ายมาก ใช้เฉพาะสำหรับการแชร์ แนะนำเฉพาะสำหรับมอดแพ็ก ไม่ใช่ผู้ใช้ DIY หากคุณปิดการตรวจสอบที่ไม่จำเป็นทั้งหมด และก็มีปัญหาป๊อปอัปเช่นกัน 'original' จะรักษา GUI หลักปัจจุบันของคุณไว้ และมักจะเป็นตัวเลือกที่แนะนำสำหรับผู้ใช้ส่วนใหญ่";
	}

	@Override
	public String migradorCASitioLoggingAviso() {
		return "เลือกว่าคุณต้องการย้ายไซต์บันทึกจาก Crash Assistant หรือรักษาไซต์ปัจจุบันของ CrashDetector ไว้ Crash Assistant มักใช้ gnomebot.dev ซึ่งไม่แนะนำให้ใช้เมื่อเทียบกับ SecureLogger, PastesDev หรือ CDPaste สำหรับผู้ใช้ส่วนใหญ่ แนะนำให้รักษาไซต์ปัจจุบันไว้";
	}

	@Override
	public String ideScriptTitulo() {
		return "IDE สำหรับสคริปต์";
	}
	...
	public String ideScriptProyectoDeshabilitadoAviso() {
		return "ประเภทโปรเจกต์นี้มีอยู่ใน GUI แล้ว แต่ถูกปิดใช้งานจนกว่าจะเพิ่มเซิร์ฟเวอร์ภาษาหรือตัววิเคราะห์ของมัน";
	}
	...
	public String ideScriptConfirmarDescargaDeps(int cantidad, String lista) {
		return "จะดาวน์โหลด dependencies จำนวน " + cantidad + " รายการสำหรับ IDE สคริปต์:\n\n" + lista
				+ "\nหลังจากนั้นอาจจำเป็นต้องรีสตาร์ทเพื่อให้เข้าสู่ classpath";
	}

	@Override
	public String ideScriptDepsDescargadas(String mensaje) {
		return "ผลการดาวน์โหลด:\n\n" + mensaje + "\n\nรีสตาร์ทโปรแกรมหากคลาสยังไม่ปรากฏใน classpath";
	}
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("th", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("th", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("th", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("th", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("th", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("th", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("th", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("th", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("th", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("th", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("th", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("th", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("th", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("th", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("th", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("th", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("th", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("th", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("th", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("th", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("th", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("th", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("th", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("th", clave, argumentos);
	}
