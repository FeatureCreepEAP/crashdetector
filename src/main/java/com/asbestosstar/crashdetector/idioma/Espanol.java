...
public class Espanol implements Idioma {
	...
	public String no_se_donde_esta_jar() {
		return "<span style='color:#" + config.obtenerColorError() + "'>No se donde esta el archivo JAR de "
	...
	public String local_headless(String archivo) {
		return "<span style='color:#" + config.obtenerColorInfo() + "'>Tu Informe de " + Statics.nombre_cd.obtener()
				+ " esta aqui <a href='" + archivo + "' style='color:#" + config.obtenerColorEnlace()
				+ "'>ver informe</a></span>";
	}

	@Override
	public String texto_de_gui() {
		return "<span style='color:#" + config.obtenerColorInfo() + "'>Esta es el GUI de " + Statics.nombre_cd.obtener()
				+ ". Si el juego cierra sin problemas, ignoralo.</span>";
	}
...
//}
	...
	public String arco() {
		return "Este diálogo te permite compartir registros utilizando la API de SecureLogger "
				...
				+ "los registros irán al sitio de registros seleccionado. " + Statics.nombre_cd.obtener()
				+ " tiene una anonimización de registros predeterminada, que intenta eliminar nombres de usuario, UUID, "
				...
				+ "El Diálogo de Compartir de " + Statics.nombre_cd.obtener()
				+ " es simplemente una interfaz que te permite gestionar eso. "
	...
	public String errorSSL() {
		return "Tienes Error SSL. Es común con versiones de Java viejas, "
				...
				+ "como los archivos JAR del instalador de MinecraftForge, la función para compartir informes " + "de "
				+ Statics.nombre_cd.obtener()
				+ " al usar el endpoint predeterminado, algunos mods que requieren internet "
	...
	public String ajustesCrashDetector() {
		// TODO Auto-generated method stub
		return "Ajustes " + Statics.nombre_cd.obtener();
	}
	...
	public String transformacionDeMinecraftCodigo0() {
		return "Solo abrir " + Statics.nombre_cd.obtener() + " en falla";
	}
	...
	public String tieneErrorIPV6() {
		return "<b style='color:#" + config.obtenerColorError() + "'>"
				...
				+ "2) Usar el botón 'QuickFix' en " + Statics.nombre_cd.obtener()
				+ " para aplicar un parche que active esta configuración automáticamente." + "</b>";
	}
	...
	@Override
	public String noRegistroDeLauncher() {
		return "GENÉRICO: Seleccione el tipo de launcher que está utilizando. Los registros del launcher (launcher_log.txt, stdout, etc.) contienen información crucial sobre errores que no aparecen en latest.log. "
				+ Statics.nombre_cd.obtener()
				+ " no puede leer los registros de tu Launcher, es posible que no tenga un archivo de registro y deba pegar los registros manualmente.<br>"
	...
	public String habilitarProxySysOutSysErrMensaje() {
		return "¿Habilitar ProxySysOutSysErr?\n\n" + "Esta opción da a " + Statics.nombre_cd.obtener()
				+ " acceso a System.out y System.err cuando el launcher no proporciona registros.\n\n"
	...
	public String proxyHabilitadoMensaje() {
		return "ProxySysOutSysErr habilitado correctamente.\n\n" + "Se requiere reiniciar "
				+ Statics.nombre_cd.obtener() + " para que los cambios surtan efecto.";
	}
...
//En tu clase de idioma:
	...
	public String error_modlauncher_path() {
		return "<b style='color:#" + config.obtenerColorError() + "'>"
				...
				+ "Componentes de servicios comunes en ModLauncher incluyen " + Statics.nombre_cd.obtener() + ", "
	...
	public String lanzadoresRecomendadosAviso() {
		return "Estos lanzadores son los que " + Statics.nombre_cd.obtener() + " sugiere como buenos.";
	}
	...
	public String modsNoRecomendadosAviso() {
		return "Aquí puedes registrar mods desaconsejados para que " + Statics.nombre_cd.obtener()
				+ " los detecte si están instalados.";
	}
	...
	public String anularNormalDescripcion() {
		// TODO Auto-generated method stub
		return Statics.nombre_cd.obtener() + " debería avisar aunque no crashee";
	}

	@Override
	public String modsRecomendadosAviso() {
		return "Registra mods que " + Statics.nombre_cd.obtener() + " recomienda. Si faltan, "
				+ Statics.nombre_cd.obtener() + " puede avisar.";
	}
	...
	public String descripcionDerechosPirateria() {
		return "" + "Si decides habilitar la advertencia antipiratería, se recomienda definir aquí "
				...
				+ "• El derecho a utilizar el anonimizado de registros (logs) integrado en "
				+ Statics.nombre_cd.obtener() + ".\n\n"
	...
	public String advertenciaHashLento() {
		return "Advertencia: añadir muchos archivos grandes puede hacer que la verificación " + "tarde varios minutos. "
				+ Statics.nombre_cd.obtener() + " deberá calcular el hash de cada archivo "
	...
	public String mensajeDeSylentBell() {
		...
		return "<html><div style='width:150px; text-align:center;'>"
				...
				+ "solo pensamos que sería gracioso ponerla aquí. " + Statics.nombre_cd.obtener() + " es secular."
				+ "</div></html>";
	}
	...
	public String cdlauncherDescripcionCompleta() {
		return "" + "<b>Herramientas de depuración</b><br><br>"
				+ "Aquí puedes activar funciones avanzadas para depurar " + Statics.nombre_cd.obtener()
				+ " y tus juegos.<br><br>"
				...
				+ "Si necesitas probar un servidor multijugador en modo online, puede ser necesario permitir la transferencia del token de acceso al proceso de "
				+ Statics.nombre_cd.obtener() + " desde los ajustes de privacidad. "
	...
	public String compartirInstanciaPolitica7() {
		return "Si incluyes la carpeta interna de " + Statics.nombre_cd.obtener()
				+ ", también viajarán configuraciones, registros y datos auxiliares, así que puedes deseleccionarla si no hace falta.";
	}
	...
	public String jgitReiniciarParaCargarClasspath() {
		return "Reinicia " + Statics.nombre_cd.obtener() + " para que los nuevos JARs entren al classpath.";
	}
	...
	public String errorCrashProvocadoPorComando(String comandoDetectado) {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				...
				+ "usó un comando diseñado para provocar un crash manualmente.</p>" + "<p><b>Qué revisar:</b></p>"
				+ "<ul>" + "<li>Revisa quién ejecutó el comando en la consola o dentro del juego.</li>"
	...
	public String tituloCrearConfigBBE() {
		return "Crear configuración de Better Block Entities";
	}

	public String descripcionCrearConfigBBE() {
		return "No existe el archivo BBEConfig.json.";
	}

	public String sugerenciaCrearConfigBBE() {
		return "Crear BBEConfig.json con optimizaciones para cofres, shulkers, carteles, camas, campanas y banners.";
	}

	public String tituloActivarOptimizacionMaestraBBE() {
		return "Activar optimización maestra de BBE";
	}

	public String descripcionActivarOptimizacionMaestraBBE() {
		return "Better Block Entities no parece tener activada la optimización principal.";
	}

	public String sugerenciaActivarOptimizacionMaestraBBE() {
		return "Agregar {\"option\":\"optimize.master\",\"value\":true}";
	}

	public String tituloActivarCullingTextoCartelesBBE() {
		return "Activar culling de texto de carteles";
	}

	public String descripcionActivarCullingTextoCartelesBBE() {
		return "Reduce el renderizado de texto de carteles a distancia.";
	}

	public String sugerenciaActivarCullingTextoCartelesBBE() {
		return "Agregar {\"option\":\"misc.sign_text_culling\",\"value\":true}";
	}

	public String tituloAumentarSleepDelayEntityCulling() {
		return "Aumentar sleepDelay de EntityCulling";
	}

	public String descripcionAumentarSleepDelayEntityCulling() {
		return "EntityCulling revisará entidades con menos frecuencia.";
	}
	...
	public String tituloSubirLimiteHitboxEntityCulling() {
		return "Subir límite de hitbox";
	}

	public String descripcionSubirLimiteHitboxEntityCulling() {
		return "Permite un comportamiento de culling más agresivo antes de caer en rutas más lentas.";
	}
	...
	public String tituloDesactivarDatosF3EntityCulling() {
		return "Desactivar datos F3 de EntityCulling";
	}

	public String descripcionDesactivarDatosF3EntityCulling() {
		return "Quita información extra de depuración del mod.";
	}
	...
	public String tituloActivarBufferingSignsImmediatelyFast() {
		return "Activar buffering experimental de carteles";
	}

	public String descripcionActivarBufferingSignsImmediatelyFast() {
		return "Puede mejorar el rendimiento cuando hay muchos carteles.";
	}
	...
	public String tituloReducirConflictosResourcePacksImmediatelyFast() {
		return "Reducir manejo de conflictos de resource packs";
	}

	public String descripcionReducirConflictosResourcePacksImmediatelyFast() {
		return "Puede quitar trabajo extra, pero también puede causar problemas visuales con resource packs.";
	}
	...
	public String tituloOcultarBotonNCR() {
		return "Ocultar botón de No Chat Reports";
	}

	public String descripcionOcultarBotonNCR() {
		return "Cambio de interfaz; no mejora mucho los FPS, pero limpia la pantalla.";
	}
	...
	public String tituloActivarMixinsExperimentalesLithium() {
		return "Activar mixins experimentales de Lithium";
	}

	public String descripcionActivarMixinsExperimentalesLithium() {
		return "Habilita optimizaciones experimentales adicionales.";
	}
	...
	public String tituloUsarDetectorThreadingPequenoFerriteCore() {
		return "Usar detector de threading pequeño";
	}

	public String descripcionUsarDetectorThreadingPequenoFerriteCore() {
		return "Reduce memoria, pero puede ser más riesgoso.";
	}
	...
	public String tituloModernFixRecursosDinamicos() {
		return "Activar recursos dinámicos de ModernFix";
	}

	public String descripcionModernFixRecursosDinamicos() {
		return "Puede reducir uso de memoria y trabajo cargando recursos de forma más eficiente.";
	}

	public String tituloModernFixRenderizadoresDinamicosEntidades() {
		return "Activar renderizadores dinámicos de entidades";
	}

	public String descripcionModernFixRenderizadoresDinamicosEntidades() {
		return "Puede mejorar rendimiento al manejar renderizadores de entidades de forma más eficiente.";
	}

	public String tituloModernFixRenderizadoItemsRapido() {
		return "Activar renderizado rápido de items";
	}

	public String descripcionModernFixRenderizadoItemsRapido() {
		return "Puede mejorar el rendimiento al renderizar items.";
	}

	public String tituloModernFixWorldgenAllocation() {
		return "Reducir asignaciones en worldgen";
	}

	public String descripcionModernFixWorldgenAllocation() {
		return "Puede reducir basura de memoria durante generación de mundo.";
	}

	public String tituloModernFixDeduplicacionIngredientes() {
		return "Activar deduplicación de ingredientes";
	}

	public String descripcionModernFixDeduplicacionIngredientes() {
		return "Reduce objetos duplicados relacionados con recetas e ingredientes.";
	}

	public String tituloSodiumRenderCielo() {
		return "Activar optimización/render de cielo en Sodium";
	}

	public String descripcionSodiumRenderCielo() {
		return "Puede ajustar el comportamiento de renderizado del cielo.";
	}

	public String tituloActivarLightmapCaching() {
		return "Activar caché del lightmap";
	}

	public String descripcionActivarLightmapCaching() {
		return "Evita recalcular iluminación cuando no hace falta.";
	}
	...
	public String tituloOcultarTextoF3BadOptimizations() {
		return "Ocultar texto F3 de BadOptimizations";
	}

	public String descripcionOcultarTextoF3BadOptimizations() {
		return "Reduce ruido de depuración en la pantalla F3.";
	}
	...
	public String tituloDesactivarLogConfigBadOptimizations() {
		return "Desactivar log de configuración";
	}

	public String descripcionDesactivarLogConfigBadOptimizations() {
		return "Evita imprimir toda la configuración al iniciar.";
	}
	...
	public String tituloActivarSerializadorGCFreeC2ME() {
		return "Activar serializador GC-free de C2ME";
	}

	public String descripcionActivarSerializadorGCFreeC2ME() {
		return "Reduce asignaciones de memoria al cargar o guardar chunks.";
	}
	...
	public String tituloDesactivarSyncPlayerTicketsC2ME() {
		return "Desactivar syncPlayerTickets";
	}

	public String descripcionDesactivarSyncPlayerTicketsC2ME() {
		return "Puede mejorar el rendimiento de chunks, pero puede afectar contraptions técnicas.";
	}
	...
	public String tituloUsarCullingHojasDepthMoreCulling() {
		return "Usar culling de hojas DEPTH";
	}

	public String descripcionUsarCullingHojasDepthMoreCulling() {
		return "Usa un modo de culling de hojas más agresivo que el modo normal.";
	}
	...
	public String tituloActivarEndGatewayCullingMoreCulling() {
		return "Activar culling de End Gateway";
	}

	public String descripcionActivarEndGatewayCullingMoreCulling() {
		return "Evita renderizado innecesario de End Gateways.";
	}
	...
	public String tituloActivarActivationRangeServerCore() {
		return "Activar activation range";
	}

	public String descripcionActivarActivationRangeServerCore() {
		return "Reduce ticks de entidades lejos del jugador.";
	}
	...
	public String tituloActivarRangoVerticalServerCore() {
		return "Activar rango vertical";
	}

	public String descripcionActivarRangoVerticalServerCore() {
		return "Reduce ticks de entidades que están muy arriba o abajo del jugador.";
	}
	...
	public String advertenciaModsCulling() {
		return "Los mods de culling pueden causar incompatibilidades con algunos mods, crashes, errores donde el juego deja de tickear correctamente y también pueden hacer que granjas automáticas o fábricas dejen de funcionar.";
	}

	public String tituloModBadOptimizations() {
		return "Agregar BadOptimizations";
	}

	public String descripcionModBadOptimizations() {
		return "Agrega micro-optimizaciones de cliente como caché de lightmap, caché de cielo y reducción de llamadas innecesarias.";
	}

	public String tituloModBBE() {
		return "Agregar Better Block Entities";
	}

	public String descripcionModBBE() {
		return "Optimiza el renderizado de block entities como cofres, shulkers, camas, campanas, banners y carteles.";
	}

	public String tituloModC2ME() {
		return "Agregar Concurrent Chunk Management Engine";
	}

	public String descripcionModC2ME() {
		return "Mejora carga, generación y manejo de chunks usando procesamiento concurrente. Puede ser muy potente, pero también puede causar incompatibilidades en modpacks grandes.";
	}

	public String tituloModEntityCulling() {
		return "Agregar EntityCulling";
	}

	public String descripcionModEntityCulling() {
		return "Evita renderizar entidades que no están visibles. " + advertenciaModsCulling();
	}

	public String tituloModFerriteCore() {
		return "Agregar FerriteCore";
	}

	public String descripcionModFerriteCore() {
		return "Reduce uso de memoria mediante deduplicación y estructuras internas más eficientes.";
	}

	public String tituloModImmediatelyFast() {
		return "Agregar ImmediatelyFast";
	}

	public String descripcionModImmediatelyFast() {
		return "Optimiza varias partes del renderizado inmediato, texto, buffers, mapas e interfaz.";
	}

	public String tituloModLithium() {
		return "Agregar Lithium";
	}

	public String descripcionModLithium() {
		return "Optimiza lógica del juego, entidades, bloques, física y otros sistemas sin cambiar demasiado el comportamiento vanilla.";
	}

	public String tituloModModernFix() {
		return "Agregar ModernFix";
	}

	public String descripcionModModernFix() {
		return "Agrega muchas optimizaciones de memoria, carga, recursos y rendimiento general. Sus herramientas relacionadas con atlas pueden entrar en conflicto con mods que hacen el atlas más pequeño.";
	}

	public String tituloModMoreCulling() {
		return "Agregar More Culling";
	}

	public String descripcionModMoreCulling() {
		return "Agrega culling para bloques, hojas, item frames, pinturas, lluvia, beacons y otros elementos. "
				+ advertenciaModsCulling();
	}

	public String tituloModScalableLux() {
		return "Agregar ScalableLux";
	}

	public String descripcionModScalableLux() {
		return "Optimiza cálculos relacionados con iluminación y puede mejorar el rendimiento en mundos con muchos cambios de luz.";
	}

	public String tituloModServerCore() {
		return "Agregar ServerCore";
	}

	public String descripcionModServerCore() {
		return "Agrega optimizaciones del lado servidor, activation range, controles de mobcaps, reducción de ticks y mejoras de carga.";
	}

	public String tituloModSodium() {
		return "Agregar Sodium";
	}

	public String descripcionModSodium() {
		return "Mod principal de optimización de renderizado. Normalmente es una de las mejoras más importantes para FPS.";
	}

	public String tituloModVMP() {
		return "Agregar Very Many Players";
	}

	public String descripcionModVMP() {
		return "Optimiza sistemas del servidor para manejar muchos jugadores. El mod id esperado es vmp.";
	}
	...
	public String descripcionModMCMT() {
		return "Intenta multihilear partes del servidor de Minecraft. Puede mejorar rendimiento en algunos casos, pero tiene riesgo alto de incompatibilidades, errores de ticking y comportamiento raro.";
	}

	public String tituloLiabilityUranium() {
		return "Quitar Uranium";
	}

	public String descripcionLiabilityUranium() {
		return "Uranium es un mod diseñado para laggear intencionalmente el juego. No debe estar instalado si se quiere rendimiento.";
	}

	public String tituloAmbientalSinXmx() {
		return "Configurar memoria máxima de Java";
	}

	public String descripcionAmbientalSinXmx(int mods, String minimo, String maximoSeguro) {
		return "No se detectó -Xmx en los argumentos entregados. Para " + mods + " mods, el mínimo sugerido es "
				+ minimo + ", sin pasar aproximadamente " + maximoSeguro + ".";
	}

	public String sugerenciaAmbientalSinXmx(String minimo) {
		return "Agregar -Xmx" + minimo.replace(" ", "");
	}

	public String tituloAmbientalDemasiadaMemoria() {
		return "Reducir memoria asignada";
	}

	public String descripcionAmbientalDemasiadaMemoria(String xmx, String total, String maximoSeguro) {
		return "La instancia tiene asignado " + xmx + " de " + total
				+ ". No se recomienda asignar más del 80% de la RAM disponible.";
	}

	public String sugerenciaAmbientalDemasiadaMemoria(String maximoSeguro) {
		return "Reducir -Xmx a " + maximoSeguro + " o menos.";
	}

	public String tituloAmbientalMemoriaInsuficiente() {
		return "Aumentar memoria asignada";
	}

	public String descripcionAmbientalMemoriaInsuficiente(int mods, String xmx, String minimo) {
		return "La instancia tiene " + xmx + " asignado. Para " + mods + " mods, el mínimo sugerido es " + minimo + ".";
	}

	public String sugerenciaAmbientalMemoriaInsuficiente(String minimo) {
		return "Aumentar -Xmx a por lo menos " + minimo + ".";
	}

	public String tituloAmbientalJava8GC() {
		return "Usar G1GC o Shenandoah en Java 8";
	}

	public String descripcionAmbientalJava8GC() {
		return "En Java 8 se recomienda usar G1GC o Shenandoah para reducir pausas y mejorar estabilidad.";
	}

	public String sugerenciaAmbientalJava8GC() {
		return "Agregar -XX:+UseG1GC o -XX:+UseShenandoahGC.";
	}
	...
	public String descripcionAmbientalZGC(String ramTotal) {
		return "El equipo tiene más de 12 GB de RAM (" + ramTotal
				+ "). Si la distribución de Java lo soporta, ZGC puede reducir pausas del recolector.";
	}

	public String sugerenciaAmbientalZGC() {
		return "En Java 17 o superior, probar -XX:+UseZGC.";
	}

	public String tituloAmbientalAikar() {
		return "Agregar flags de Aikar";
	}

	public String descripcionAmbientalAikar() {
		return "En Java 17 o anterior, las flags de Aikar suelen mejorar el comportamiento de G1GC para Minecraft.";
	}

	public String sugerenciaAmbientalAikar() {
		return "Usar flags de Aikar, incluyendo -XX:+UseG1GC -XX:+ParallelRefProcEnabled -XX:MaxGCPauseMillis=200.";
	}
	...
	public String descripcionAmbientalRedHatJDK(int javaMayor, String os) {
		return "Para Java " + javaMayor + " en " + os + ", se recomienda Red Hat JDK por estabilidad y compatibilidad.";
	}

	public String sugerenciaAmbientalRedHatJDK() {
		return "Instalar Red Hat JDK para Java 8 o Java 11.";
	}
	...
	public String descripcionAmbientalAzulPrime() {
		return "En Linux con Java 16 o superior y más de 16 GB de RAM, Azul Prime puede ser una buena opción de rendimiento.";
	}

	public String sugerenciaAmbientalAzulPrime() {
		return "Probar Azul Prime si el equipo tiene más de 16 GB de RAM.";
	}
	...
	public String descripcionAmbientalGraalVM() {
		return "Con Java 16 o superior y más de 16 GB de RAM, GraalVM puede ser una alternativa útil fuera de Linux.";
	}

	public String sugerenciaAmbientalGraalVM() {
		return "Probar GraalVM si el equipo tiene más de 16 GB de RAM.";
	}

	public String tituloAmbientalDiscoBajo() {
		return "Revisar espacio libre en disco";
	}

	public String descripcionAmbientalDiscoBajo(String libre) {
		return "El disco tiene poco espacio libre: " + libre
				+ ". Minecraft puede fallar, guardar lento o corromper datos si se queda sin espacio.";
	}

	public String sugerenciaAmbientalDiscoBajo() {
		return "Liberar espacio hasta tener al menos 20 GB disponibles.";
	}

	public String tituloAmbientalWindowsRHEL9() {
		return "Considerar RHEL 9 para pruebas";
	}

	public String descripcionAmbientalWindowsRHEL9() {
		return "En Windows, se recomienda considerar RHEL 9 porque incluye Red Hat JDK, es estable, se puede descargar gratis para individuos y es donde se hacen la mayoría de las pruebas.";
	}

	public String sugerenciaAmbientalWindowsRHEL9() {
		return "Probar la instancia en RHEL 9 si se busca máxima estabilidad de prueba.";
	}

	public String tituloAmbientalRaptorLake() {
		return "Advertencia de Intel Raptor Lake";
	}

	public String descripcionAmbientalRaptorLake() {
		return "Se detectó el problema de Raptor Lake marcado por la verificación existente. Esto puede causar inestabilidad, crashes y errores que parecen ser del modpack.";
	}

	public String sugerenciaAmbientalRaptorLake() {
		return "Actualizar BIOS/microcódigo y revisar la advertencia de Raptor Lake antes de culpar al modpack.";
	}

	@Override
	public String tituloAmbientalNeoForge1201Antiguo() {
		return "NeoForge 1.20.1 antiguo detectado";
	}

	@Override
	public String descripcionAmbientalNeoForge1201Antiguo() {
		return "Se detectó FancyModLoader 47 o una ruta compatible con NeoForge 1.20.1. "
				+ "NeoForge 1.20.1 fue una bifurcación de MinecraftForge 1.20.1 y suele ser compatible a nivel binario, "
				+ "pero esa línea fue abandonada antes y puede faltar varias optimizaciones disponibles en Forge.";
	}

	@Override
	public String sugerenciaAmbientalNeoForge1201Antiguo() {
		return "Para 1.20.1, si el modpack lo permite, considera usar MinecraftForge 1.20.1 en lugar de NeoForge 1.20.1.";
	}
	...
	public String descripcionAmbientalGPU() {
		return "Otra verificación ya detectó un posible problema de GPU, OpenGL o selección de tarjeta gráfica.";
	}

	@Override
	public String sugerenciaAmbientalGPU() {
		return "Revisa que Minecraft esté usando la GPU correcta, actualiza drivers y evita configuraciones híbridas inestables.";
	}

	@Override
	public String gpuFixTitulo() {
		return "Configuración de GPU";
	}
	...
	public String gpuFixBotonFuenteTLauncher() {
		return "Abrir guía de TLauncher";
	}

	@Override
	public String gpuFixBotonVirusTotal() {
		return "Abrir análisis VirusTotal";
	}

	@Override
	public String gpuFixBotonOptimusLinux() {
		return "Abrir guía NVIDIA Optimus";
	}

	@Override
	public String gpuFixTextoWindows() {
		return Statics.nombre_cd.obtener()
				+ " detectó que Minecraft podría no estar usando la GPU de alto rendimiento.\n\n"
				+ "En Windows se pueden establecer claves de registro en "
				+ "HKEY_CURRENT_USER\\\\Software\\\\Microsoft\\\\DirectX\\\\UserGpuPreferences "
				+ "para forzar que javaw.exe use la GPU dedicada.\n\n"
				+ "GpuPreference=0 = decisión automática de Windows.\n"
				+ "GpuPreference=1 = ahorro de energía / GPU integrada.\n"
				+ "GpuPreference=2 = GPU de alto rendimiento.\n\n"
				+ "Parte de esta información fue obtenida gracias a la investigación publicada por TLauncher y al análisis "
				+ "de comportamiento disponible en VirusTotal.";
	}

	@Override
	public String gpuFixTextoLinux() {
		return Statics.nombre_cd.obtener() + " detectó un posible problema relacionado con NVIDIA Optimus o PRIME.\n\n"
				+ "Dependiendo de la distribución Linux utilizada, puede ser necesario configurar NVIDIA Optimus, "
				+ "nvidia-prime, switcheroo-control u otros sistemas híbridos.\n\n"
				+ "En Fedora/RHEL y derivados suele recomendarse seguir la documentación de RPMFusion.\n\n"
				+ "El botón inferior abrirá la documentación oficial recomendada.";
	}

	@Override
	public String gpuFixTextoMac() {
		return Statics.nombre_cd.obtener() + " detectó un posible problema de selección de GPU.\n\n"
				+ "En algunos sistemas macOS con GPU híbrida es posible forzar el uso de la GPU dedicada "
				+ "mediante configuraciones avanzadas del sistema.\n\n"
				+ "El botón de aplicar intentará ejecutar un comando para priorizar la GPU de alto rendimiento.";
	}

	@Override
	public String gpuFixTextoOtroSistema() {
		return Statics.nombre_cd.obtener() + " detectó un posible problema relacionado con la GPU, "
				+ "pero no existe una implementación específica para este sistema operativo.";
	}

	@Override
	public String gpuFixLinuxManual() {
		return "En Linux normalmente la configuración debe realizarse manualmente dependiendo de la distribución, "
				+ "driver NVIDIA y sistema Optimus/PRIME utilizado.";
	}

	@Override
	public String gpuFixSistemaNoSoportado() {
		return "Sistema operativo no soportado para la configuración automática de GPU.";
	}

	@Override
	public String gpuFixJavaNoDetectado() {
		return "No se pudo detectar la ruta actual de javaw.exe.";
	}

	@Override
	public String gpuFixWindowsAplicado(String ruta) {
		return "La configuración de GPU fue aplicada correctamente para:\n\n" + ruta + "\n\n"
				+ "GpuPreference=2 indica GPU de alto rendimiento.";
	}

	@Override
	public String gpuFixErrorAplicando() {
		return "Ocurrió un error al intentar aplicar la configuración de GPU";
	}

	@Override
	public String gpuFixMacAplicado() {
		return "La configuración de GPU de alto rendimiento fue aplicada.";
	}

	@Override
	public String gpuFixMacError() {
		return "No se pudo aplicar la configuración de GPU en macOS";
	}

	@Override
	public String rendimientoTitulo() {
		return "Administrador de rendimiento";
	}
	...
	public String rendimientoBotonAnalizar() {
		return "Analizar rendimiento";
	}

	@Override
	public String rendimientoBotonAbrirGPU() {
		return "Abrir configuración de GPU";
	}

	@Override
	public String rendimientoDescripcion() {
		return "Este panel revisa problemas ambientales, mods recomendados o riesgosos, y opciones de configuración "
				+ "que pueden mejorar el rendimiento. No todas las opciones funcionan juntas, no todas sirven para cada "
				+ "versión de Minecraft y no todas son compatibles con cada modloader. Eso está bien: no necesitas una "
				+ "puntuación perfecta de optimización.";
	}

	@Override
	public String rendimientoNotaCompatibilidad() {
		return "Nota: estas sugerencias son posibilidades, no una orden de aplicar todo. Algunas opciones pueden chocar "
				+ "entre sí o no ser adecuadas para tu versión, launcher, modloader o modpack.";
	}
	...
	public String rendimientoPestanaAmbiental() {
		return "Problemas ambientales";
	}

	@Override
	public String rendimientoPestanaMods() {
		return "Mods recomendados y liabilities";
	}

	@Override
	public String rendimientoPestanaConfigs() {
		return "Opciones de config";
	}
	...
	public String rendimientoResumenAmbiental(int cantidad) {
		return "Problemas ambientales encontrados: " + cantidad;
	}

	@Override
	public String rendimientoResumenMods(int cantidad) {
		return "Sugerencias o liabilities de mods encontrados: " + cantidad;
	}

	@Override
	public String rendimientoResumenConfigs(int cantidad) {
		return "Sugerencias de configuración encontradas: " + cantidad;
	}

	@Override
	public String rendimientoResumenGPU() {
		return "Se detectó un problema de GPU. Por eso se habilitó el botón para abrir la configuración de GPU.";
	}

	@Override
	public String rendimientoSinHallazgos() {
		return "No se encontraron sugerencias en esta sección.";
	}
	...
	public String faltanDatosParaEliminarMCLogs() {
		return "Faltan el slug o el token de eliminación.";
	}

	public String confirmarEliminarMCLogs() {
		return "¿Seguro que quieres eliminar este registro de MCLogs?";
	}
	...
	public String colorCampoTexto() {
		return "Color de campo de texto";
	}

	public String historialCDPaste() {
		return "Historial de CDPaste";
	}
	...
	public String eliminarRegistroCDPaste() {
		return "Eliminar registro CDPaste";
	}

	public String faltanDatosParaEliminarCDPaste() {
		return "Falta el slug del registro CDPaste.";
	}

	public String confirmarEliminarCDPaste() {
		return "¿Seguro que quieres eliminar este registro de CDPaste?";
	}

	public String registroEliminadoCDPaste() {
		return "Registro CDPaste eliminado correctamente.";
	}
	...
	public String seleccioneArchivoLog() {
		return "Seleccione un archivo de log";
	}
	...
	public String presioneGuardarParaAgregarAnalisis() {
		return "Presione Guardar y cerrar para agregarlo al análisis.";
	}

	public String errorAlCargarArchivoArrastrado() {
		return "Error al cargar archivo arrastrado";
	}
	...
	public String suprimirConsolaCD() {
		return "Suprimir consola de " + Statics.nombre_cd.obtener();
	}
	...
	public String profilerTituloRendimiento() {
		return "Profiler de rendimiento";
	}
	...
	public String profilerAyudaMinaly() {
		return "Los métodos más lentos aparecen arriba. La barra muestra el peso relativo del tiempo acumulado.";
	}
	...
	public String profilerEstadoResumen(String estado, int metodos, int top, String totalVisible) {
		return estado + " | métodos: " + metodos + " | top: " + top + " | total visible: " + totalVisible;
	}

	@Override
	public String samplerTituloRendimiento() {
		return "Sampler de rendimiento";
	}

	@Override
	public String samplerAyudaEineLotta() {
		return "Los métodos con más tiempo acumulado aparecen arriba. La barra muestra visualmente el peso relativo.";
	}
	...
	public String migradorLegacyTitulo() {
		return "Migrador de analizadores legacy";
	}

	@Override
	public String migradorLegacyDescripcion() {
		return "Este wizard ayuda a mover configuraciones desde analizadores de crashes legacy y propietarios hacia sistemas modernos, abiertos y mantenibles. Migrar estas reglas reduce la dependencia de herramientas cerradas y facilita auditoría, colaboración y soporte comunitario. Los logos mostrados aquí no son los logos reales; son parodias que nos parecieron graciosas.";
	}

	@Override
	public String migradorLegacyCrashAssistant() {
		return "Wizard de Crash Assistant";
	}

	@Override
	public String migradorCrashAssistantDescripcion() {
		return "Importa problematic_mods.json de Crash Assistant y lo combina con el formato de CrashDetector mediante un wizard.";
	}

	@Override
	public String migradorEjecutar() {
		return "Ejecutar wizard";
	}

	@Override
	public String migradorCompletado() {
		return "Wizard completado.";
	}

	@Override
	public String migradorNadaParaMigrar() {
		return "No se encontró nada para migrar.";
	}
	...
	public String migradorCADeshabilitarChecks() {
		return "Deshabilitar checks";
	}

	@Override
	public String migradorCAAvisoUrlSoporteWysiwyg() {
		return "No se migró el enlace de soporte porque no estás usando la GUI primitiva. Para cambiar la URL de soporte, usa el editor WYSIWYG en la configuración de CrashDetector.";
	}
	...
	public String centroSoporteTituloCrash() {
		return "App se cerró inesperadamente.";
	}

	@Override
	public String centroSoporteTextoSuperior() {
		return "Esta interfaz gráfica no se recomienda para usuarios avanzados (DIY); si usted es un usuario avanzado, por favor diríjase a Archivo -> Configuración -> Configuración de "
				+ Statics.nombre_cd.obtener()
				+ " y cambie la Interfaz Principal de \"centro suporte\" a \"estilo_lanzer\". Si eres el autor de un modpack, puedes cambiar este texto allí.";
	}

	@Override
	public String centroSoporteTextoBajoTitulo() {
		return "Proporciona detalles sobre qué ocurrió antes del fallo.";
	}

	@Override
	public String centroSoporteTextoAviso() {
		return "Lee el texto anterior cuidadosamente. Una captura de esta ventana no contiene suficiente información.";
	}

	@Override
	public String centroSoporteArchivosDisponibles() {
		return "Archivos de registro disponibles";
	}

	@Override
	public String centroSoporteSubirTodoYCopiar() {
		return "Subir todo y copiar mensaje con enlaces";
	}

	@Override
	public String centroSoportePedirAyuda() {
		return "Pedir ayuda en el centro de soporte";
	}

	@Override
	public String mostrarEnExplorador() {
		return "Mostrar en explorador";
	}

	@Override
	public String subirYCopiarEnlace() {
		return "Subir y copiar enlace";
	}
	...
	public String colorTextoAviso() {
		return "Color de texto del aviso";
	}

	@Override
	public String colorBotonPrincipal() {
		return "Color del botón principal";
	}

	@Override
	public String colorTextoBotonPrincipal() {
		return "Color de texto del botón principal";
	}
	...
	public String textoBajoTituloPersonalizado() {
		return "Texto bajo el título personalizado";
	}

	@Override
	public String urlSoporte() {
		return "URL de soporte";
	}

	@Override
	public String leyProteccionDatosPersonales() {
		return "Ley de protección de datos personales";
	}

	@Override
	public String altoFilaLog() {
		return "Alto de fila de registro";
	}

	@Override
	public String anchoNombreArchivo() {
		return "Ancho del nombre de archivo";
	}

	@Override
	public String anchoBotonAbrir() {
		return "Ancho del botón abrir";
	}

	@Override
	public String anchoBotonExplorador() {
		return "Ancho del botón mostrar en explorador";
	}

	@Override
	public String anchoBotonSubir() {
		return "Ancho del botón subir";
	}

	@Override
	public String tamanoFuenteBotonPrincipal() {
		return "Tamaño de fuente del botón principal";
	}

	@Override
	public String formatoBloqueLogs() {
		return "Formato del bloque de logs";
	}

	@Override
	public String formatoHeaderMensaje() {
		return "Formato del encabezado del mensaje";
	}

	@Override
	public String formatoEstructuraMensaje() {
		return "Formato de estructura del mensaje";
	}

	@Override
	public String formatoLineaLog() {
		return "Formato de línea de registro";
	}
	...
	public String formatoModlistDiff() {
		return "Formato de diferencias de mods";
	}
	...
	public String mostrarLogoCuadrado() {
		return "Mostrar logo cuadrado";
	}

	@Override
	public String rutaLogoCuadrado() {
		return "Ruta del logo cuadrado";
	}

	@Override
	public String tamanoLogoCuadrado() {
		return "Tamaño del logo cuadrado";
	}

	@Override
	public String migradorCAModoPrincipalAviso() {
		return "Elige cómo migrar la GUI principal. centro_soporte es lo más parecido a la GUI predeterminada de Crash Assistant, pero no se recomienda, especialmente para jugadores DIY, porque tiene popup hell y un diseño pobre; existe solo para ayudar a migrar entornos legacy de Crash Assistant. primitiva es una GUI muy simple usada solo para compartir; solo se sugiere para modpacks, no usuarios DIY, si deshabilitas todas las verificaciones innecesarias, y también sufre de popup hell. original conserva tu GUI principal actual y generalmente es la opción recomendada para la mayoría de usuarios.";
	}

	@Override
	public String migradorCASitioLoggingAviso() {
		return "Elige si quieres migrar el sitio de logging desde Crash Assistant o conservar el actual de CrashDetector. Crash Assistant usa con frecuencia gnomebot.dev, que no se recomienda frente a SecureLogger, PastesDev o CDPaste. Para la mayoría de usuarios, se recomienda conservar el sitio actual.";
	}
	...
	public String ideScriptProyectoDeshabilitadoAviso() {
		return "Este tipo de proyecto ya existe en la GUI, pero esta deshabilitado hasta que se agregue su servidor de lenguaje o analizador.";
	}
	...
	public String ideScriptDepsDescargadas(String mensaje) {
		return "Resultado de descarga:\n\n" + mensaje
				+ "\n\nReinicie el programa si las clases todavia no aparecen en el classpath.";
	}
	...
	public String mcpDescargarDependencias() {
		return "Descargar dependencias MCP/CFR";
	}
	...
	public String mcpEstadoDependenciasNoCargadas() {
		return "Dependencias MCP/CFR no cargadas. Descárgalas y reinicia si el botón sigue desactivado.";
	}

	public String mcpEstadoDependenciasCargadas() {
		return "Dependencias MCP/CFR detectadas. El servidor MCP puede iniciarse.";
	}

	public String mcpDependenciasDescargadasReiniciar() {
		return "Dependencias descargadas. Si todavía no aparecen cargadas, reinicia CrashDetector.";
	}

	public String mcpErrorDescargandoDependencias(String error) {
		return "No se pudieron descargar las dependencias MCP/CFR: " + error;
	}

	public String mcpServidorIniciado(int puerto) {
		return "Servidor MCP iniciado en 127.0.0.1:" + puerto + "/mcp";
	}

	public String mcpErrorIniciandoServidor(String error) {
		return "No se pudo iniciar el servidor MCP: " + error;
	}

	public String mcpImagenNoDisponible() {
		return "Imagen MCP no disponible";
	}
	...
	public String mcpDescripcionHtml() {
		return "<b>Este panel inicia un servidor MCP local para asistentes como Claude Desktop, Qwen Desktop Linux, Red Hat command-line-assistant o Goose.</b>"
				+ "<br><br>"
				+ "Primero descarga las dependencias MCP/CFR. Después reinicia si las clases no aparecen en el classpath."
				+ "<br><br>" + "<b>Claude Desktop / Qwen Desktop Linux, ejemplo:</b>" + "<pre>{\n"
				+ "  \"mcpServers\": {\n" + "    \"crashdetector\": {\n"
				+ "      \"url\": \"http://127.0.0.1:8765/mcp\"\n" + "    }\n" + "  }\n" + "}</pre>"
				+ "<b>Goose / command-line-assistant:</b>" + "<pre>http://127.0.0.1:8765/mcp</pre>"
				+ "Por ahora este servidor MCP es básico. Luego se pueden agregar herramientas reales para leer logs, consultar CFR, revisar mods, buscar clases y explicar crashes.";
	}
	...
	public String mensajeErrorJvmDllCurseForgeG1(boolean conOverwolf) {
		...
		if (conOverwolf) {
			textoOverwolf = "<p>El log también muestra indicios de <b>Overwolf</b> o DLLs relacionadas, como "
					+ "<b>OWClient.dll</b> u <b>OWUtils.dll</b>. Esto no prueba por sí solo que Overwolf sea la causa, "
					+ "pero sí indica que el proceso de Minecraft estaba ejecutándose dentro de un entorno más modificado "
					+ "que un lanzamiento vanilla normal.</p>";
		}

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Java se cerró por un fallo nativo en jvm.dll durante el recolector G1 en CurseForge.</b>"
				+ "<p>El log contiene un <b>EXCEPTION_ACCESS_VIOLATION</b> dentro de <b>jvm.dll</b>, "
				+ "y el hilo activo es un <b>GCTaskThread</b>. Esto significa que Java falló mientras el recolector "
				+ "de basura <b>G1</b> estaba trabajando.</p>"
				+ "<p>También hay indicios de que el juego fue iniciado desde un entorno administrado por "
				+ "<b>CurseForge</b>, por ejemplo rutas de CurseForge, <b>DCFInstanceId</b> o marca de launcher de CurseForge.</p>"
				+ textoOverwolf
				+ "<p>No se puede demostrar solamente desde el log que CurseForge u Overwolf sean la causa exacta. "
				+ "Sin embargo, este patrón se ve con frecuencia en lanzamientos de CurseForge y puede estar relacionado "
				+ "con la combinación de <b>G1 GC</b>, memoria nativa, librerías de Minecraft, drivers gráficos, "
				+ "carpetas nativas administradas por CurseForge, overlays o componentes externos del launcher.</p>"
				+ "<p><b>Solución común:</b></p>" + "<ul>"
				+ "<li>Cambia el recolector de basura agregando este argumento JVM: <b>-XX:+UseShenandoahGC</b></li>"
				+ "<li>En CurseForge, esto normalmente se agrega en los argumentos adicionales de Java del perfil o del launcher.</li>"
				+ "<li>Borra la caché de natives/bin del perfil de CurseForge para forzar que las librerías nativas se extraigan de nuevo.</li>"
				+ "<li>Actualiza Java y los drivers gráficos.</li>"
				+ "<li>Si usas overlays, grabadores, antivirus agresivo u otras herramientas que se inyectan en juegos, prueba cerrarlas temporalmente.</li>"
				+ "</ul>" + "<p>Tutorial recomendado en inglés para cambiar los argumentos en CurseForge: "
				+ "<a href='https://youtu.be/UKFWBOZxB2o'>https://youtu.be/UKFWBOZxB2o</a></p>"
				+ "<p><b>Nota para Minecraft 1.16.5 o anterior:</b> esas versiones normalmente usan Java 8. "
				+ "Si estás en JDK 8 y quieres usar Shenandoah, puede que necesites usar el "
				+ "<b>Red Hat Build of OpenJDK 8</b> y apuntar CurseForge hacia esa instalación de Java.</p>"
				+ "<p>Guía de Red Hat para instalar OpenJDK 8 en Windows: "
	...
	public String nombreErrorJvmDllCurseForgeG1() {
		return "Fallo jvm.dll de CurseForge con G1 GC";
	}

	@Override
	public String mensajeErrorJvmDllC2Sodium() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Java se cerró por un fallo nativo en jvm.dll mientras compilaba código de Sodium o un mod similar.</b>"
				+ "<p>El log contiene un <b>EXCEPTION_ACCESS_VIOLATION</b> dentro de <b>jvm.dll</b>, "
				+ "y el hilo activo es un <b>C2 CompilerThread</b>. Esto significa que el fallo ocurrió dentro del "
				+ "compilador JIT de Java, no como una excepción normal de Minecraft.</p>"
				+ "<p>En este caso, la tarea de compilación menciona código relacionado con <b>Sodium</b>, "
				+ "<b>Embeddium</b>, <b>Rubidium</b> o una clase similar como "
				+ "<b>ClonedChunkSectionCache::acquire</b>.</p>" + "<p><b>Solución recomendada:</b></p>" + "<ul>"
				+ "<li>Actualiza <b>Sodium</b>, <b>Embeddium</b>, <b>Rubidium</b>, <b>Oculus</b> o cualquier mod de renderizado relacionado.</li>"
				+ "<li>Actualiza Java 17. Si ya estás usando una versión moderna, prueba otra distribución como Temurin, Zulu o Microsoft OpenJDK.</li>"
				+ "<li>Actualiza los drivers de la tarjeta gráfica.</li>"
				+ "<li>Prueba temporalmente sin Sodium, Embeddium, Rubidium u Oculus para confirmar si el fallo desaparece.</li>"
				+ "<li>Como prueba avanzada, usa <b>-XX:TieredStopAtLevel=1</b> para reducir el uso del compilador C2. "
				+ "Esto puede bajar el rendimiento, pero ayuda a confirmar si el fallo viene del compilador JIT.</li>"
				+ "</ul>"
				+ "<p>Este problema no es el mismo que un crash normal de un mod. También es distinto de los fallos donde "
				+ "<b>GCTaskThread</b> aparece como hilo activo. Aquí el patrón apunta más al compilador C2 de Java "
				+ "compilando código de renderizado optimizado.</p>";
	}

	@Override
	public String nombreErrorJvmDllC2Sodium() {
		return "Fallo nativo de Java con Sodium / Embeddium";
	}
	...
	public String mensajeErrorArchivoUsadoPorOtroProceso(String archivo) {
		...
		if (archivo != null && archivo.length() > 0) {
			textoArchivo = "<p><b>Archivo bloqueado:</b> " + archivo + "</p>";
		}

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Un archivo está siendo usado por otro proceso.</b>"
				+ "<p>El log contiene un error de <b>java.nio.file.FileSystemException</b> indicando que Windows no puede "
				+ "acceder a un archivo porque otro programa lo está usando.</p>" + textoArchivo
				+ "<p>Esto suele pasar cuando Minecraft, CurseForge, un editor de texto, un antivirus, OneDrive, "
				+ "un programa de sincronización o incluso otra instancia del juego tiene abierto el archivo.</p>"
				+ "<p><b>Solución recomendada:</b></p>" + "<ul>" + "<li>Cierra Minecraft completamente.</li>"
				+ "<li>Cierra CurseForge y vuelve a abrirlo.</li>"
				+ "<li>Revisa el Administrador de tareas y termina procesos duplicados de <b>javaw.exe</b>, <b>java.exe</b>, Minecraft o CurseForge.</li>"
				+ "<li>Cierra editores de texto que puedan tener abierto el archivo de configuración.</li>"
				+ "<li>Si el archivo está dentro de OneDrive, Dropbox o un programa similar, pausa la sincronización temporalmente.</li>"
				+ "<li>Si el problema continúa, reinicia la computadora para liberar el bloqueo del archivo.</li>"
				+ "</ul>"
				+ "<p>Después de liberar el archivo, vuelve a iniciar el modpack. Si el archivo bloqueado es una configuración, "
				+ "también puede ayudar hacer una copia de seguridad y regenerar ese archivo.</p>";
	}
	...
	public String bittorrentArchivoCompartirDebeSerZip() {
		return "BitTorrent solo admite el archivo ZIP exportado por la función de compartir instancia.";
	}

	@Override
	public String bittorrentArchivoCompartirNoValido() {
		return "El archivo que se intentó compartir no existe o no se puede leer.";
	}

	@Override
	public String bittorrentArchivoTorrent() {
		return "Archivo .torrent";
	}

	@Override
	public String bittorrentArchivoTorrentSalida() {
		return "Guardar .torrent como";
	}
	...
	public String bittorrentColorAcento() {
		return "Acento del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorAcentoSecundario() {
		return "Acento secundario del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorBorde() {
		return "Borde del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorFondo() {
		return "Fondo del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorPanel() {
		return "Panel del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorPanelClaro() {
		return "Panel claro del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorSeleccion() {
		return "Selección del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorTexto() {
		return "Texto claro del cliente BitTorrent";
	}

	@Override
	public String bittorrentColorTextoOscuro() {
		return "Texto oscuro del cliente BitTorrent";
	}

	@Override
	public String bittorrentComentarioTorrent() {
		return "Archivo compartido para diagnóstico y soporte técnico mediante CrashDetector.";
	}

	@Override
	public String bittorrentConfiguracionGuardada() {
		return "La configuración BitTorrent fue guardada. Los cambios de puerto, DHT, PEX y descubrimiento local se aplicarán a un runtime nuevo después de reiniciar la aplicación.";
	}

	@Override
	public String bittorrentConfirmarPrivacidad() {
		return "Entiendo la advertencia de privacidad y autorizo esta transferencia P2P.";
	}
	...
	public String bittorrentCrearCompartir() {
		return "Crear .torrent y empezar a compartir";
	}

	@Override
	public String bittorrentDebeAceptarPrivacidad() {
		return "Debes leer y aceptar la advertencia de privacidad antes de iniciar una transferencia BitTorrent.";
	}

	@Override
	public String bittorrentDestino() {
		return "Carpeta de descarga";
	}

	@Override
	public String bittorrentDestinoNoValido() {
		return "Selecciona una carpeta de descarga válida y escribible.";
	}

	@Override
	public String bittorrentDetenerSeleccionada() {
		return "Detener transferencia seleccionada";
	}

	@Override
	public String bittorrentElegirDestino() {
		return "Seleccionar carpeta de descarga";
	}

	@Override
	public String bittorrentElegirOrigen() {
		return "Seleccionar archivo o carpeta para compartir";
	}

	@Override
	public String bittorrentElegirTorrent() {
		return "Seleccionar archivo .torrent";
	}

	@Override
	public String bittorrentErrorCrearComparticion() {
		return "No se pudo crear o iniciar la compartición BitTorrent.";
	}

	@Override
	public String bittorrentErrorDetalle(String detalle) {
		return "No se pudo completar la operación BitTorrent:\n" + detalle;
	}
	...
	public String bittorrentFaltaTorrentOMagnet() {
		return "Pega un magnet o selecciona un archivo .torrent.";
	}

	@Override
	public String bittorrentGuardarConfiguracion() {
		return "Guardar trackers y opciones";
	}

	@Override
	public String bittorrentGuardarTorrent() {
		return "Guardar archivo .torrent";
	}

	@Override
	public String bittorrentHilosHash() {
		return "Hilos de verificación";
	}
	...
	public String bittorrentMagnetCopiado() {
		return "El magnet fue copiado al portapapeles.";
	}

	@Override
	public String bittorrentMagnetNoValido() {
		return "El magnet no es válido o no contiene un info-hash BitTorrent.";
	}

	@Override
	public String bittorrentOrigen() {
		return "Archivo o carpeta de origen";
	}

	@Override
	public String bittorrentOrigenNoValido() {
		return "Selecciona un archivo o una carpeta de origen válida.";
	}

	@Override
	public String bittorrentOrigenVacio() {
		return "El archivo o la carpeta seleccionada no contiene datos para compartir.";
	}

	@Override
	public String bittorrentPestanaAbrir() {
		return "Abrir .torrent o magnet";
	}

	@Override
	public String bittorrentPestanaConfiguracion() {
		return "Privacidad y trackers";
	}

	@Override
	public String bittorrentPestanaCrear() {
		return "Crear y compartir";
	}
	...
	public String bittorrentPrivacidadAdvertencia() {
		return "ADVERTENCIA DE PRIVACIDAD: BitTorrent es una red entre pares y no una subida privada de extremo a extremo. Tu dirección IP pública es visible para los trackers configurados y para los pares que participan en la transferencia. Los nombres de archivos y carpetas, tamaños y estructura del .torrent pueden ser visibles para cualquier persona que reciba el .torrent o el magnet. Esta versión sin dependencias usa únicamente los trackers que configures; no activa DHT, PEX ni descubrimiento local. Revisa el contenido antes de compartir y elimina tokens de acceso, contraseñas, cookies, claves, sesiones, datos personales y registros sensibles. Comparte el magnet o .torrent únicamente con el soporte autorizado y mantén la aplicación abierta mientras seas el único seeder.";
	}

	@Override
	public String bittorrentPrivacidadTitulo() {
		return "Privacidad de BitTorrent";
	}

	@Override
	public String bittorrentPuerto() {
		return "Puerto BitTorrent";
	}

	@Override
	public String bittorrentSeguirCompartiendo() {
		return "Seguir compartiendo después de completar la descarga";
	}

	@Override
	public String bittorrentSobrescribirTorrent(String ruta) {
		return "El archivo .torrent ya existe:\n" + ruta + "\n\n¿Sobrescribirlo?";
	}
	...
	public String bittorrentTorrentCreado(String ruta) {
		return "El archivo .torrent fue creado y el seeding comenzó:\n" + ruta
				+ "\n\nMantén CrashDetector abierto hasta que el soporte termine de descargar.";
	}

	@Override
	public String bittorrentTorrentNoValido() {
		return "El archivo .torrent no contiene bencode válido.";
	}

	@Override
	public String bittorrentTorrentSinInfo() {
		return "El archivo .torrent no contiene el diccionario info requerido.";
	}

	@Override
	public String bittorrentTrackerNoValido(String tracker) {
		return "Tracker no válido: " + tracker + "\nSolo se aceptan URLs http, https o udp.";
	}

	@Override
	public String bittorrentTrackers() {
		return "Trackers, uno por línea";
	}
	...
	public String bittorrentTransferenciaIniciada() {
		return "La transferencia BitTorrent fue iniciada.";
	}

	@Override
	public String bittorrentUsarDht() {
		return "Usar DHT y routers públicos para encontrar pares";
	}

	@Override
	public String bittorrentUsarLsd() {
		return "Usar descubrimiento local de pares en la red LAN";
	}

	@Override
	public String bittorrentUsarPex() {
		return "Permitir intercambio de pares entre clientes";
	}

	@Override
	public String bittorrentSinTrackersNiDht() {
		return "Configura al menos un tracker HTTP, HTTPS o UDP antes de crear o abrir una compartición BitTorrent basada en magnet.";
	}
	...
	public String gitAvanzadoTipo() {
		return "Cliente Git avanzado";
	}

	@Override
	public String jgitAbrirClienteAvanzado() {
		return "Abrir cliente Git avanzado";
	}

	@Override
	public String gitAvanzadoTitulo() {
		return "Cliente Git avanzado — Wendy Mizumi: Lost Media";
	}

	@Override
	public String gitAvanzadoSerieLostMedia() {
		return "Wendy Mizumi — Lost Media / archivo del repositorio actual";
	}
	...
	public String gitAvanzadoActualizando() {
		return "Actualizando el repositorio actual...";
	}

	@Override
	public String gitAvanzadoJGitNoDisponible() {
		return "JGit no está disponible. Instala las dependencias desde la GUI Git normal y reinicia la aplicación.";
	}

	@Override
	public String gitAvanzadoRepositorioRequerido() {
		return "El cliente avanzado solo puede abrirse después de crear el repositorio de la instancia actual desde la GUI Git normal.";
	}

	@Override
	public String gitAvanzadoEstadoResumen(int noPreparados, int preparados, int commits) {
		return "No preparados: " + noPreparados + " | Preparados: " + preparados + " | Commits mostrados: " + commits;
	}

	@Override
	public String gitAvanzadoMensajeRequerido() {
		return "Escribe un mensaje para el commit.";
	}

	@Override
	public String gitAvanzadoNombreNuevaRama() {
		return "Nombre de la nueva rama:";
	}

	@Override
	public String gitAvanzadoConfirmarCambioRama(String rama) {
		return "¿Cambiar a la rama '" + rama + "'? Los cambios locales deben ser compatibles con el cambio de rama.";
	}

	@Override
	public String gitAvanzadoErrorOperacion() {
		return "La operación Git no pudo completarse. Revisa la pestaña Actividad y el registro de CrashDetector.";
	}
	...
	public String gitAvanzadoActividadActualizado() {
		return "Estado e historial actualizados.";
	}

	@Override
	public String gitAvanzadoActividadFetch() {
		return "Obteniendo referencias del remote...";
	}

	@Override
	public String gitAvanzadoActividadPull() {
		return "Descargando e integrando cambios...";
	}

	@Override
	public String gitAvanzadoActividadPush() {
		return "Enviando commits al remote...";
	}
	...
	public String gitAvanzadoActividadPrepararTodo() {
		return "Preparando todos los cambios...";
	}

	@Override
	public String gitAvanzadoActividadQuitarPreparacion() {
		return "Quitando archivos seleccionados del área preparada...";
	}

	@Override
	public String gitAvanzadoActividadQuitarTodo() {
		return "Vaciando el área preparada...";
	}
	...
	public String gitAvanzadoActividadCrearRama(String rama) {
		return "Creando y cambiando a la rama '" + rama + "'...";
	}

	@Override
	public String gitAvanzadoActividadCambiarRama(String rama) {
		return "Cambiando a la rama '" + rama + "'...";
	}
	...
	public String universalatorDescripcion() {
		return "Esta GUI ayuda a encontrar mods que probablemente sean solo del cliente para quitarlos de un pack de servidor. Solo el método Universalator está implementado por ahora.";
	}

	@Override
	public String universalatorAdvertenciaSoloCliente() {
		return "El análisis es orientativo. Revise el resultado antes de quitar un mod. Los otros dos métodos todavía no están implementados.";
	}

	@Override
	public String universalatorMetodoUniversalator() {
		return "Usar Universalator para buscar mods del lado cliente para quitar";
	}

	@Override
	public String universalatorMetodoMetadatosLocales() {
		return "Buscar en los metadatos locales de los archivos del mod";
	}

	@Override
	public String universalatorMetodoMetadatosRemotos() {
		return "Buscar en los metadatos de archivos de Modrinth y CurseForge";
	}
	...
	public String universalatorMetodosTitulo() {
		return "Métodos de búsqueda";
	}

	@Override
	public String universalatorEscanear() {
		return "Escanear mods del cliente";
	}

	@Override
	public String universalatorActualizar() {
		return "Actualizar vista";
	}
	...
	public String universalatorEstadoEscaneando() {
		return "Escaneando mods... espere.";
	}

	@Override
	public String universalatorResultadoTitulo() {
		return "Mods cliente probables";
	}
	...
	public String universalatorSinResultados() {
		return "No se encontraron mods que parezcan ser únicamente del cliente.";
	}

	@Override
	public String universalatorBotonElegirEliminar() {
		return "Elegir mods para quitar...";
	}
	...
	public String universalatorConfirmarEliminar() {
		return "Seleccione los mods que quiera quitar del pack del servidor. Por seguridad se moverán a una carpeta de respaldo en vez de borrarse silenciosamente.";
	}

	@Override
	public String universalatorEliminadosExito() {
		return "Mods movidos a la carpeta de respaldo";
	}

	@Override
	public String universalatorNadaSeleccionado() {
		return "No seleccionó ningún mod.";
	}

	@Override
	public String universalatorErrorEscaneo() {
		return "Error al escanear los mods.";
	}

	@Override
	public String universalatorErrorEliminar() {
		return "Error al quitar los mods seleccionados.";
	}
	...
	public String universalatorRazonEntornoCliente() {
		return "el metadato declara entorno cliente";
	}

	@Override
	public String universalatorRazonMetadatosCliente() {
		return "los metadatos indican que es de lado cliente";
	}

	@Override
	public String universalatorRazonHeuristicaNombre() {
		return "el nombre coincide con heurísticas de mods cliente";
	}
