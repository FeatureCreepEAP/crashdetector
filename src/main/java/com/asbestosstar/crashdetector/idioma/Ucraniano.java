...
public class Ucraniano implements Idioma // ucraniano de Majnovschina. ¡NO SOMOS VYSHYVATNIKS!
{
	...
	public String migradorCAAvisoNoMigrado() {
		return "Попередження: через відмінності між типами конфігурації чорний список перевірок не може бути перенесений автоматично. Звідти ви також можете вимкнути попередження Intel та Mod List Diff; так само, як і в CrashDetector, вони вважаються звичайними перевілками. Якщо ви не ввімкнете примітивний режим, вам потрібно буде використовувати редактор HTML WYSIWYG у налаштуваннях CrashDetector для вставки посилань. Якщо ви використовуєте примітивний режим, посилання допомоги буде скопійовано автоматично з Crash Assistant. Щоб змінити кольори та налаштування в графічному інтерфейсі (GUI), вам потрібно перейти до налаштувань CrashDetector, зайти в область CDSkinCape/GUI Editor і вибрати тип GUI, а також його конкретну реалізацію. Зображення можна редагувати з наступного місця: "
				+ Statics.carpeta.resolve("imagenes").toString()
				+ ". Скрипти JEXL також не будуть перенесені. Якщо вам потрібно лише виконувати базовий аналіз за допомогою зіставлення рядків або регулярних виразів, ви можете використовувати функцію 'Agregar Razones' у корпоративній конфігурації; якщо вам потрібні більш просунуті функції, вам слід створити розширення на Java: https://github.com/FeatureCreepEAP/crashdetector-tutorial-extention-english";
	}
	...
	public String bittorrentArchivoCompartirDebeSerZip() {
		return "BitTorrent підтримує лише ZIP-файл, експортований функцією обміну екземпляром.";
	}

	public String bittorrentArchivoCompartirNoValido() {
		return "Файл, який намагалися поділитися, не існує або не може бути прочитаний.";
	}
	...
	public String bittorrentColorAcento() {
		return "Акцент клієнта BitTorrent";
	}

	public String bittorrentColorAcentoSecundario() {
		return "Вторинний акцент клієнта BitTorrent";
	}

	public String bittorrentColorBorde() {
		return "Межа клієнта BitTorrent";
	}

	public String bittorrentColorFondo() {
		return "Фон клієнта BitTorrent";
	}

	public String bittorrentColorPanel() {
		return "Панель клієнта BitTorrent";
	}

	public String bittorrentColorPanelClaro() {
		return "Світла панель клієнта BitTorrent";
	}

	public String bittorrentColorSeleccion() {
		return "Виділення клієнта BitTorrent";
	}

	public String bittorrentColorTexto() {
		return "Світлий текст клієнта BitTorrent";
	}

	public String bittorrentColorTextoOscuro() {
		return "Темний текст клієнта BitTorrent";
	}

	public String bittorrentComentarioTorrent() {
		return "Файл, наданий для діагностики та технічної підтримки через CrashDetector.";
	}

	public String bittorrentConfiguracionGuardada() {
		return "Конфігурація BitTorrent збережена. Зміни порту, DHT, PEX та локального виявлення будуть застосовані до нового runtime після перезапуску програми.";
	}

	public String bittorrentConfirmarPrivacidad() {
		return "Я розумію попередження про конфіденційність і дозволяю цю P2P-передачу.";
	}

	public String bittorrentCopiarMagnet() {
		return "Копіювати magnet";
	}

	public String bittorrentCrearCompartir() {
		return "Створити .torrent і почати обмін";
	}

	public String bittorrentDebeAceptarPrivacidad() {
		return "Ви повинні прочитати та прийняти попередження про конфіденційність перед початком передачі BitTorrent.";
	}

	public String bittorrentDestino() {
		return "Тека завантаження";
	}

	public String bittorrentDestinoNoValido() {
		return "Виберіть дійсну теку для завантаження з правами на запис.";
	}

	public String bittorrentDetenerSeleccionada() {
		return "Зупинити вибрану передачу";
	}

	public String bittorrentElegirDestino() {
		return "Вибрати теку завантаження";
	}

	public String bittorrentElegirOrigen() {
		return "Вибрати файл або теку для обміну";
	}

	public String bittorrentElegirTorrent() {
		return "Вибрати файл .torrent";
	}

	public String bittorrentErrorCrearComparticion() {
		return "Не вдалося створити або почати обмін BitTorrent.";
	}

	public String bittorrentErrorDetalle(String detalle) {
		return "Не вдалося завершити операцію BitTorrent:\n" + detalle;
	}
	...
	public String bittorrentFaltaTorrentOMagnet() {
		return "Вставте magnet або виберіть файл .torrent.";
	}

	public String bittorrentGuardarConfiguracion() {
		return "Зберегти трекери та налаштування";
	}

	public String bittorrentGuardarTorrent() {
		return "Зберегти файл .torrent";
	}

	public String bittorrentHilosHash() {
		return "Потоки перевірки";
	}
	...
	public String bittorrentMagnetCopiado() {
		return "Magnet скопійовано в буфер обміну.";
	}

	public String bittorrentMagnetNoValido() {
		return "Magnet недійсний або не містить info-hash BitTorrent.";
	}

	public String bittorrentOrigen() {
		return "Вихідний файл або тека";
	}

	public String bittorrentOrigenNoValido() {
		return "Виберіть дійсний вихідний файл або теку.";
	}

	public String bittorrentOrigenVacio() {
		return "Вибраний файл або тека не містять даних для обміну.";
	}

	public String bittorrentPestanaAbrir() {
		return "Відкрити .torrent або magnet";
	}

	public String bittorrentPestanaConfiguracion() {
		return "Конфіденційність та трекери";
	}

	public String bittorrentPestanaCrear() {
		return "Створити та поділитися";
	}
	...
	public String bittorrentPrivacidadAdvertencia() {
		return "ПОПЕРЕДЖЕННЯ ПРО КОНФІДЕНЦІЙНІСТЬ: BitTorrent — це однорангова мережа, а не приватне завантаження типу end-to-end. Ваша публічна IP-адреса видима налаштованим трекерам та пірам, які беруть участь у передачі. Імена файлів і тек, розміри та структура .torrent можуть бути видимі будь-кому, хто отримає .torrent або magnet. Ця версія без залежностей використовує лише ті трекери, які ви налаштуєте; вона не активує DHT, PEX або локальне виявлення. Перевірте вміст перед обміном і видаліть токени доступу, паролі, куки, ключі, сесії, особисті дані та чутливі логи. Діліться magnet або .torrent лише з авторизованою підтримкою і тримайте програму відкритою, поки ви є єдиним сідером.";
	}

	public String bittorrentPrivacidadTitulo() {
		return "Конфіденційність BitTorrent";
	}
	...
	public String bittorrentSeguirCompartiendo() {
		return "Продовжувати раздачу після завершення завантаження";
	}

	public String bittorrentSobrescribirTorrent(String ruta) {
		return "Файл .torrent вже існує:\n" + ruta + "\n\nПерезаписати його?";
	}
	...
	public String bittorrentTitulo() {
		return "Клієнт BitTorrent — Holostars EN";
	}

	public String bittorrentTorrentCreado(String ruta) {
		return "Файл .torrent створено, і сідування почалося:\n" + ruta
				+ "\n\nТримайте CrashDetector відкритим, поки підтримка не завершить завантаження.";
	}

	public String bittorrentTorrentNoValido() {
		return "Файл .torrent не містить коректного bencode.";
	}

	public String bittorrentTorrentSinInfo() {
		return "Файл .torrent не містить необхідного словника info.";
	}

	public String bittorrentTrackerNoValido(String tracker) {
		return "Недійсний трекер: " + tracker + "\nПриймаються тільки URL http, https або udp.";
	}

	public String bittorrentTrackers() {
		return "Трекери, по одному в рядку";
	}

	public String bittorrentTrackersConfig() {
		return "Користувацькі трекери BitTorrent";
	}

	public String bittorrentTransferenciaIniciada() {
		return "Передача BitTorrent розпочата.";
	}

	public String bittorrentUsarDht() {
		return "Використовувати DHT та публічні роутери для пошуку пірів";
	}

	public String bittorrentUsarLsd() {
		return "Використовувати локальне виявлення пірів у мережі LAN";
	}

	public String bittorrentUsarPex() {
		return "Дозволити обмін пірами між клієнтами";
	}

	public String bittorrentSinTrackersNiDht() {
		return "Налаштуйте принаймні один трекер HTTP, HTTPS або UDP перед створенням або відкриттям обміну BitTorrent на основі magnet.";
	}
	...
	public String transferidorClasesTitulo() {
		return "Передавання класів — Eon of Stars";
	}

	@Override
	public String transferidorClasesDescripcion() {
		return "Введіть ім’я класу, завантаженого у спостережуваному процесі, використовуючи крапки або скісні риски. CrashDetector запитає його поточні байти у JVM, а Пошук використовуватиме їх раніше за байти з JAR. Копії зберігаються лише в пам’яті й автоматично видаляються після зміни процесу.";
	}
	...
	public String generadorParchesCompilando() {
		return "Компіляція проєкту…";
	}

	@Override
	public String generadorParchesCreado(String ruta) {
		return "Проєкт створено: " + ruta;
	}

	@Override
	public String generadorParchesCompilado(String ruta) {
		return "JAR скомпільовано: " + ruta;
	}

	@Override
	public String generadorParchesError(String detalle) {
		return "Помилка: " + detalle;
	}

	@Override
	public String generadorParchesJdkInvalido() {
		return "Вибраний шлях не містить дійсного JDK із javac.";
	}

	@Override
	public String generadorParchesMcpInstruccion() {
		return "Після створення проєкту відкрийте AI > MCP і запустіть сервер MCP, щоб ШІ міг читати, редагувати та компілювати патч.";
	}

	@Override
	public String generadorParchesSeleccionarDirectorioTitulo() {
		return "Вибрати папку проєкту";
	}
	...
	public String generadorParchesProyectoExiste() {
		return "Папка вже є проєктом патча. Оновити файли шаблону?";
	}
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("uk", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("uk", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("uk", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("uk", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("uk", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("uk", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("uk", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("uk", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("uk", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("uk", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("uk", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("uk", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("uk", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("uk", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("uk", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("uk", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("uk", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("uk", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("uk", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("uk", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("uk", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("uk", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("uk", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("uk", clave, argumentos);
	}
	...
	public String mensajeWatchdogCierreClientePostMain() {
		return "<b style='color:#" + config.obtenerColorAdvertencia() + "'>" + "Minecraft надто довго закривався.</b>"
				+ "<p>Гра згенерувала:</p>" + "<code>java.lang.Error: Watchdog (Client shutdown from post-main)</code>"
				+ "<p>Цей звіт з'являється, коли процес Minecraft залишається активним приблизно "
				+ "15 секунд після початку закриття.</p>"
				+ "<p><b>Саме по собі це зазвичай не становить серйозної проблеми.</b> "
				+ "Це може означати, що мод, потік або завдання очищення зайняли занадто багато часу "
				+ "для завершення під час закриття.</p>"
				+ "<p>Це також може бути вторинний звіт, згенерований, коли гра вже "
				+ "закривалася після іншої помилки.</p>" + "<p><b>Що робити:</b></p>" + "<ul>"
				+ "<li>Якщо гра закрилася коректно і це сталося лише один раз, можете ігнорувати.</li>"
				+ "<li>Якщо це відбувається повторно, перевірте попередні помилки в " + "<code>latest.log</code>.</li>"
				+ "<li>Шукайте моди, які підтримують активні завдання, з'єднання або процеси під час закриття.</li>"
				+ "<li>Не припускайте, що останній потік, показаний у дампу, обов'язково є винним.</li>" + "</ul>";
	}

	public String nombreWatchdogCierreClientePostMain() {
		return "Повільне закриття клієнта (Watchdog post-main)";
	}
