...
//Esperanto
	...
	public String profilerDescripcion() {
		return "Ilo por analizi rendimenton, bazita sur instrumentado kaj specimenado.";
	}
	...
	public String profilerEstadoIniciado() {
		return "Analizilo de rendimento ekfunkciis.";
	}

	@Override
	public String profilerEstadoDetenido() {
		return "Analizilo de rendimento haltis.";
	}

	@Override
	public String profilerMuestraHilo(String nombreHilo) {
		return "Specimeno ricevita de fadeno: " + nombreHilo;
	}
	...
	public String mensajeCobblemonPinkanIslandsRhyhornModelo() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Eraro de modelo detektita por Rhyhorn.</b>"
	...
	public String mensajeColdSweatInitDynamicTags() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Eraro detektita en Cold Sweat.</b>"
				+ "<p>La protokolo enhavas indikojn kiel <b>$cold_sweat$onBuildStart</b>, "
				+ "<b>InitDynamicTagsEvent.fillTag</b> kaj <b>NullPointerException</b> kie "
	...
	public String mensajeClassCastExceptionGeneral(String lineaClassCast) {
		String detalle = lineaClassCast == null || lineaClassCast.isEmpty() ? ""
				: "<p><b>Linio detektita:</b></p><p><code>" + lineaClassCast + "</code></p>";

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "ClassCastException detektita.</b>"
				+ "<p>Ĉi tio signifas, ke klaso estis traktita kvazaŭ ĝi estus alia ne kongrua klaso aŭ interfaco.</p>"
				+ detalle + "<p>Ĉi tiu speco de eraro kutime estas kaŭzita de unu el ĉi tiuj situacioj:</p>" + "<ul>"
				+ "<li><b>Du ne kongruaj mod-oj</b> inter si.</li>"
				+ "<li><b>Mixins</b>, <b>transformers</b> aŭ patch-oj kiuj modifas klason kaj igas alian parton de la ludo atendi malsaman tipon.</li>"
				+ "<li>Aliaj mod-oj ĉeestantaj en la <b>stacktrace</b> kiuj kaŭzas la miscast.</li>" + "</ul>"
				+ "<p><b>Kion kontroli:</b></p>" + "<ul>"
				+ "<li>Rigardu la liniojn de la <b>stacktrace</b> rilatajn al ĉi tiu eraro.</li>"
				+ "<li>Prestu specialan atenton al nomoj de mod-oj aŭ klasoj kun la formato <b>$modid$algo</b>, ĉar ili kutime indikas implikitajn mod-ojn.</li>"
				+ "<li>Provu ĝisdatigi, forigi aŭ apartigi mod-ojn kiuj ŝajnas esti rilataj al la nevalida konverto.</li>"
				+ "</ul>" + "<p>Kvankam <b>ClassCastException</b> ne ĉiam estas mortiga, tre ofte ĝi ja estas.</p>";
	}

	@Override
	public String nombreClassCastExceptionGeneral() {
		return "ClassCastException detektita";
	}

	@Override
	public String mensajeValkyrienSkiesTournamentLithiumPoiInjection() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Ebla nekongrueco inter Valkyrien Skies Tournament kaj Lithium/Radium detektita.</b>"
				+ "<p>La protokolo enhavas <b>InvalidInjectionException</b> kie aperas mixin de "
				+ "<b>Lithium</b> pri <b>POI</b> kune kun <b>valkyrienskies-common.mixins.json:feature.poi.MixinPOIManager</b>.</p>"
				+ "<p>Ĉi tiu problemo kutime okazas kiam oni uzas <b>malnovan version de Lithium</b> aŭ "
				+ "<b>fork-on bazitan sur malnova Lithium</b>, kiel <b>Radium Reforged</b>, kune kun "
				+ "<b>VS Tournament</b>.</p>" + "<p><b>Kion provi：</b></p>" + "<ul>"
				+ "<li>Ĝisdatigu <b>Lithium</b> al pli nova kaj kongrua versio.</li>"
				+ "<li>Se vi estas en <b>Forge/NeoForge</b> kaj uzas <b>Radium Reforged</b> aŭ alian malnovan fork-on, forigu ĝin.</li>"
				+ "<li>Anstataŭe, provu <b>Harium</b>, kiu estas moderna fork-o de Radium sinkronigita kun lastatempaj plibonigoj de Lithium.</li>"
				+ "<li>Se la problemo komenciĝis post ĝisdatigo de mod-oj, kontrolu la precizan kombinaĵon inter <b>VS Tournament</b> kaj via mod-o por optimumigo de AI/POI.</li>"
				+ "</ul>"
				+ "<p>En praktiko, ĉi tiu paneo kutime venas de malnova realigo de <b>Lithium/Radium</b> kiu ne bone kongruas kun <b>VS Tournament</b>.</p>";
	}

	@Override
	public String nombreValkyrienSkiesTournamentLithiumPoiInjection() {
		return "Nekongrueco de VS Tournament kun Lithium/Radium";
	}

	@Override
	public String mensajeVSTournamentVSConfigClassNoExiste() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Ŝajnas, ke VS Tournament estas tro malnova por via versio de Valkyrien Skies.</b>"
				+ "<p>La protokolo enhavas <b>NoClassDefFoundError</b> por "
				+ "<b>org/valkyrienskies/core/impl/config/VSConfigClass</b> kaj ankaŭ linion de "
				+ "<b>org.valkyrienskies.tournament.TournamentMod.init(...)</b>.</p>"
				+ "<p>Tio kutime signifas, ke vi havas <b>malnovan version de VS Tournament</b>, kiu provas "
				+ "uzi malnovajn internajn klasojn de <b>Valkyrien Skies</b>, kiuj ne plu ekzistas.</p>"
				+ "<p><b>Kion fari：</b></p>" + "<ul>" + "<li>Forigu la malnovan <b>VS Tournament</b>.</li>"
				+ "<li>Anstataŭe, uzu <b>VS Tournament Reforged</b>.</li>"
				+ "<li>Kontrolu ankaŭ, ĉu la versio de <b>Valkyrien Skies</b> kongruas kun la versio subtenata de la aldonaĵo.</li>"
				+ "</ul>"
				+ "<p>La rekomendo ŝanĝi al <b>VS Tournament Reforged</b> kongruas kun la aktuala stato de la projekto： "
				+ "la origina versio de Tournament daŭre estas listigita kiel malnova mod-o por 1.18.2, dum "
				+ "<b>VS Tournament Reforged</b> estas publikigita aparte kaj nuntempe anoncas subtenon por Valkyrien "
	...
	public String mensajeControlifyRemoveReloadingScreen() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Nekongrueco detektita inter Controlify kaj Remove Reloading Screen.</b>"
				+ "<p>La protokolo enhavas la liniojn <b>Attempted to fetch default config before DefaultConfigManager was ready!</b> "
				+ "kaj <b>$rrls$init</b>, kio kutime indikas konfliktion inter <b>Controlify</b> kaj "
				+ "<b>Remove Reloading Screen</b>.</p>"
				+ "<p><b>Probabla kaŭzo:</b> Remove Reloading Screen modifas partojn de la ŝarga ekrano aŭ la ŝarga procezo, "
				+ "dum Controlify provas inicialigi sian agordon antaŭ ol la sistemo estas plene preta.</p>"
				+ "<p><b>Rekomenditaj ebloj:</b></p>" + "<ul>" + "<li>Forigu <b>Remove Reloading Screen</b>.</li>"
				+ "<li>Aŭ ĝisdatigu <b>Controlify</b> kaj <b>Remove Reloading Screen</b> se novaj versioj haveblas.</li>"
				+ "<li>Se la problemo daŭras, tenu <b>Controlify</b> kaj forigu ajnan mod-on, kiu modifas la ŝargan ekranon.</li>"
				+ "</ul>" + "<p>Mod-oj, kiuj modifas la ŝargan ekranon, ofte kaŭzas nekongruecojn kun aliaj mod-oj, "
				+ "kaj kutime ofertas malmultan praktikan utilon kompare kun la problemoj, kiujn ili povas kaŭzi.</p>";
	}

	@Override
	public String nombreControlifyRemoveReloadingScreen() {
		return "Nekongrueco: Controlify vs Remove Reloading Screen";
	}

	@Override
	public String mensajeBiomesOPlentyFogDataLiquidosPersonalizados() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Ebla problemo kun Biomes O' Plenty kaj personaj likvaĵoj.</b>"
				+ "<p>La protokolo enhavas la eraron <b>class org.joml.Vector4f cannot be cast to class "
				+ "net.minecraft.client.renderer.fog.FogData</b> kune kun referenco al <b>Biomes O' Plenty</b>.</p>"
				+ "<p>Ĉi tio eble rilatas al <b>Biomes O' Plenty</b>, precipe pri biomoj, nebulo "
				+ "aŭ personaj likvaĵoj. Tamen, ne estas tute certe, ke Biomes O' Plenty estas la sola kaŭzo.</p>"
				+ "<p><b>Rekomenditaj ebloj:</b></p>" + "<ul>"
				+ "<li>Provu redakti la datumojn de la ludanto por movi lin al alia loko en la mondo.</li>"
				+ "<li>Provu ŝargi la mondon sen <b>Biomes O' Plenty</b>.</li>"
				+ "<li>Se la mondo ŝargas post movi la ludanton, la problemo verŝajne okazas en specifa zono, "
				+ "specifa biomo aŭ proksima persona likvaĵo.</li>"
				+ "<li>Vi ankaŭ povas provi ĝisdatigi <b>Biomes O' Plenty</b> kaj la mod-ojn rilatajn al rendorado, nebulo, "
				+ "ombroprogrametoj (shaders) aŭ dimensioj.</li>" + "</ul>"
				+ "<li>Se forigi Biomes O' Plenty permesas startigi la ludon, kontrolu ĉu la ludanto estis ene aŭ proksime de biomo "
				+ "aŭ fluido aldonita de tiu mod-o.</p>";
	}

	@Override
	public String nombreBiomesOPlentyFogDataLiquidosPersonalizados() {
		return "Ebla problemo: Biomes O' Plenty kaj FogData";
	}

	@Override
	public String mensajeKotlinReflectionInternalErrorVersion() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Interna eraro de reflekto de Kotlin detektita.</b>"
				+ "<p>La protokolo enhavas <b>kotlin.reflect.jvm.internal.KotlinReflectionInternalError</b> kun mesaĝo simila al "
				+ "<b>Property 'none' not resolved</b>.</p>"
				+ "<p>Ĉi tiu speco de eraro estas ofta kun certaj versioj de <b>Fabric Language Kotlin</b> / <b>Kotlin</b>. "
				+ "En ĉi tiu okazo aperas klaso de <b>Inventory Profiles Next</b>, sed la sama problemo ankaŭ povas okazi "
				+ "kun aliaj mod-oj, kiuj uzas Kotlin.</p>" + "<p><b>Rekomenditaj ebloj:</b></p>" + "<ul>"
				+ "<li>Ĝisdatigu <b>Fabric Language Kotlin</b> al versio <b>2.3.40</b>, se disponebla por via versio de Minecraft.</li>"
				+ "<li>Se ĝisdatigo ne funkcias, provu malaltigi <b>Fabric Language Kotlin</b> al versio <b>2.3.10</b>.</li>"
				+ "<li>Ĝisdatigu ankaŭ <b>Inventory Profiles Next</b> se la protokolo mencias klasojn de tiu mod-o.</li>"
				+ "<li>Se la eraro aperas kun alia mod-o, kontrolu ĉu tiu mod-o dependas de Kotlin kaj provu ŝanĝi la version de "
				+ "<b>Fabric Language Kotlin</b>.</li>" + "</ul>" + "<p>Rilata teknika referenco: "
				+ "<a href='https://github.com/FabricMC/fabric-language-kotlin/issues/183'>Problemo #183 de Fabric Language Kotlin</a>.</p>";
	}
	...
	public String mensajeEntradaDuplicadaIdModerno() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				...
				+ "malsamajn enigojn uzante la saman internan ID.</p>" + "<p><b>Rekomenditaj opcioj:</b></p>" + "<ul>"
	...
	public String errorCrashProvocadoPorComando(String comandoDetectado) {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Minecraft estis fermita pro komando de kraŝo.</b>" + "<p>La protokolo indikas, ke la komando <code>"
				+ comandoDetectado + "</code> estis plenumita.</p>"
				+ "<p>Ĉi tio kutime signifas, ke la ludo ne fermiĝis pro normala eraro de modoj, sed ĉar iu "
				+ "uzis komandon dizajnitan por provoki kraŝon mane.</p>" + "<p><b>Kion kontroli:</b></p>" + "<ul>"
	...
	public String tituloCrearConfigBBE() {
		return "Krei agordon de Better Block Entities";
	}

	public String descripcionCrearConfigBBE() {
		return "La dosiero BBEConfig.json ne ekzistas.";
	}

	public String sugerenciaCrearConfigBBE() {
		return "Krei BBEConfig.json kun optimumigoj por kestoj, ŝulker-kompletoj, signoj, litoj, sonoriloj kaj standardoj.";
	}

	public String tituloActivarOptimizacionMaestraBBE() {
		return "Aktivigi ĉefan optimumigon de BBE";
	}

	public String descripcionActivarOptimizacionMaestraBBE() {
		return "Ŝajnas, ke Better Block Entities ne havas aktivigitan la ĉefan optimumigon.";
	}

	public String sugerenciaActivarOptimizacionMaestraBBE() {
		return "Aldoni {\"option\":\"optimize.master\",\"value\":true}";
	}

	public String tituloActivarCullingTextoCartelesBBE() {
		return "Aktivigi forviŝadon (culling) de signa teksto";
	}

	public String descripcionActivarCullingTextoCartelesBBE() {
		return "Malpliigas la bildigon de signa teksto je distanco.";
	}

	public String sugerenciaActivarCullingTextoCartelesBBE() {
		return "Aldoni {\"option\":\"misc.sign_text_culling\",\"value\":true}";
	}

	public String tituloAumentarSleepDelayEntityCulling() {
		return "Pliigi sleepDelay de EntityCulling";
	}

	public String descripcionAumentarSleepDelayEntityCulling() {
		return "EntityCulling kontrolos estaĵojn malpli ofte.";
	}
	...
	public String tituloSubirLimiteHitboxEntityCulling() {
		return "Levi limon de kolizia skatolo (hitbox)";
	}

	public String descripcionSubirLimiteHitboxEntityCulling() {
		return "Permesas pli agreseman forviŝadon antaŭ transiri al pli malrapidaj vojoj.";
	}
	...
	public String tituloDesactivarDatosF3EntityCulling() {
		return "Malaktivigi F3-datumojn de EntityCulling";
	}

	public String descripcionDesactivarDatosF3EntityCulling() {
		return "Forigas kromajn sencimigajn informojn de la mod.";
	}
	...
	public String tituloActivarBufferingSignsImmediatelyFast() {
		return "Aktivigi eksperimentan bufroregon de signoj";
	}

	public String descripcionActivarBufferingSignsImmediatelyFast() {
		return "Povas plibonigi rendimenton kiam estas multaj signoj.";
	}
	...
	public String tituloReducirConflictosResourcePacksImmediatelyFast() {
		return "Malpliigi konflikto-traktadon de rimedpakoj";
	}

	public String descripcionReducirConflictosResourcePacksImmediatelyFast() {
		return "Povas forigi kroman laboron, sed ankaŭ povas kaŭzi vidajn problemojn kun rimedpakoj.";
	}
	...
	public String tituloOcultarBotonNCR() {
		return "Kaŝi butonon de No Chat Reports";
	}

	public String descripcionOcultarBotonNCR() {
		return "Interfaca ŝanĝo; ne multe plibonigas FPS, sed purigas la ekranon.";
	}
	...
	public String tituloActivarMixinsExperimentalesLithium() {
		return "Aktivigi eksperimentajn mixins de Lithium";
	}

	public String descripcionActivarMixinsExperimentalesLithium() {
		return "Ebligas kromajn eksperimentajn optimumigojn.";
	}
	...
	public String tituloUsarDetectorThreadingPequenoFerriteCore() {
		return "Uzi malgrandan detektilon de fadenado";
	}

	public String descripcionUsarDetectorThreadingPequenoFerriteCore() {
		return "Malpliigas memoron, sed povas esti pli riska.";
	}
	...
	public String tituloModernFixRecursosDinamicos() {
		return "Aktivigi dinamikajn rimedojn de ModernFix";
	}

	public String descripcionModernFixRecursosDinamicos() {
		return "Povas malpliigi memoruzon kaj laboron per pli efika ŝargado de rimedoj.";
	}

	public String tituloModernFixRenderizadoresDinamicosEntidades() {
		return "Aktivigi dinamikajn bildigilojn de estaĵoj";
	}

	public String descripcionModernFixRenderizadoresDinamicosEntidades() {
		return "Povas plibonigi rendimenton per pli efika administrado de estaĵbildigiloj.";
	}

	public String tituloModernFixRenderizadoItemsRapido() {
		return "Aktivigi rapidan bildigon de objektoj";
	}

	public String descripcionModernFixRenderizadoItemsRapido() {
		return "Povas plibonigi rendimenton dum bildigo de objektoj.";
	}

	public String tituloModernFixWorldgenAllocation() {
		return "Malpliigi asignojn dum mondgreado";
	}

	public String descripcionModernFixWorldgenAllocation() {
		return "Povas malpliigi memoran rubon dum mondgreado.";
	}

	public String tituloModernFixDeduplicacionIngredientes() {
		return "Aktivigi deduplikigon de ingrediencoj";
	}

	public String descripcionModernFixDeduplicacionIngredientes() {
		return "Malpliigas duplikitajn objektojn rilatajn al receptoj kaj ingrediencoj.";
	}

	public String tituloSodiumRenderCielo() {
		return "Aktivigi optimumigon/bildigon de ĉielo en Sodium";
	}

	public String descripcionSodiumRenderCielo() {
		return "Povas ĝustigi la bildig-konduton de la ĉielo.";
	}

	public String tituloActivarLightmapCaching() {
		return "Aktivigi kaŝmemoron de lummapo";
	}

	public String descripcionActivarLightmapCaching() {
		return "Evitas rekalkuli lumigon kiam ĝi ne necesas.";
	}
	...
	public String tituloOcultarTextoF3BadOptimizations() {
		return "Kaŝi F3-tekston de BadOptimizations";
	}

	public String descripcionOcultarTextoF3BadOptimizations() {
		return "Malpliigas sencimigan bruon sur la F3-ekrano.";
	}
	...
	public String tituloDesactivarLogConfigBadOptimizations() {
		return "Malaktivigi agordan protokolon";
	}

	public String descripcionDesactivarLogConfigBadOptimizations() {
		return "Evitas presi tutan agordon dum startado.";
	}
	...
	public String tituloActivarSerializadorGCFreeC2ME() {
		return "Aktivigi GC-liberan seriigilon de C2ME";
	}

	public String descripcionActivarSerializadorGCFreeC2ME() {
		return "Malpliigas memorasignojn dum ŝargado aŭ konservado de pecoj.";
	}
	...
	public String tituloDesactivarSyncPlayerTicketsC2ME() {
		return "Malaktivigi syncPlayerTickets";
	}

	public String descripcionDesactivarSyncPlayerTicketsC2ME() {
		return "Povas plibonigi pecrendimenton, sed povas influi teknikajn aparatojn.";
	}
	...
	public String tituloUsarCullingHojasDepthMoreCulling() {
		return "Uzi folian forviŝadon per DEPTH";
	}

	public String descripcionUsarCullingHojasDepthMoreCulling() {
		return "Uzas pli agreseman folian forviŝadon ol la normala reĝimo.";
	}
	...
	public String tituloActivarEndGatewayCullingMoreCulling() {
		return "Aktivigi forviŝadon de Fina Portalo";
	}

	public String descripcionActivarEndGatewayCullingMoreCulling() {
		return "Evitas nebezonan bildigon de Finaj Portaloj.";
	}
	...
	public String tituloActivarActivationRangeServerCore() {
		return "Aktivigi aktivigan rangon";
	}

	public String descripcionActivarActivationRangeServerCore() {
		return "Malpliigas tikojn de estaĵoj malproksimaj de la ludanto.";
	}
	...
	public String tituloActivarRangoVerticalServerCore() {
		return "Aktivigi vertikan rangon";
	}

	public String descripcionActivarRangoVerticalServerCore() {
		return "Malpliigas tikojn de estaĵoj tre super aŭ sub la ludanto.";
	}
	...
	public String impactoNegativoAlto() {
		return "Alta negativa efiko";
	}

	public String advertenciaModsCulling() {
		return "Forviŝaj (culling) modoj povas kaŭzi malkongruecojn kun kelkaj modoj, kraŝojn, erarojn kie la ludo ĉesas ĝuste tiki, kaj ankaŭ povas igi aŭtomatajn farmojn aŭ fabrikojn ĉesi funkcii.";
	}

	public String tituloModBadOptimizations() {
		return "Aldoni BadOptimizations";
	}

	public String descripcionModBadOptimizations() {
		return "Aldonas klientajn mikro-optimumigojn kiel kaŝmemoron de lummapo, kaŝmemoron de ĉielo kaj reduktadon de nebezonaj alvokoj.";
	}

	public String tituloModBBE() {
		return "Aldoni Better Block Entities";
	}

	public String descripcionModBBE() {
		return "Optimumigas la bildigon de blokaĵoj kiel kestoj, ŝulker-kompletoj, litoj, sonoriloj, standardoj kaj signoj.";
	}

	public String tituloModC2ME() {
		return "Aldoni Concurrent Chunk Management Engine";
	}

	public String descripcionModC2ME() {
		return "Plibonigas ŝargadon, generadon kaj administradon de pecoj per samtempa prilaborado. Povas esti tre potenca, sed ankaŭ povas kaŭzi malkongruecojn en grandaj modpakoj.";
	}

	public String tituloModEntityCulling() {
		return "Aldoni EntityCulling";
	}

	public String descripcionModEntityCulling() {
		return "Evitas bildigi nevideblajn estaĵojn. " + advertenciaModsCulling();
	}

	public String tituloModFerriteCore() {
		return "Aldoni FerriteCore";
	}

	public String descripcionModFerriteCore() {
		return "Malpliigas memoruzon per deduplikigo kaj pli efikaj internaj strukturoj.";
	}

	public String tituloModImmediatelyFast() {
		return "Aldoni ImmediatelyFast";
	}

	public String descripcionModImmediatelyFast() {
		return "Optimumigas diversajn partojn de tuja bildigo, teksto, bufroj, mapoj kaj interfaco.";
	}

	public String tituloModLithium() {
		return "Aldoni Lithium";
	}

	public String descripcionModLithium() {
		return "Optimumigas ludlogikon, estaĵojn, blokojn, fizikon kaj aliajn sistemojn sen multe ŝanĝi la vanilan konduton.";
	}

	public String tituloModModernFix() {
		return "Aldoni ModernFix";
	}

	public String descripcionModModernFix() {
		return "Aldonas multajn optimumigojn de memoro, ŝargado, rimedoj kaj ĝenerala rendimento. Ĝiaj iloj rilataj al atlaso povas kolizii kun modoj, kiuj faras la atlason pli malgranda.";
	}

	public String tituloModMoreCulling() {
		return "Aldoni More Culling";
	}

	public String descripcionModMoreCulling() {
		return "Aldonas forviŝadon por blokoj, folioj, kadroj de objektoj, pentraĵoj, pluvo, lumturoj kaj aliaj elementoj. "
				+ advertenciaModsCulling();
	}

	public String tituloModScalableLux() {
		return "Aldoni ScalableLux";
	}

	public String descripcionModScalableLux() {
		return "Optimumigas kalkulojn rilatajn al lumigado kaj povas plibonigi rendimenton en mondoj kun multaj lumŝanĝoj.";
	}

	public String tituloModServerCore() {
		return "Aldoni ServerCore";
	}

	public String descripcionModServerCore() {
		return "Aldonas serverflankajn optimumigojn, aktivigan rangon, kontrolojn de limoj de estaĵoj, reduktadon de tikoj kaj plibonigojn de ŝargado.";
	}

	public String tituloModSodium() {
		return "Aldoni Sodium";
	}

	public String descripcionModSodium() {
		return "Ĉefa mod de bildig-optimumigo. Kutime estas unu el la plej gravaj plibonigoj por FPS.";
	}

	public String tituloModVMP() {
		return "Aldoni Very Many Players";
	}

	public String descripcionModVMP() {
		return "Optimumigas serversistemojn por trakti multajn ludantojn. La atendata modo-ID estas vmp.";
	}
	...
	public String descripcionModMCMT() {
		return "Provas multfadenigi partojn de la Minecraft-servilo. Povas plibonigi rendimenton en kelkaj kazoj, sed havas altan riskon de malkongruecoj, tik-eraroj kaj stranga konduto.";
	}

	public String tituloLiabilityUranium() {
		return "Forigi Uranium";
	}

	public String descripcionLiabilityUranium() {
		return "Uranium estas modo desegnita por intence malrapidigi la ludon. Ĝi ne devus esti instalita se oni volas rendimenton.";
	}

	// Esperanto (Esperanto)
	public String tituloAmbientalSinXmx() {
		return "Agordi maksimuman memoron de Java";
	}

	public String descripcionAmbientalSinXmx(int mods, String minimo, String maximoSeguro) {
		return "-Xmx ne estis detektita en la donitaj argumentoj. Por " + mods + " modoj, la sugestita minimumo estas "
				+ minimo + ", ne superante proksimume " + maximoSeguro + ".";
	}

	public String sugerenciaAmbientalSinXmx(String minimo) {
		return "Aldoni -Xmx" + minimo.replace(" ", "");
	}

	public String tituloAmbientalDemasiadaMemoria() {
		return "Malpliigi asignitan memoron";
	}

	public String descripcionAmbientalDemasiadaMemoria(String xmx, String total, String maximoSeguro) {
		return "La instanco havas asignitajn " + xmx + " el " + total
				+ ". Ne rekomendas asigni pli ol 80% de la disponebla RAM.";
	}

	public String sugerenciaAmbientalDemasiadaMemoria(String maximoSeguro) {
		return "Malpliigi -Xmx al " + maximoSeguro + " aŭ malpli.";
	}

	public String tituloAmbientalMemoriaInsuficiente() {
		return "Pliigi asignitan memoron";
	}

	public String descripcionAmbientalMemoriaInsuficiente(int mods, String xmx, String minimo) {
		return "La instanco havas " + xmx + " asignitajn. Por " + mods + " modoj, la sugestita minimumo estas " + minimo
				+ ".";
	}

	public String sugerenciaAmbientalMemoriaInsuficiente(String minimo) {
		return "Pliigi -Xmx al almenaŭ " + minimo + ".";
	}

	public String tituloAmbientalJava8GC() {
		return "Uzi G1GC aŭ Shenandoah en Java 8";
	}

	public String descripcionAmbientalJava8GC() {
		return "En Java 8 oni rekomendas uzi G1GC aŭ Shenandoah por redukti paŭzojn kaj plibonigi stabilecon.";
	}

	public String sugerenciaAmbientalJava8GC() {
		return "Aldoni -XX:+UseG1GC aŭ -XX:+UseShenandoahGC.";
	}
	...
	public String descripcionAmbientalZGC(String ramTotal) {
		return "La komputilo havas pli ol 12 GB da RAM (" + ramTotal
				+ "). Se la Java-distribuo subtenas ĝin, ZGC povas redukti paŭzojn de la rubkolektisto.";
	}

	public String sugerenciaAmbientalZGC() {
		return "En Java 17 aŭ supera, provu -XX:+UseZGC.";
	}

	public String tituloAmbientalAikar() {
		return "Aldoni flagojn de Aikar";
	}

	public String descripcionAmbientalAikar() {
		return "En Java 17 aŭ antaŭa, la flagoj de Aikar kutime plibonigas la konduton de G1GC por Minecraft.";
	}

	public String sugerenciaAmbientalAikar() {
		return "Uzi flagojn de Aikar, inkluzive -XX:+UseG1GC -XX:+ParallelRefProcEnabled -XX:MaxGCPauseMillis=200.";
	}

	public String tituloAmbientalRedHatJDK() {
		return "Uzi Red Hat JDK";
	}

	public String descripcionAmbientalRedHatJDK(int javaMayor, String os) {
		return "Por Java " + javaMayor + " en " + os + ", oni rekomendas Red Hat JDK pro stabileco kaj kongrueco.";
	}

	public String sugerenciaAmbientalRedHatJDK() {
		return "Instali Red Hat JDK por Java 8 aŭ Java 11.";
	}

	public String tituloAmbientalAzulPrime() {
		return "Konsideri Azul Prime";
	}

	public String descripcionAmbientalAzulPrime() {
		return "En Linux kun Java 16 aŭ supera kaj pli ol 16 GB da RAM, Azul Prime povas esti bona elekto de rendimento.";
	}

	public String sugerenciaAmbientalAzulPrime() {
		return "Provi Azul Prime se la komputilo havas pli ol 16 GB da RAM.";
	}

	public String tituloAmbientalGraalVM() {
		return "Konsideri GraalVM";
	}

	public String descripcionAmbientalGraalVM() {
		return "Kun Java 16 aŭ supera kaj pli ol 16 GB da RAM, GraalVM povas esti utila alternativo ekster Linux.";
	}

	public String sugerenciaAmbientalGraalVM() {
		return "Provi GraalVM se la komputilo havas pli ol 16 GB da RAM.";
	}

	public String tituloAmbientalDiscoBajo() {
		return "Kontroli liberan spacon sur disko";
	}

	public String descripcionAmbientalDiscoBajo(String libre) {
		return "La disko havas malmultan liberan spacon: " + libre
				+ ". Minecraft povas malsukcesi, malrapide konservi aŭ korupti datumojn se ĝi elĉerpiĝas.";
	}

	public String sugerenciaAmbientalDiscoBajo() {
		return "Liberigu spacon ĝis havi almenaŭ 20 GB disponeblajn.";
	}

	public String tituloAmbientalWindowsRHEL9() {
		return "Konsideri RHEL 9 por testado";
	}

	public String descripcionAmbientalWindowsRHEL9() {
		return "En Windows, oni rekomendas konsideri RHEL 9 ĉar ĝi inkluzivas Red Hat JDK, estas stabila, estas elŝutebla senpage por individuoj kaj estas kie la plej multaj testoj faratas.";
	}

	public String sugerenciaAmbientalWindowsRHEL9() {
		return "Provi la instancon en RHEL 9 se oni serĉas maksimuman stabilecon de testado.";
	}

	public String tituloAmbientalRaptorLake() {
		return "Averto pri Intel Raptor Lake";
	}

	public String descripcionAmbientalRaptorLake() {
		return "Estis detektita la problemo de Raptor Lake markita de la ekzistanta kontrolo. Ĉi tio povas kaŭzi nestabilecon, kraŝojn kaj erarojn kiuj ŝajnas esti de la modpako.";
	}

	public String sugerenciaAmbientalRaptorLake() {
		return "Ĝisdatigu BIOS/mikrokodon kaj kontrolu la averton de Raptor Lake antaŭ kulpigi la modpakon.";
	}

	// Esperanto (Esperanto)
	@Override
	public String tituloAmbientalNeoForge1201Antiguo() {
		return "Malnova NeoForge 1.20.1 detektita";
	}

	@Override
	public String descripcionAmbientalNeoForge1201Antiguo() {
		return "FancyModLoader 47 aŭ vojo kongrua kun NeoForge 1.20.1 estis detektita. "
				+ "NeoForge 1.20.1 estis forko de MinecraftForge 1.20.1 kaj kutime estas binare kongrua, "
				+ "sed tiu linio establas frue forlasita kaj povas manki pluraj optimumigoj disponeblaj en Forge.";
	}

	@Override
	public String sugerenciaAmbientalNeoForge1201Antiguo() {
		return "Por 1.20.1, se la modpako permesas, konsideru uzi MinecraftForge 1.20.1 anstataŭ NeoForge 1.20.1.";
	}

	@Override
	public String tituloAmbientalGPU() {
		return "Problemo de GPU detektita";
	}

	@Override
	public String descripcionAmbientalGPU() {
		return "Alia kontrolo jam detektis eblan problemon de GPU, OpenGL aŭ elekto de grafika karto.";
	}

	@Override
	public String sugerenciaAmbientalGPU() {
		return "Kontrolu, ke Minecraft uzas la ĝustan GPU, ĝisdatigu pelilojn kaj evitu nestabilajn hibridajn agordojn.";
	}

	// Esperanto (Esperanto)
	@Override
	public String gpuFixTitulo() {
		return "Agordo de GPU";
	}
	...
	public String gpuFixBotonAplicar() {
		return "Apliki agordon";
	}

	@Override
	public String gpuFixBotonFuenteTLauncher() {
		return "Malfermi gvidilon de TLauncher";
	}

	@Override
	public String gpuFixBotonVirusTotal() {
		return "Malfermi analizon de VirusTotal";
	}

	@Override
	public String gpuFixBotonOptimusLinux() {
		return "Malfermi gvidilon de NVIDIA Optimus";
	}
	...
	public String gpuFixTextoWindows() {
		return Statics.nombre_cd.obtener() + " detektis, ke Minecraft eble ne uzas la altrendimentan GPU.\n\n"
				...
				+ "GpuPreference=0 = aŭtomata decido de Windows.\n"
				+ "GpuPreference=1 = ŝparo de energio / integrita GPU.\n" + "GpuPreference=2 = altrendimenta GPU.\n\n"
				+ "Parto de ĉi tiu informo estis akirita dank' al la esploro publikigita de TLauncher kaj al la analizo "
				+ "de konduto disponebla en VirusTotal.";
	}
	...
	public String gpuFixTextoLinux() {
		return Statics.nombre_cd.obtener() + " detektis eblan problemon rilatan al NVIDIA Optimus aŭ PRIME.\n\n"
				...
				+ "La suba butono malfermos la rekomenditan oficialan dokumentaron.";
	}
	...
	public String gpuFixLinuxManual() {
		return "En Linux kutime la agordo devas esti farita mane depende de la distribuo, "
				+ "pelilo NVIDIA kaj sistemo Optimus/PRIME uzata.";
	}

	@Override
	public String gpuFixSistemaNoSoportado() {
		return "Operaciumo ne subtenata por la aŭtomata agordo de GPU.";
	}

	@Override
	public String gpuFixJavaNoDetectado() {
		return "Ne eblis detekti la nunan vojon de javaw.exe.";
	}

	@Override
	public String gpuFixWindowsAplicado(String ruta) {
		return "La agordo de GPU estis aplikita sukcese por:\n\n" + ruta + "\n\n"
				+ "GpuPreference=2 indikas altrendimentan GPU.";
	}

	@Override
	public String gpuFixErrorAplicando() {
		return "Okazis eraro dum la provo apliki la agordon de GPU";
	}

	@Override
	public String gpuFixMacAplicado() {
		return "La agordo de altrendimenta GPU estis aplikita.";
	}

	@Override
	public String gpuFixMacError() {
		return "Ne eblis apliki la agordon de GPU en macOS";
	}

	// Esperanto (Esperanto)
	@Override
	public String rendimientoTitulo() {
		return "Administrilo de rendimento";
	}
	...
	public String rendimientoBotonAnalizar() {
		return "Analizi rendimenton";
	}

	@Override
	public String rendimientoBotonAbrirGPU() {
		return "Malfermi agordon de GPU";
	}

	@Override
	public String rendimientoDescripcion() {
		return "Ĉi tiu panelo kontrolas mediajn problemojn, rekomenditajn aŭ riskajn modojn, kaj agordajn opciojn kiuj povas plibonigi rendimenton. Ne ĉiuj opcioj funkcias kune, ne ĉiuj taŭgas por ĉiu versio de Minecraft kaj ne ĉiuj estas kongruaj kun ĉiu modŝargilo. Tio estas bone: vi ne bezonas perfektan optimumigan poenton.";
	}

	@Override
	public String rendimientoNotaCompatibilidad() {
		return "Noto: ĉi tiuj sugestoj estas eblecoj, ne ordono apliki ĉion. Iuj opcioj povas kolizii inter si aŭ ne esti taŭgaj por via versio, lanĉilo, modŝargilo aŭ modpako.";
	}
	...
	public String rendimientoPestanaAmbiental() {
		return "Mediaj problemoj";
	}

	@Override
	public String rendimientoPestanaMods() {
		return "Rekomenditaj modoj kaj riskoj";
	}

	@Override
	public String rendimientoPestanaConfigs() {
		return "Agordaj opcioj";
	}

	@Override
	public String rendimientoResumenTitulo() {
		return "Resumo de la analizo";
	}

	@Override
	public String rendimientoResumenAmbiental(int cantidad) {
		return "Mediaj problemoj trovitaj: " + cantidad;
	}

	@Override
	public String rendimientoResumenMods(int cantidad) {
		return "Sugestoj aŭ riskoj de modoj trovitaj: " + cantidad;
	}

	@Override
	public String rendimientoResumenConfigs(int cantidad) {
		return "Agordaj sugestoj trovitaj: " + cantidad;
	}

	@Override
	public String rendimientoResumenGPU() {
		return "Problemo de GPU estis detektita. Pro tio la butono por malfermi la agordon de GPU estis aktivigita.";
	}

	@Override
	public String rendimientoSinHallazgos() {
		return "Neniuj sugestoj trovitaj en ĉi tiu sekcio.";
	}
	...
	public String historialMCLogs() {
		return "Historio de MCLogs";
	}

	public String endpoint() {
		return "Finpunkto (Endpoint)";
	}
	...
	public String eliminarRegistroMCLogs() {
		return "Forigi registron";
	}

	public String faltanDatosParaEliminarMCLogs() {
		return "Mankas la ŝlimo (slug) aŭ la foriga ĵetono.";
	}

	public String confirmarEliminarMCLogs() {
		return "Ĉu vi certe volas forigi ĉi tiun registron de MCLogs?";
	}

	public String registroEliminadoMCLogs() {
		return "Registro sukcese forigita.";
	}
	...
	public String colorCampoTexto() {
		return "Koloro de teksta kampo";
	}

	// Esperanto (Esperanto)
	public String historialCDPaste() {
		return "Historio de CDPaste";
	}

	public String enlaceRaw() {
		return "Ligilo kruda (raw)";
	}
	...
	public String eliminarRegistroCDPaste() {
		return "Forigi registron de CDPaste";
	}

	public String faltanDatosParaEliminarCDPaste() {
		return "Mankas la identigilo (slug) de la registro CDPaste.";
	}

	public String confirmarEliminarCDPaste() {
		return "Ĉu vi certe volas forigi ĉi tiun registron de CDPaste?";
	}

	public String registroEliminadoCDPaste() {
		return "Registro de CDPaste sukcese forigita.";
	}
	...
	public String launcherServidorMinecraft() {
		return "Minecraft-servilo";
	}

	public String descargandoYPreparandoEnlaces() {
		return "Elŝutante kaj preparante ligilojn...";
	}

	public String seleccioneArchivoLog() {
		return "Elektu protokoldosieron";
	}

	public String archivoNoValido() {
		return "La dosiero ne estas valida.";
	}

	public String archivoSeleccionado() {
		return "Elektita dosiero:";
	}

	public String presioneGuardarParaAgregarAnalisis() {
		return "Premu Konservi kaj fermi por aldoni ĝin al la analizo.";
	}

	public String errorAlCargarArchivoArrastrado() {
		return "Eraro dum ŝargo de trenita dosiero";
	}

	public String errorAlAbrirArchivo() {
		return "Eraro dum malfermo de dosiero";
	}
	...
	public String migradorCAModoPrincipalAviso() {
		return "Elektu kiel migri la ĉefan GUI. \"centro_soporte\" estas la plej simila al la defaŭlta GUI de Crash Assistant, sed ne estas rekomendata, precipe por DIY-ludantoj, ĉar ĝi havas \"popup hell\" kaj malbonan dezajnon; ĝi ekzistas nur por helpi migri legacy-mediojn de Crash Assistant. \"primitiva\" estas tre simpla GUI uzata nur por kunhavigo; ĝi estas sugestita nur por modpakoj, ne por DIY-uzantoj, kaj eĉ se vi malaktivigas ĉiujn nenecesajn kontrolojn, ĝi ankaŭ suferas de \"popup hell\". \"original\" konservas vian nunan ĉefan GUI kaj estas ĝenerale la rekomendita opcio por la plej multaj uzantoj.";
	}

	@Override
	public String migradorCASitioLoggingAviso() {
		return "Elektu ĉu vi volas migri la logging-ejon de Crash Assistant aŭ konservi la nunan de CrashDetector. Crash Assistant ofte uzas gnomebot.dev, kiu ne estas rekomendata kompare al SecureLogger, PastesDev aŭ CDPaste. Por la plej multaj uzantoj, oni rekomendas konservi la nunan ejon.";
	}
	...
	public String ideScriptAbrirArchivo() {
		return "Malfermi dosieron";
	}

	@Override
	public String ideScriptGuardarComo() {
		return "Konservi kiel";
	}
	...
	public String ideScriptProyectoDeshabilitadoAviso() {
		return "Ĉi tiu tipo de projekto jam ekzistas en la GUI, sed estas malaktivigita ĝis oni aldonas ĝian lingvoservilon aŭ analizilon.";
	}

	@Override
	public String ideScriptDeshabilitadoCorto() {
		return "(malaktivigita)";
	}
	...
	public String ideScriptConfirmarDescargaDeps(int cantidad, String lista) {
		return "Elŝutiĝos " + cantidad + " dependecoj por la skripta IDE:\n\n" + lista
				+ "\nPoste eble necesas restartigi por ke ili eniru la classpath.";
	}

	@Override
	public String ideScriptDepsDescargadas(String mensaje) {
		return "Rezulto de elŝuto:\n\n" + mensaje
				+ "\n\nRestartigu la programon se la klasoj ankoraŭ ne aperas en la classpath.";
	}

	@Override
	public String ideScriptErrorAbrirArchivo() {
		return "Eraro malfermante dosieron";
	}

	@Override
	public String ideScriptErrorGuardarArchivo() {
		return "Eraro konservante dosieron";
	}

	@Override
	public String ideScriptColorEditor() {
		return "Koloro de redaktilo";
	}

	@Override
	public String ideScriptColorKeyword() {
		return "Koloro de ŝlosilvortoj";
	}

	@Override
	public String ideScriptColorComentario() {
		return "Koloro de komentoj";
	}

	@Override
	public String ideScriptColorCadena() {
		return "Koloro de ĉenoj";
	}
	...
	public String mcpTituloPrincipal() {
		return "MCP-servilo por loka IA";
	}
	...
	public String mcpDescargarDependencias() {
		return "Elŝuti dependecojn MCP/CFR";
	}

	public String mcpIniciarServidor() {
		return "Startigi MCP-servilon";
	}

	public String mcpEstadoDependenciasNoCargadas() {
		return "Dependecoj MCP/CFR ne ŝargitaj. Elŝutu ilin kaj restartigu se la butono restas malaktivigita.";
	}

	public String mcpEstadoDependenciasCargadas() {
		return "Dependecoj MCP/CFR detektita. La MCP-servilo povas esti startigita.";
	}

	public String mcpDependenciasDescargadasReiniciar() {
		return "Dependecoj elŝutitaj. Se ili ankoraŭ ne aperas ŝargitaj, restartigu CrashDetector.";
	}

	public String mcpErrorDescargandoDependencias(String error) {
		return "Ne eblis elŝuti dependecojn MCP/CFR: " + error;
	}

	public String mcpServidorIniciado(int puerto) {
		return "MCP-servilo startigita ĉe 127.0.0.1:" + puerto + "/mcp";
	}

	public String mcpErrorIniciandoServidor(String error) {
		return "Ne eblis startigi la MCP-servilon: " + error;
	}

	public String mcpImagenNoDisponible() {
		return "Bildo MCP ne disponebla";
	}
	...
	public String mcpDescripcionHtml() {
		return "<b>Ĉi tiu panelo startigas lokan MCP-servilon por asistantoj kiel Claude Desktop, Qwen Desktop Linux, Red Hat command-line-assistant aŭ Goose.</b>"
				+ "<br><br>"
				+ "Unue elŝutu la dependecojn MCP/CFR. Poste restartigu se la klasoj ne aperas en la classpath."
				+ "<br><br>" + "<b>Claude Desktop / Qwen Desktop Linux, ekzemplo:</b>" + "<pre>{\n"
				+ "  \"mcpServers\": {\n" + "    \"crashdetector\": {\n"
				+ "      \"url\": \"http://127.0.0.1:8765/mcp\"\n" + "    }\n" + "  }\n" + "}</pre>"
				+ "<b>Goose / command-line-assistant:</b>" + "<pre>http://127.0.0.1:8765/mcp</pre>"
				+ "Nuntempe ĉi tiu MCP-servilo estas baza. Poste oni povas aldoni realajn ilojn por legi protokolojn, konsulti CFR, kontroli modojn, serĉi klasojn kaj klarigi kraŝojn.";
	}
	...
	public String mensajeErrorJvmDllCurseForgeG1(boolean conOverwolf) {
		...
		if (conOverwolf) {
			textoOverwolf = "<p>La protokolo ankaŭ montras indikojn de <b>Overwolf</b> aŭ rilataj DLL-oj, kiel "
					+ "<b>OWClient.dll</b> aŭ <b>OWUtils.dll</b>. Ĉi tio ne pruvas sole ke Overwolf estas la kaŭzo, "
					+ "sed indikas ke la proceso de Minecraft estis funkcianta ene de pli modifita medio "
					+ "ol normala vanila lanĉo.</p>";
		}

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Java fermiĝis pro neta eraro en jvm.dll dum la rubkolektanto G1 en CurseForge.</b>"
				+ "<p>La protokolo enhavas <b>EXCEPTION_ACCESS_VIOLATION</b> ene de <b>jvm.dll</b>, "
				+ "kaj la aktiva fadeno estas <b>GCTaskThread</b>. Ĉi tio signifas ke Java malsukcesis dum la rubkolektanto "
				+ "<b>G1</b> laboris.</p>"
				+ "<p>Ankaŭ ekzistas indikoj ke la ludo estis lanĉita el medio administrata de "
				+ "<b>CurseForge</b>, ekzemple vojoj de CurseForge, <b>DCFInstanceId</b> aŭ marko de lanĉilo de CurseForge.</p>"
				+ textoOverwolf
				+ "<p>Ne eblas pruvi sole el la protokolo ke CurseForge aŭ Overwolf estas la preciza kaŭzo. "
				+ "Tamen, ĉi tiu padrono ofte videblas en lanĉoj de CurseForge kaj povas esti rilata "
				+ "al la kombinaĵo de <b>G1 GC</b>, neta memoro, bibliotekoj de Minecraft, grafikaj peliloj, "
				+ "netaj dosierujoj administritaj de CurseForge, supermetadoj aŭ eksteraj komponantoj de la lanĉilo.</p>"
				+ "<p><b>Komuna solvo:</b></p>" + "<ul>"
				+ "<li>Ŝanĝu la rubkolektanton aldonante ĉi tiun JVM-argumenton: <b>-XX:+UseShenandoahGC</b></li>"
				+ "<li>En CurseForge, ĉi tio normale aldoniĝas en la kromaj argumentoj de Java de la profilo aŭ de la lanĉilo.</li>"
				+ "<li>Viŝu la kaŝmemoron de natives/bin de la profilo de CurseForge por devigi ke la netaj bibliotekoj estu eltiritaj denove.</li>"
				+ "<li>Ĝisdatigu Java kaj la grafikajn pelilojn.</li>"
				+ "<li>Se vi uzas supermetadojn, registrilojn, agresan antivirusilon aŭ aliajn ilojn kiuj injektas sin en ludojn, provu fermi ilin provizore.</li>"
				+ "</ul>" + "<p>Rekomendita anglalingva tutorialo por ŝanĝi la argumentojn en CurseForge: "
				+ "<a href='https://youtu.be/UKFWBOZxB2o'>https://youtu.be/UKFWBOZxB2o</a></p>"
				+ "<p><b>Noto por Minecraft 1.16.5 aŭ pli malnova:</b> tiuj versioj normale uzas Java 8. "
				+ "Se vi estas en JDK 8 kaj volas uzi Shenandoah, eble vi bezonos uzi la "
				+ "<b>Red Hat Build of OpenJDK 8</b> kaj direkti CurseForge al tiu instalado de Java.</p>"
				+ "<p>Gvidilo de Red Hat por instali OpenJDK 8 en Windows: "
	...
	public String nombreErrorJvmDllCurseForgeG1() {
		return "Eraro de jvm.dll de CurseForge kun G1 GC";
	}

	@Override
	public String mensajeErrorJvmDllC2Sodium() {
		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Java fermiĝis pro neta eraro en jvm.dll dum kompilado de kodo de Sodium aŭ simila modo.</b>"
				+ "<p>La protokolo enhavas <b>EXCEPTION_ACCESS_VIOLATION</b> ene de <b>jvm.dll</b>, "
				+ "kaj la aktiva fadeno estas <b>C2 CompilerThread</b>. Ĉi tio signifas ke la eraro okazis ene de la "
				+ "JIT-kompililo de Java, ne kiel normala escepto de Minecraft.</p>"
				+ "<p>En ĉi tiu okazo, la kompila tasko mencias kodon rilatan al <b>Sodium</b>, "
				+ "<b>Embeddium</b>, <b>Rubidium</b> aŭ simila klaso kiel "
				+ "<b>ClonedChunkSectionCache::acquire</b>.</p>" + "<p><b>Rekomendita solvo:</b></p>" + "<ul>"
				+ "<li>Ĝisdatigu <b>Sodium</b>, <b>Embeddium</b>, <b>Rubidium</b>, <b>Oculus</b> aŭ ajnan rilatan renderigan modon.</li>"
				+ "<li>Ĝisdatigu Java 17. Se vi jam uzas modernan version, provu alian distribuon kiel Temurin, Zulu aŭ Microsoft OpenJDK.</li>"
				+ "<li>Ĝisdatigu la pelilojn de la grafika karto.</li>"
				+ "<li>Provu provizore sen Sodium, Embeddium, Rubidium aŭ Oculus por konfirmi ĉu la eraro malaperas.</li>"
				+ "<li>Kiel altnivela provo, uzu <b>-XX:TieredStopAtLevel=1</b> por redukti la uzon de la kompililo C2. "
				+ "Ĉi tio povas malpliigi la rendimenton, sed helpas konfirmi ĉu la eraro venas de la JIT-kompililo.</li>"
				+ "</ul>"
				+ "<p>Ĉi tiu problemo ne estas la sama kiel normala kraŝo de modo. Ĝi ankaŭ malsamas de eraroj kie "
				+ "<b>GCTaskThread</b> aperas kiel aktiva fadeno. Ĉi tie la padrono pli celas al la kompililo C2 de Java "
				+ "kompilanta optimigitan renderigan kodon.</p>";
	}

	@Override
	public String nombreErrorJvmDllC2Sodium() {
		return "Neta eraro de Java kun Sodium / Embeddium";
	}
	...
	public String mensajeErrorArchivoUsadoPorOtroProceso(String archivo) {
		...
		if (archivo != null && archivo.length() > 0) {
			textoArchivo = "<p><b>Blokita dosiero:</b> " + archivo + "</p>";
		}

		return "<b style='color:#" + Config.obtenerInstancia().obtenerColorError() + "'>"
				+ "Dosiero estas uzata de alia procezo.</b>"
				+ "<p>La protokolo enhavas eraron <b>java.nio.file.FileSystemException</b> indikante, ke Windows ne povas "
				+ "aliri dosieron, ĉar alia programo ĝin uzas.</p>" + textoArchivo
				+ "<p>Tio kutime okazas, kiam Minecraft, CurseForge, tekstredaktilo, virusprotektilo, OneDrive, "
				+ "sinkroniga programo aŭ eĉ alia instanco de la ludo malfermis la dosieron.</p>"
				+ "<p><b>Rekomendita solvo:</b></p>" + "<ul>" + "<li>Fermu Minecraft plene.</li>"
				+ "<li>Fermu CurseForge kaj remalufermu ĝin.</li>"
				+ "<li>Kontrolu la Taskadministrilon kaj finigu duobligitajn procezojn de <b>javaw.exe</b>, <b>java.exe</b>, Minecraft aŭ CurseForge.</li>"
				+ "<li>Fermu tekstredaktilojn, kiuj povas havi la agordan dosieron malfermita.</li>"
				+ "<li>Se la dosiero estas ene de OneDrive, Dropbox aŭ simila programo, provizore paŭzigu la sinkronigon.</li>"
				+ "<li>Se la problemo daŭras, restartigu la komputilon por liberigi la dosierblokon.</li>" + "</ul>"
				+ "<li>Post liberigi la dosieron, relanĉu la modpakon. Se la blokita dosiero estas agordo, "
				+ "povas helpi ankaŭ fari sekurkopion kaj regeneri tiun dosieron.</p>";
	}
	...
	public String nombreVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("eo", "check_meltdown");
	}

	@Override
	public String nombreVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("eo", "check_spectre");
	}

	@Override
	public String desactivarVerificacionMeltdown() {
		return TraduccionesSeguridadCPU.texto("eo", "disable_meltdown");
	}

	@Override
	public String desactivarVerificacionSpectre() {
		return TraduccionesSeguridadCPU.texto("eo", "disable_spectre");
	}

	@Override
	public String abrirDocumentacionOficialSeguridadCPU() {
		return TraduccionesSeguridadCPU.texto("eo", "open_docs");
	}

	@Override
	public String errorComprobacionSeguridadCPU(String verificacion, String detalle) {
		return TraduccionesSeguridadCPU.texto("eo", "check_error", verificacion, detalle);
	}
	...
	public String tituloProteccionProcesador(String vulnerabilidad) {
		return TraduccionesSeguridadCPU.texto("eo", "title_protection", vulnerabilidad);
	}

	@Override
	public String etiquetaSeguridadCpuCPU() {
		return TraduccionesSeguridadCPU.texto("eo", "label_cpu");
	}

	@Override
	public String etiquetaSeguridadCpuFabricante() {
		return TraduccionesSeguridadCPU.texto("eo", "label_vendor");
	}

	@Override
	public String etiquetaSeguridadCpuArquitectura() {
		return TraduccionesSeguridadCPU.texto("eo", "label_arch");
	}

	@Override
	public String etiquetaSeguridadCpuSistemaOperativo() {
		return TraduccionesSeguridadCPU.texto("eo", "label_os");
	}

	@Override
	public String etiquetaSeguridadCpuAfectado() {
		return TraduccionesSeguridadCPU.texto("eo", "label_affected");
	}

	@Override
	public String etiquetaSeguridadCpuEstadoGeneral() {
		return TraduccionesSeguridadCPU.texto("eo", "label_overall");
	}

	@Override
	public String etiquetaSeguridadCpuMitigacionSO() {
		return TraduccionesSeguridadCPU.texto("eo", "label_os_mitigation");
	}

	@Override
	public String etiquetaSeguridadCpuMicrocodigoFirmware() {
		return TraduccionesSeguridadCPU.texto("eo", "label_microcode");
	}

	@Override
	public String etiquetaSeguridadCpuRevisionDetectada() {
		return TraduccionesSeguridadCPU.texto("eo", "label_revision");
	}

	@Override
	public String etiquetaSeguridadCpuNota() {
		return TraduccionesSeguridadCPU.texto("eo", "label_note");
	}

	@Override
	public String etiquetaSeguridadCpuEvidencia() {
		return TraduccionesSeguridadCPU.texto("eo", "label_evidence");
	}

	@Override
	public String etiquetaSeguridadCpuAccionRecomendada() {
		return TraduccionesSeguridadCPU.texto("eo", "label_action");
	}

	@Override
	public String estadoAfectacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoAfectacion("eo", estado);
	}

	@Override
	public String estadoMitigacionSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoMitigacion("eo", estado);
	}

	@Override
	public String estadoComponenteSeguridadCPU(String estado) {
		return TraduccionesSeguridadCPU.estadoComponente("eo", estado);
	}

	@Override
	public String notaSeguridadCpuRegistroRemoto() {
		return TraduccionesSeguridadCPU.texto("eo", "remote_note");
	}

	@Override
	public String mensajeSeguridadCPU(String clave, String... argumentos) {
		return TraduccionesSeguridadCPU.mensaje("eo", clave, argumentos);
	}
