 ...
 * AuthenticationException en fetchProperties(), sin importar el código de error.
 */
public class ParcheSoyPirata implements ParcheClassNode {
    ...
    /**
     * Método estático que crea el archivo "SOY_PIRATA" en el directorio actual.
     * Se invoca desde el bytecode inyectado.
     */
