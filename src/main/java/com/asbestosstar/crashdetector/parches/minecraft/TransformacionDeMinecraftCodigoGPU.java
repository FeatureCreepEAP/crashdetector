...
/**
 * Parche que inyecta una llamada segura al verificador de GPU
 * (HacerVerificacionGPU) al final de los constructores de Minecraft.
 */
			...
			for (MethodNode method : node.methods) {
				...
				if (method.name.equals("<init>")) {
					...
					toInject.add(new MethodInsnNode(Opcodes.INVOKESTATIC,
							"com/asbestosstar/crashdetector/hw/gpu/HacerVerificacionGPU", // Ruta interna de la clase
																							// (con /)
					...
					// Usamos toArray() para evitar ConcurrentModificationException si modificamos
					// la lista mientras iteramos.
