...
public class HacerVerificacionGPU {
    ...
    public static final String NO_FATAL =
            "Si puedes leer esto, significa que el verificador de la GPU probablemente no provocó que tu juego fallara; no funcionó según lo previsto, pero no hizo que el juego se cerrara inesperadamente.";
