...
/**
 * ComboBox que muestra una bandera o icono junto al nombre del idioma.
 * Las rutas de los iconos se proporcionan completas en el mapa (por ejemplo "imagenes/bandera_mexico.png").
 */
public class ComboIdiomasConIcono extends JComboBox<String> {
    ...
    private Icon cargarIconoLocal(String rutaRelativa, int w, int h) {
        try {
            ...
            if (base.getIconWidth() <= 0 || base.getIconHeight() <= 0) return base;
    ...
    private class Renderizador extends BasicComboBoxRenderer {
        ...
        public Component getListCellRendererComponent(JList lista, Object valor, int indice,
            ...
            int altoFila = Math.max(
                lista.getFixedCellHeight() > 0 ? lista.getFixedCellHeight() : 0,
