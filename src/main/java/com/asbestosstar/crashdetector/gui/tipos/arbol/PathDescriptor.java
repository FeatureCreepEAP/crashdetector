...
/**
 * Descriptor ligero de una ruta en el árbol de mods.
 * No contiene Swing, solo datos estructurales.
 */
public class PathDescriptor {
    ...
    public PathDescriptor(String modUbicacion, String paquete, String clase, String metodo, String descriptor, String tipo) {
    ...
    // Getters
    public String obtenerModUbicacion() { return modUbicacion; }
    public String obtenerPaquete() { return paquete; }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PathDescriptor)) return false;
        PathDescriptor that = (PathDescriptor) o;
        return java.util.Objects.equals(modUbicacion, that.modUbicacion) &&
               java.util.Objects.equals(paquete, that.paquete) &&
               java.util.Objects.equals(clase, that.clase) &&
