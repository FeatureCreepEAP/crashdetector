...
/**
 * Localizador de CFR (Class File Reader).
 * Busca el archivo cfr.jar en ubicaciones comunes en sistemas UNIX/Linux,
 * incluyendo una carpeta personalizada dentro del directorio de usuario.
 */
public class BuscarParaCFR {
     ...
     */
    private static final List<String> UBICACIONES_COMUNES = Arrays.asList(
        "/usr/share/java/CFR/cfr.jar",
        "/usr/local/share/java/CFR/cfr.jar",
        "/opt/cfr/cfr.jar",
     ...
     *
     * @return true si se encuentra al menos una copia válida de cfr.jar; false en caso contrario.
     */
