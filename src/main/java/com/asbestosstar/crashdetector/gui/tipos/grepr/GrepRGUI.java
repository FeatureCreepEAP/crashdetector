...
public abstract class GrepRGUI extends JFrame implements CrashDetectorGUI, BotonDeBarraLateralDerecha {
    ...
    public void estilizarBoton(JButton b) {
        ...
        b.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(colorBordeDestacado.obtener(), 1),
    ...
    /**
     * Método público que las subclases deben sobrescribir.
     * Debe inicializar los colores y luego llamar a aplicarEstilos().
     */
    @Override
    ...
    /**
     * Aplica todos los estilos visuales. Debe llamarse SOLO después de que los colores hayan sido inicializados.
     */
