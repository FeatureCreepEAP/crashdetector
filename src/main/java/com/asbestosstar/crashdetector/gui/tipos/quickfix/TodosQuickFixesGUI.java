 ...
 *  - Gestiona el contenedor con BoxLayout vertical y margen.
 *  - Mantiene un «pie» con UNA sola imagen decorativa al final.
 *  - Proporciona métodos para agregar QuickFix antes del pie y limpiar todo.
 *  - Expone hooks de apariencia: ruta/tamaño de imagen, color de separador, opacidad, etc.
 *
...
public abstract class TodosQuickFixesGUI extends JScrollPane implements CrashDetectorGUI {
    ...
    protected String textoFallbackImagen() { return "(No se pudo cargar la imagen)"; }

    /** Color del separador entre elementos. */
    protected Color colorSeparador() { return Color.LIGHT_GRAY; }
