...
public class CorpoSAO extends CorpoBase {
    ...
    @Override
    public void init() {
        // Inicializar configuraciones de color con valores por defecto que coincidan con la imagen
        colorFondoVentana = ConfigColor.de("tema.corpo.sao.color.fondo.ventana", new Color(30, 30, 30));
        colorTexto = ConfigColor.de("tema.corpo.sao.color.texto", new Color(220, 220, 220));
        colorBoton = ConfigColor.de("tema.corpo.sao.color.boton", new Color(50, 60, 150));
        colorCajaTexto = ConfigColor.de("tema.corpo.sao.color.caja_texto", new Color(40, 40, 40));
        colorEnlace = ConfigColor.de("tema.corpo.sao.color.enlace", new Color(100, 150, 255));
        colorBordePanel = ConfigColor.de("tema.corpo.sao.color.borde_panel", new Color(60, 60, 60));
        ...
        panelConfiguracion.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(colorBordePanel.obtener(), 1), 
        ...
        panelBotones.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(colorBordePanel.obtener(), 1),
            MonitorDePID.idioma.funcionalidades()));
    ...
    private void agregarListeners() {
        ...
        botonDerechosMaranda.addActionListener(proximamenteListener);
    }
