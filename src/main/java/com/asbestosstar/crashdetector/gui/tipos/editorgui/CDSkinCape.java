...
/**
 * Implementación concreta del editor de GUIs con apariencia CDSkinCape.
 * Define completamente el layout, la apariencia y la gestión de `ConfigColor`.
 */
public class CDSkinCape extends EditorGUI {
   ...
   public ConfigColor  colorCajaTexto = ConfigColor.de("tema.cdskincape.editor.color.caja_texto", new Color(255, 255, 255));
   public ConfigColor  colorBorde = ConfigColor.de("tema.cdskincape.editor.color.borde", new Color(200, 200, 200));
    ...
    private void inicializarInterfaz() {
        ...
        JSplitPane splitPanePrincipal = new JSplitPane(JSplitPane.VERTICAL_SPLIT, scrollPanelEdicion, panelConfiguracionGUI);
        ...
        // Añadir el splitPane al panel central en lugar del scrollPanelEdicion directamente
    ...
    private Component crearComponenteEditable(ElementoConfig<?> elemento) {
        if (elemento instanceof com.asbestosstar.crashdetector.config.ConfigBoolean) {
            ...
            // Para colores, usar un panel con un cuadrado de previsualización y un campo de texto
            JPanel panelColor = new JPanel(new BorderLayout(5, 0));
            JTextField textField = new JTextField("#" + Integer.toHexString(((com.asbestosstar.crashdetector.config.ConfigColor) elemento).obtener().getRGB()).substring(2));
            textField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
                ...
                private void actualizarColor(JTextField field, com.asbestosstar.crashdetector.config.ConfigColor configColor) {
            ...
            cuadradoColor.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseClicked(java.awt.event.MouseEvent e) {
                    Color nuevoColor = javax.swing.JColorChooser.showDialog(CDSkinCape.this, "Seleccionar Color", ((com.asbestosstar.crashdetector.config.ConfigColor) elemento).obtener());
                    if (nuevoColor != null) {
            ...
            textField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
                ...
                private void actualizarTexto(JTextField field, com.asbestosstar.crashdetector.config.ConfigDouble configDouble) {
                    String texto = field.getText();
                    if (texto == null || texto.isEmpty())
                        return;
                    try {
            ...
            textField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
                ...
                private void actualizarTexto(JTextField field, com.asbestosstar.crashdetector.config.ConfigString configString) {
                    String texto = field.getText();
    ...
    public void editarElemento(ElementoConfig<?> elemento) {
        ...
        try {
            ...
            if (elemento instanceof ConfigBoolean) {
                ...
                throw new IllegalArgumentException("Tipo de ElementoConfig no soportado: " + elemento.getClass().getName());
            }
            
            // Actualizar la interfaz para reflejar los cambios
            actualizarPanelConfiguracionGUI();
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Error al parsear el nuevo valor: debe ser un número válido.", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error al procesar el nuevo valor: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
