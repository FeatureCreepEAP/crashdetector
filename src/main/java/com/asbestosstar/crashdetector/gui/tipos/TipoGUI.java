...
public abstract class TipoGUI<T extends CrashDetectorGUI> {
	...
	public static TipoGUI<MapaDeDependenciasGUI> DEPMAP = new TipoGUI<MapaDeDependenciasGUI>() {
		...
		@Override
		public String etiquetaDelBoton() {
			return MonitorDePID.idioma.depmapBotonLateral();
		}

		@Override
		public void registrarGUI(String id, Supplier<MapaDeDependenciasGUI> gui) {
			MapaDeDependenciasGUI.GUIS.put(id, gui);
		}
	...
	public static TipoGUI<GuardiaGUI> GUARD = new TipoGUI<GuardiaGUI>() {
		@Override
		public String id() {
			return "guard";
		}
		...
		@Override
		public String etiquetaDelBoton() {
			return MonitorDePID.idioma.guardBotonLateral();
		}

		@Override
		public void registrarGUI(String id, java.util.function.Supplier<GuardiaGUI> gui) {
			GuardiaGUI.GUIS.put(id, gui);
		}
