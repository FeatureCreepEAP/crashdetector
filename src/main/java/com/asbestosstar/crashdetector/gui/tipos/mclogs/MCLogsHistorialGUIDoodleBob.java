...
/**
 * GUI estilo DoodleBob para ver historial MCLogs y eliminar registros.
 */
public class MCLogsHistorialGUIDoodleBob extends MCLogsHistorialGUI {
	private static final long serialVersionUID = 1L;

	public static final String ID = "doodlebob_mclogs";
	public static final File imagen = Statics.carpeta.resolve("imagenes/doodlebob.png").toFile();
	...
	public MCLogsHistorialGUIDoodleBob() {
		colorFondo = ConfigColor.de("tema.doodlebob_mclogs.color.fondo", new Color(45, 174, 95));
		colorTexto = ConfigColor.de("tema.doodlebob_mclogs.color.texto", new Color(15, 15, 15));
		colorBoton = ConfigColor.de("tema.doodlebob_mclogs.color.boton", new Color(246, 203, 52));
		colorTabla = ConfigColor.de("tema.doodlebob_mclogs.color.tabla", new Color(255, 255, 245));
		colorBorde = ConfigColor.de("tema.doodlebob_mclogs.color.borde", new Color(20, 20, 20));
		colorCampo = ConfigColor.de("tema.doodlebob_mclogs.color.campo", new Color(255, 255, 255));
	}

	@Override
	public void init() {
		setTitle(MonitorDePID.idioma.historialMCLogs());
	...
	private JPanel crearPanelSuperior() {
		...
		agregarFila(panelCampos, gbc, y++, MonitorDePID.idioma.tokenEliminacion(), campoToken);
		agregarFila(panelCampos, gbc, y++, MonitorDePID.idioma.enlace(), campoUrl);

		botonEliminar = new JButton(MonitorDePID.idioma.eliminarRegistroMCLogs());
	...
	private void agregarListeners() {
		tabla.getSelectionModel().addListSelectionListener(e -> {
			...
			campoToken.setText(valor(fila, 3));
		});
