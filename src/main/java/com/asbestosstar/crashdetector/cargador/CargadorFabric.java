...
public class CargadorFabric implements Cargador{
	...
	/**
	 * Extrae todos los ids y provides desde un archivo fabric.mod.json
	...
	public static java.util.List<String> parsearIdModFabric(String texto) throws java.io.IOException {
	    ...
	    try {
	        ...
	        java.util.regex.Pattern pprov = java.util.regex.Pattern.compile("\"provides\"\\s*:\\s*\\[(.*?)\\]", java.util.regex.Pattern.DOTALL);
