...
/**
 * Analiza mods.toml de Forge
 * Si Electronwill esta disponible usa AnalizadorModsTomlForgeElectronwill
 * Si no esta disponible usa respaldo por regex
 */
public class AnalizadorModsTomlForge {
    ...
    /**
     * Devuelve modId principal y modIds en secciones de dependencias
    ...
    private static List<String> extraerModIdsPorRegex(String toml) {
        ...
        java.util.regex.Pattern pMods = java.util.regex.Pattern.compile(
                "\\[\\[mods\\]\\][^\\[]*?modId\\s*\\=\\s*\"([^\"]+)\"", java.util.regex.Pattern.DOTALL);
        ...
        java.util.regex.Pattern pDep = java.util.regex.Pattern.compile(
