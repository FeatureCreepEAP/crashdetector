...
public class DetectorTLLegacyFlatpak implements DetectorLanzer {
    ...
    public boolean desanimado() {
        return true;//La verison flatpak es diferente y tiene problemas, especialmente con la consola. Generalmente versiones de apps de flatpak son inferior a las versiones nativas
    }
