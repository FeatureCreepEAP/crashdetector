...
public class DetectorXMLC implements DetectorLanzer {
    @Override public String id() { return "xmlc"; }
    @Override public boolean animado() { return true; }//Mystic Pasta dice esta bien. Tiene mas poder de otras lanzeres electron, pero similar a otras lanzeres electron es lento
