...
public class DetectorFeather implements DetectorLanzer {
    @Override public String id() { return "feather"; }
    @Override public boolean animado() { return false; }
    @Override public boolean desanimado() { return true; }//PVP clientes y Feather tienen muchos problemas para mods normales
