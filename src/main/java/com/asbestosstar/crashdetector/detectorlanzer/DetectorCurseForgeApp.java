...
public class DetectorCurseForgeApp implements DetectorLanzer {
	...
	public boolean desanimado() {
		return true;
	}// Tiene muchas problemas instalando mods y con instalcaciones del juego
		// corruptos. Pero con la opcion sin Mojang Lanzer hay mas problemas Y no hay
		// una consola con SysOut o SysErr
		// https://curseforge-ideas.overwolf.com/ideas/CF-I-7632
