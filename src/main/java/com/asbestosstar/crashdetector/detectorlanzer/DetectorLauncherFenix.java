...
public class DetectorLauncherFenix implements DetectorLanzer {
    ...
    /**
     * Obtiene la ruta a la carpeta predeterminada de Minecraft según el sistema operativo.
     * 
     * @return ruta absoluta a la carpeta .minecraft, o null si no se puede determinar
     */
