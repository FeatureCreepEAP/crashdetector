...
public class DetectorTL implements DetectorLanzer {
    @Override public String id() { return "tlauncher"; }
    ...
    public boolean detectar(App app, String cmd) {
        ...
        return n.contains("/org/tlauncher/patchy/") ||
               n.contains("/org/tlauncher/authlib/");//No es perfecta , especialmente para versiones personalizado, pero esta bien para ahora
    }
}