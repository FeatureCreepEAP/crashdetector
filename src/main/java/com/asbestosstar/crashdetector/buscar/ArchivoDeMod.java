...
/**
 * Interfaz que representa un archivo de mod (JAR, ZIP, directorio) y sus contenidos.
 * Proporciona métodos para explorar y analizar mods sin depender directamente de ASM o Javassist.
 */
