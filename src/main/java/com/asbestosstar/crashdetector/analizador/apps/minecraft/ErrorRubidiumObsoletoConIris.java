...
/**
 * Detecta el error causado por usar Rubidium (fork obsoleto de Sodium) con Iris/Oculus
 * en versiones recientes de Minecraft donde OptionInstance es final.
 */
public class ErrorRubidiumObsoletoConIris implements Verificaciones {
    ...
    public void verificar(Consola consola, String linea, int numero_de_linea) {
        ...
        if (linea.contains("java.lang.IncompatibleClassChangeError")
            && linea.contains("ShadowDistanceOption")
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionRubidiumObsoletoConIris())
            .construir();
    }
