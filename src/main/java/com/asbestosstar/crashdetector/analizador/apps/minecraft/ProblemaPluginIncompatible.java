...
/**
 * Clase que detecta plugins de PocketMine-MP que no son compatibles con la versión actual del servidor.Gracias a Aternos por que esta es una implementacion de su codex https://github.com/aternosorg/codex-minecraft
 */
public class ProblemaPluginIncompatible implements Verificaciones {
    ...
    public void verificar(Consola consola) {
        ...
        Pattern[] patrones = {
            Pattern.compile("Could not load plugin '([^']+)'\\: Incompatible API version"),
