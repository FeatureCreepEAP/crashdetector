...
/**
 * Clase que detecta plugins con dependencias faltantes en PocketMine-MP.Gracias
 * a Aternos por que esta es una implementacion de su codex
	...
	public void verificar(Consola consola) {
		...
		if (!nombresPlugins.isEmpty()) {
			if (nombresPlugins.size() > 1) {
				...
				this.mensaje = MonitorDePID.idioma.mensajeDependenciaPluginFaltanteSingular(nombresPlugins.get(0),
						dependencias.get(0));
			}
			activado = true;
		}
