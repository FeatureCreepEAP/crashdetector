 ...
 * errores porque OptiFine intenta cargar clases del cliente en un entorno de servidor.
 */
public class ErrorOptiFineServidor implements Verificaciones {
    ...
    public void verificar(Consola consola, String linea, int numero_de_linea) {
        ...
        // Buscamos la línea que contiene el error de carga de clase para servidor dedicado de OptiFine
        if (linea.contains("Base resource not found")
                && encontradoOptiFine) {
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoErrorOptiFineServidor())
                .construir();
    }
