...
/**
 * Clase que detecta si el plugin AuthMe causó el cierre del servidor.Gracias a Aternos por que esta es una implementacion de su codex https://github.com/aternosorg/codex-minecraft
 */
public class ProblemaCierreAuthMe implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionCierreAuthMe())
            ...
            .agregarEtiqueta(MonitorDePID.idioma.solucionEliminarPluginAuthMe())
            .construir();
    }
