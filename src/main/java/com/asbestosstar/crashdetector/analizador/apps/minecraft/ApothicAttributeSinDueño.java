...
/**
 * Detecta errores de Apothic Attributes donde un AttributeMap es modificado sin dueño.
 *
 * Ejemplo 1: apoth_attrModifiedEvent
 * Ejemplo 2: An AttributeMap object was modified without a set owner!
 *
 * Causado generalmente por conflictos de mods al registrar atributos de entidades.
 * Especialmente común con el mod Chest Cavity.
 */
public class ApothicAttributeSinDueño implements Verificaciones {
    ...
    public void verificar(Consola consola) {
        ...
        if (log.contains("apoth_attrModifiedEvent") || log.contains("AttributeMap object was modified without a set owner")) {
            analizarLineas = true;
        }
    ...
    public void verificar(Consola consola, String linea, int numero_de_linea) {
        ...
        if (linea.contains("apoth_attrModifiedEvent") || linea.contains("AttributeMap object was modified without a set owner")) {
