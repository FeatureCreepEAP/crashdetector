...
/**
 * Clase que detecta mundos duplicados que no pueden cargarse.Gracias a Aternos por que esta es una implementacion de su codex https://github.com/aternosorg/codex-minecraft
 */
public class ProblemaMundoDuplicado implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionEliminarUID(nombreMundo))
            .agregarEtiqueta(MonitorDePID.idioma.solucionEliminarMundo(nombreMundo))
            .construir();
    }
}