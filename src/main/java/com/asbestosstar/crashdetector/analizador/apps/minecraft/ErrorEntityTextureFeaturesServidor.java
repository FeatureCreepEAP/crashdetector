...
public class ErrorEntityTextureFeaturesServidor implements Verificaciones {
    ...
    public void verificar(Consola consola) {
        ...
        if (consola.contenido_verificar != null) {
            encontradoETF = consola.contenido_verificar.toLowerCase().contains("entity texture features") || 
                           consola.contenido_verificar.toLowerCase().contains("etf") ||
                           consola.contenido_verificar.contains("ResourceLocation.handler$zca000$etf$illegalPathOverride");
        }
    }
