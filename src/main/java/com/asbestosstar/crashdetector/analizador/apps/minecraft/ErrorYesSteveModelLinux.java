...
/**
 * Detecta el error de YesSteveModel en Linux donde solo se soporta el servidor YSM,
 * lo cual ha sido corregido en versiones más recientes desde el 23 de noviembre.
 */
public class ErrorYesSteveModelLinux implements Verificaciones {
     ...
     * <p>
     * Se busca el patrón característico del error donde YesSteveModel indica
     * que solo se soporta el servidor YSM en Linux.
     * </p>
     */
    @Override
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoErrorYesSteveModelLinux())
                .construir();
    }
