...
/**
 * Detecta errores NullPointerException relacionados con BlockItem nulo en addons de Create,
 * típicamente causados por conflictos con Amendments, Moonshine o mala inicialización de bloques.
 */
public class ErrorBlockItemNuloCreate implements Verificaciones {

    private boolean activado = false;
    private String mensaje = "";
    private static final Pattern PATRON_BLOCKITEM_NULO = Pattern.compile(
        "java\\.lang\\.NullPointerException: BlockItem ([^ ]+) has a NULL block!"
    );
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionErrorBlockItemNuloCreate())
            .construir();
    }
