 ...
 * Sodium o sus forks que no cumplen con el requisito mínimo de versión 0.6.0-beta.2.
 */
public class ConflictoFlywheelRubidium implements Verificaciones {
     ...
     * superior, pero se encuentra una versión anterior como Sodium 0.5.3 o
     * forks basados en versiones antiguas.
     * </p>
     */
    @Override
    public void verificar(Consola consola, String linea, int numero_de_linea) {
        ...
        // Primera línea: "Failure message: Mod flywheel only supports sodium 0.6.0-beta.2 or above"
        ...
        if (encontradaLinea1 && linea.contains("Currently, sodium is")) {
            ...
            if (linea.contains("0.5.") || linea.contains("0.4.") || linea.contains("0.3.") || 
                linea.contains("0.2.") || linea.contains("0.1.") || linea.contains("0.0.")) {
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoConflictoFlywheelSodium())
                .construir();
    }
    ...
    public boolean ocupaTrazo(TraceInfo trazo) {
        ...
        return t.contains("Failure message: Mod flywheel only supports sodium")
                && t.contains("0.6.0-beta.2 or above")
