...
/**
 * Clase que detecta mods duplicados en Fabric. Gracias a Aternos por que esta es una implementacion de su codex https://github.com/aternosorg/codex-minecraft
 */
public class ProblemaModDuplicadoFabric implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionEliminarModDuplicado(rutaMod))
            .construir();
    }
}