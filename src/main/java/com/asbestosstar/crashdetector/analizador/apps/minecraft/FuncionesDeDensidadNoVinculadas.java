...
public class FuncionesDeDensidadNoVinculadas implements Verificaciones {
    ...
    public void verificar(Consola consola) {
        ...
        if (clavesFaltantes.isEmpty()) return;

        // Intentar localizar posibles proveedores por namespace (sin meterlos en idioma)
        modsUbicacion.clear();
        Buscardor.cargar();
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoFuncionesDeDensidadNoVinculadas())
                .construir();
    }
