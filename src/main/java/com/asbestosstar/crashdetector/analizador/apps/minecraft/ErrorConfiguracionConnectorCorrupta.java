...
/**
 * Detecta cuando el archivo de configuración de Sinytra Connector está corrupto,
 * típicamente lleno de caracteres nulos (\u0000), lo que impide que el mod inicie.
 */
public class ErrorConfiguracionConnectorCorrupta implements Verificaciones {
    ...
    public boolean ocupaTrazo(TraceInfo trazo) {
        ...
        return t.contains("org.sinytra.connector.locator.ConnectorConfig")
            && t.contains("Not a JSON object")
            && t.contains("\\u0000");
    }
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionConfiguracionConnectorCorrupta())
            .construir();
    }
