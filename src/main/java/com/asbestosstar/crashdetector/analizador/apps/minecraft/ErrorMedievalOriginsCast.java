...
/**
 * Detecta errores de compatibilidad con Medieval Origins donde ItemStack no puede
 * ser casteado a EntityLinkedItemStack, común en versiones superiores a 6.6.0.
 */
public class ErrorMedievalOriginsCast implements Verificaciones {
    ...
    /**
     * Método de compatibilidad — busca si Medieval Origins está presente en el contenido completo del registro.
     */
    @Override
    ...
    public void verificar(Consola consola, String linea, int numero_de_linea) {
        ...
        // Buscamos la línea que contiene el error de casteo de ItemStack a EntityLinkedItemStack
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoErrorMedievalOriginsCast())
                .construir();
    }
