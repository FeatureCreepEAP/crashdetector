...
/**
 * Detecta errores NullPointerException que ocurren dentro del código de Neruina.
 *
 * Ejemplo:
 * at com.bawnorton.neruina.util.TickingEntry.writeStackTraceNbt
 * java.lang.NullPointerException: Cannot invoke "String.isEmpty()" because "p_129298_" is null
 *
 * Esto indica que Neruina está fallando en su intento de manejar un error de otra entidad,
 * ocultando la verdadera causa del problema original.
 */
