...
/**
 * Clase que detecta errores fatales causados por Mixin en mods de Fabric. Gracias a Aternos por que esta es una implementacion de su codex https://github.com/aternosorg/codex-minecraft
 */
public class ProblemaSpongeMixinFabric implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionEliminarMod(nombreMod))
            .construir();
    }
}