...
/**
 * Detecta el error crítico donde un mod intenta cargar una clase del lado del cliente
 * (AnimationMetadataSection) en un servidor dedicado, lo que provoca una falla al iniciar.
 * 
 * Este error suele manifestarse con ModernFix presente, ya que ModernFix aplica optimizaciones
 * que exponen incompatibilidades de mods que no separan correctamente lógica de cliente/servidor.
 */
public class ErrorMetadataAnimacionEnServidor implements Verificaciones {
    ...
    public boolean ocupaTrazo(TraceInfo trazo) {
        ...
        return t.contains("ClassMetadataNotFoundException")
            && t.contains("AnimationMetadataSection");
    }
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionErrorMetadataAnimacionEnServidor())
            .construir();
    }
