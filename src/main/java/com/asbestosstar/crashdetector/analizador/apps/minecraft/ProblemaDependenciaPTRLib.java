...
/**
 * Clase que detecta que el mod PTRLib no está instalado.Gracias a Aternos por que esta es una implementacion de su codex https://github.com/aternosorg/codex-minecraft
 */
public class ProblemaDependenciaPTRLib implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionInstalarMod(nombreMod))
            .construir();
    }
}