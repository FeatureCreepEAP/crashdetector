...
public class ErrorConfiguracionMCForge implements Verificaciones {
	...
	// Patrón más flexible: acepta tanto ConfigFileTypeHandler$ConfigLoadingException
	// como ConfigSpecWrapper$ConfigLoadingException (Moonlight), captura archivo y modid.
	...
	public void verificar(Consola consola) {
		...
		// Detectar condición principal: mensaje de ParsingException o cualquier excepción de carga de config.
		...
		// Si se activó, intentar complementar con el detalle de archivo/modid en cualquier parte del log.
		if (activado) {
			for (int i = 0; i < lineas.length; i++) {
				String l = lineas[i];
