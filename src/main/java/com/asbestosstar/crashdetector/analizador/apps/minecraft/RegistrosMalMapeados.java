...
public class RegistrosMalMapeados implements Verificaciones {
    ...
    public void verificar(Consola consola) {
        ...
        // Patrón 2: "Unidentified mapping from registry minecraft:itemkubejs:100k_card: 35229"
        Pattern patternMapeoNoIdentificado = Pattern.compile("Unidentified mapping from registry [^:]+:([\\w\\d_:-]+:[\\w\\d_:-]+)");
        
        // Patrón 3: Bloques densos como "kubejs:ender_pearl_block_1x: 24927kubejs:ender_pearl_block_2x: 24928"
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionRegistrosMalMapeados())
            .construir();
    }

    @Override
    public boolean anularNormal() {
        return true;//Normalment el juego salir normalmente, pero esta problema generalment es solo cuando conectarse a un mundo o servidor
    }
}