 ...
 * Detecta específicamente el error "mods.toml missing metadata for modid [modid]".
 * Utiliza Buscardor para identificar mods que podrían estar causando el problema.
 */
public class ErrorMetadataModsTomlFaltante implements Verificaciones {
        ...
        for (String linea : contenidoConsola.split(Verificaciones.nl)) {
            ...
            if (linea.contains("mods.toml missing metadata for modid")) {
                ...
                if (matcher.find()) {
                    ...
                    mensaje = MonitorDePID.idioma.errorMetadataModsTomlFaltante(modIdFaltante, modsPotenciales) + Verificaciones.nl_html;
                    activado = true;
                    break;
                }
            }
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            ...
            .agregarEtiqueta(MonitorDePID.idioma.paso3_metadata_mods_toml_faltante(modIdFaltante))
            .construir();
    }
