...
public class AnimacionGeckoLibNoEncontrada implements Verificaciones {
	...
	public String[] patronesRapidos() {
		return new String[] { "Error loading animation file", "GeckoLibException" };
	}
	...
	public void verificarPorLinea(Consola consola, String linea, int numeroDeLinea) {
		...
		if (linea.indexOf("Error loading animation file") < 0)
			return;
	...
	private static String extraerArchivo(String linea) {
		int fin = linea.indexOf(": Error loading animation file");
		if (fin < 0)
			return "";
