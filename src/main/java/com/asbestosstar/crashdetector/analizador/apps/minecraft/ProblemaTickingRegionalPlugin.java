 ...
 * Folia. Gracias a Aternos por que esta es una implementacion de su codex
...
public class ProblemaTickingRegionalPlugin implements Verificaciones {
	...
	/**
	 * Verifica si el log contiene plugins no compatibles con ticking regional en
	 * Folia.
	 */
	@Override
	public void verificar(Consola consola) {
		...
		Pattern patron = Pattern.compile("Could not load plugin '([^']+)'.*?in folder '([^']+)'.*?"
				+ "not marked as supporting regionised multithreading", Pattern.DOTALL);
