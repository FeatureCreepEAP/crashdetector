...
public class ConflictoMovingElevatorsOptiFine implements Verificaciones {
	 ...
	 * <p>
	 * Se busca el patrón característico del error de inyección crítica de Moving
	 * Elevators con LevelRenderer, que ocurre cuando Moving Elevators y OptiFine no
	 * son compatibles.
	 * </p>
	 */
	@Override
	...
	public QuickFix solucion() {
		return new QuickFix.Builder(nombre())
				.agregarEtiqueta(MonitorDePID.idioma.pasoConflictoMovingElevatorsOptiFine()).construir();
	}
	...
	public String[] ocupaTrazo() {
		return new String[] { CRITICAL_INJECTION, MOVING_ELEVATORS_MIXINS };
	}
