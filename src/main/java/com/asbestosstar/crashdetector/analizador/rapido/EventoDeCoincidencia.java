...
public final class EventoDeCoincidencia {
	...
	public final VerificacionesLegacy verificacion;
	...
	public EventoDeCoincidencia(Consola consola, Path archivo, VerificacionesLegacy verificacion, String patron,
			String linea, int numeroDeLinea, int inicioEnLinea, int finEnLinea, EstadoAnalisisArchivo estado) {
