...
public class ErrorDeEnlaceInsatisfecho implements Verificaciones {
    ...
    public void verificar(Consola consola) {
        ...
        // Patrón para detectar errores de enlace insatisfecho sin hardcodear binarios específicos
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucion_para_error_enlace_insatisfecho())
            .construir();
    }
}