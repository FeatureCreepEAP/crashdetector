    ...
    public void verificar(Consola consola) {
        ...
        if (cpuName != null && esRaptorLake(cpuName)) {
            ...
            try {
                ...
                // Si hay cualquier error (seguridad, clase no encontrada, acceso restringido), lo capturamos
                CrashDetectorLogger.log("No se pudo validar microcódigo para Raptor Lake (excepción controlada): " + t.getMessage());
    ...
    public QuickFix solucion() {
        ...
        try {
            builder.agregarBoton(MonitorDePID.idioma.verArticuloRaptorLake("CPU-Monkey"), retener -> {
                abrirEnNavegador("https://www.cpu-monkey.com/en/article/how_to_check_if_your_intel_13_14_gen_cpu_is_affected_by_instability_problems");
            }, false);
