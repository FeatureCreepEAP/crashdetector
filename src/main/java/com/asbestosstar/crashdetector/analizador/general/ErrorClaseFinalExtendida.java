...
/**
 * Detecta errores IncompatibleClassChangeError causados por intentar heredar
 * de una clase marcada como 'final' en versiones recientes de Minecraft o mods.
 * 
 * Ejemplo:
 * java.lang.IncompatibleClassChangeError: class A cannot inherit from final class B
 */
public class ErrorClaseFinalExtendida implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
            .agregarEtiqueta(MonitorDePID.idioma.solucionErrorClaseFinalExtendida())
            .construir();
    }
