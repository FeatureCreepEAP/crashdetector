 ...
 * problemas con Early Window en Forge/NeoForge/PillowMC o con LWJGL 3.2.2 y más nuevos.
 */
public class ErrorStackSmashingDetected implements Verificaciones {
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoErrorStackSmashingDetected())
                .construir();
    }
