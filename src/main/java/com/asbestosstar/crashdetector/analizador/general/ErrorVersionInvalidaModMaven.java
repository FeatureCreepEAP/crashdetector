...
/**
 * Detecta errores de especificación de versión inválida en mods donde la versión
 * no está correctamente rodeada por corchetes, causando un InvalidVersionSpecificationException.
 */
public class ErrorVersionInvalidaModMaven implements Verificaciones {
    ...
    public void verificar(Consola consola, String linea, int numero_de_linea) {
        ...
        if (linea.contains("org.apache.maven.artifact.versioning.InvalidVersionSpecificationException")
            ...
            // Extraemos la versión detectada del error, que está después de "must be surrounded by []:"
    ...
    public QuickFix solucion() {
        return new QuickFix.Builder(nombre())
                .agregarEtiqueta(MonitorDePID.idioma.pasoErrorVersionInvalidaMod())
                .construir();
    }
