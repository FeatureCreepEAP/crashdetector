 ...
 * Similar a un mapa multiclave donde se requiere el conjunto completo de dos claves para acceder al valor.
 *
...
public class BiMap<K0, K1, V> {
    ...
    public static class DoubleKey<K0, K1> {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(key0, other.key0) &&
                   Objects.equals(key1, other.key1);
        }
